...
class DiscountsInfo(BaseModel):
    ...
    """ # noqa: E501
    card: Optional[DiscountCard] = Field(default=None, description="Track of discount card to be applied to order.")
    discounts: Optional[List[Discount]] = Field(default=None, description="Discounts/surcharges.   > Type **iikoCard** allowed from version `7.4.4`.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "card": DiscountCard.from_dict(obj["card"]) if obj.get("card") is not None else None,
