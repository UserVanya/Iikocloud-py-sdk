...
class ExternalMenuItemSize(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["buttonImageUrl", "isDefault", "isHidden", "itemModifierGroups", "measureUnitType", "nutritionPerHundredGrams", "nutritions", "portionWeightGrams", "prices", "sizeCode", "sizeId", "sizeName", "sku"]
