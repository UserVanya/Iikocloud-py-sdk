...
class NomenclatureGroupDeleteRequest(BaseModel):
    """
    NomenclatureGroupDeleteRequest
    """ # noqa: E501
    group_ids: List[UUID] = Field(description="List of nomenclature group UUIDs for recursive deletion", alias="groupIds")
