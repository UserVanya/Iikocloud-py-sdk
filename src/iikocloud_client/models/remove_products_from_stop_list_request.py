...
class RemoveProductsFromStopListRequest(BaseModel):
    """
    Request for remove items from out-of-stock list.
    """ # noqa: E501
    items: List[RemoveProductsFromStopListItem] = Field(description="Items for removing from out-of-stock list.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [RemoveProductsFromStopListItem.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
