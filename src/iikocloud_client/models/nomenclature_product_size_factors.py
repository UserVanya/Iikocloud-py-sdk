...
class NomenclatureProductSizeFactors(BaseModel):
    """
    NomenclatureProductSizeFactors
    """ # noqa: E501
    factors: Optional[Dict[str, Dict[str, StrictStr]]] = Field(default=None, description="Write-off factor table: key - dish size UUID, value - a map of quantity range lower bound to write-off factor")
