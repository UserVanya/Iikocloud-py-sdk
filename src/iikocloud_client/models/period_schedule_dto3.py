...
class PeriodScheduleDto3(BaseModel):
    """
    Schedule availability interval
    """ # noqa: E501
    begin: StrictStr = Field(description="Start time")
    days_of_week: List[StrictStr] = Field(description="Availability days of week", alias="daysOfWeek")
    end: StrictStr = Field(description="End time")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["begin", "daysOfWeek", "end"]
