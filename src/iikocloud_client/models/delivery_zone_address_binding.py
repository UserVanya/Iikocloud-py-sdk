...
class DeliveryZoneAddressBinding(BaseModel):
    """
    Delivery zone polygon, defined by the combination of street, index and house numbers.
    """ # noqa: E501
    houses: HousesRange = Field(description="Range of house numbers in the delivery zone.")
    ...
    __properties: ClassVar[List[str]] = ["houses", "postcode", "streetId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "houses": HousesRange.from_dict(obj["houses"]) if obj.get("houses") is not None else None,
