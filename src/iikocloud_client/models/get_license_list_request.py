...
class GetLicenseListRequest(BaseModel):
    """
    Request to obtain the information on license list.
    """ # noqa: E501
    organization_ids: Optional[List[UUID]] = Field(default=None, description="Organization IDs for which license list information will be returned. By default - all organizations from API login.", alias="organizationIds")
