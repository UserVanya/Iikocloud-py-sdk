...
class ChartOfAccountsListResponse(BaseModel):
    ...
    """ # noqa: E501
    accounts: Optional[List[ChartOfAccount]] = Field(default=None, description="List of accounts")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "accounts": [ChartOfAccount.from_dict(_item) for _item in obj["accounts"]] if obj.get("accounts") is not None else None
        })
