...
class ExternalMenuModifierItem3(BaseModel):
    ...
    restrictions: Optional[ModifierRestrictionsDto7] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "restrictions": ModifierRestrictionsDto7.from_dict(obj["restrictions"]) if obj.get("restrictions") is not None else None,
