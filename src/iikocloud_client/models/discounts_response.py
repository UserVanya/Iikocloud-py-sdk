...
class DiscountsResponse(BaseModel):
    ...
    discounts: List[RmsDiscountCardTypeItemsResponse] = Field(description="List of discounts/surcharges.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "discounts": [RmsDiscountCardTypeItemsResponse.from_dict(_item) for _item in obj["discounts"]] if obj.get("discounts") is not None else None
        })
        return _obj
