...
class TransformationDocumentUpdateRequest(BaseModel):
    """
    TransformationDocumentUpdateRequest
    """ # noqa: E501
    amount: Union[StrictFloat, StrictInt] = Field(description="Product quantity")
    amount_unit: StrictStr = Field(description="Unit of measure identifier (GUID)", alias="amountUnit")
    ...
    __properties: ClassVar[List[str]] = ["amount", "amountUnit", "assemblyChartWriteoff", "comment", "conception", "date", "documentId", "isAutomatic", "isEditable", "items", "number", "organizationId", "product", "storeFrom", "storeTo"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "items": [TransformationDocumentCreateItem.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
