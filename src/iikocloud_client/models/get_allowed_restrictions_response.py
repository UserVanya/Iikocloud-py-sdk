...
class GetAllowedRestrictionsResponse(BaseModel):
    """
    ...
    allowed_items: List[AllowedItemWithDuration] = Field(description="Suitable terminal groups with a delivery duration for them.", alias="allowedItems")
    ...
    location: Optional[OrderLocation] = Field(description="Coordinates returned by geocoding service.")
    reject_cause: Optional[StrictStr] = Field(description="Reject cause.", alias="rejectCause")
    rejected_items: List[RejectItem] = Field(description="Rejected items with cause.", alias="rejectedItems")
    __properties: ClassVar[List[str]] = ["addressExternalId", "allowedItems", "correlationId", "isAllowed", "location", "rejectCause", "rejectedItems"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "allowedItems": [AllowedItemWithDuration.from_dict(_item) for _item in obj["allowedItems"]] if obj.get("allowedItems") is not None else None,
            "correlationId": obj.get("correlationId"),
            "isAllowed": obj.get("isAllowed"),
            "location": OrderLocation.from_dict(obj["location"]) if obj.get("location") is not None else None,
            "rejectCause": obj.get("rejectCause"),
            "rejectedItems": [RejectItem.from_dict(_item) for _item in obj["rejectedItems"]] if obj.get("rejectedItems") is not None else None
        })
        return _obj
