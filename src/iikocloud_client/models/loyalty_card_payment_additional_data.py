...
class LoyaltyCardPaymentAdditionalData(PaymentAdditionalData):
    """
    LoyaltyCardPaymentAdditionalData
    """ # noqa: E501
    credential: StrictStr = Field(description="Guest credential, authorizing payment.")
    search_scope: IikoCardSearchScope = Field(description="Guest credential search scope.", alias="searchScope")
