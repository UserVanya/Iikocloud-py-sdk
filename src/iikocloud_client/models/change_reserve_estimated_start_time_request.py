...
class ChangeReserveEstimatedStartTimeRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["newEstimatedStartTime", "organizationId", "reserveId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "newEstimatedStartTime": obj.get("newEstimatedStartTime"),
