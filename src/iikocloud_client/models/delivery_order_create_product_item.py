...
class DeliveryOrderCreateProductItem(DeliveryOrderCreateItem):
    """
    DeliveryOrderCreateProductItem
    """ # noqa: E501
    modifiers: Optional[List[Modifier]] = Field(default=None, description="Modifiers.")
    ...
    __properties: ClassVar[List[str]] = ["amount", "comboInformation", "comment", "productSizeId", "type", "modifiers", "positionId", "price", "productId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "type": obj.get("type"),
            "modifiers": [Modifier.from_dict(_item) for _item in obj["modifiers"]] if obj.get("modifiers") is not None else None,
