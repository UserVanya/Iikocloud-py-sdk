...
class NomenclatureProductUpdateBarcodesRequest(BaseModel):
    """
    NomenclatureProductUpdateBarcodesRequest
    """ # noqa: E501
    barcodes: List[NomenclatureProductBarcode] = Field(description="Barcodes")
    product_id: UUID = Field(description="Product ID", alias="productId")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["barcodes", "productId"]
