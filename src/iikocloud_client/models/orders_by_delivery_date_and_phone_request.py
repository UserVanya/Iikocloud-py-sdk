...
class OrdersByDeliveryDateAndPhoneRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["deliveryDateFrom", "deliveryDateTo", "organizationIds", "phone", "rowsCount", "sourceKeys", "startRevision"]
