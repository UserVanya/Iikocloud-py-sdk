...
class DeliveryOrderResponseRegularCustomer(DeliveryOrderResponseCustomer):
    """
    ...
    gender: Optional[Gender] = Field(default=None, description="Sex.")
    ...
    __properties: ClassVar[List[str]] = ["type", "birthdate", "blacklistReason", "comment", "gender", "id", "inBlacklist", "name", "surname"]
