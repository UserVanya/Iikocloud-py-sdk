...
class ChangeExternalDataRequest(BaseModel):
    """
    Request for change of delivery or table order external data.
    """ # noqa: E501
    external_data: List[DeliveryOrderCreateExternalData] = Field(description="External data to change.", alias="externalData")
    ...
    __properties: ClassVar[List[str]] = ["externalData", "orderId", "organizationId"]
