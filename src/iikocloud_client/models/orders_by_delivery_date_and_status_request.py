...
class OrdersByDeliveryDateAndStatusRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["courierIds", "deliveryDateFrom", "deliveryDateTo", "organizationIds", "sourceKeys", "statuses"]
