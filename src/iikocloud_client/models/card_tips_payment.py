...
class CardTipsPayment(TipsPayment):
    """
    CardTipsPayment
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["isFiscalizedExternally", "isPrepay", "isProcessedExternally", "paymentAdditionalData", "paymentTypeId", "paymentTypeKind", "sum", "tipsTypeId", "number"]
