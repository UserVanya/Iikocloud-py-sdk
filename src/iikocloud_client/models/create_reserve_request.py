...
class CreateReserveRequest(BaseModel):
    ...
    create_reserve_settings: Optional[CreateOrderSettingsBase] = Field(default=None, description="Reserve creation parameters.", alias="createReserveSettings")
    customer: DeliveryOrderCreateRegularCustomer = Field(description="Customer.")
    ...
    guests: Optional[ReserveGuestsInfo] = Field(default=None, description="Guests information.")
    ...
    order: Optional[ReserveOrderRequest] = Field(default=None, description="Order. Used only at a banquet.")
    ...
    __properties: ClassVar[List[str]] = ["comment", "createReserveSettings", "customer", "durationInMinutes", "estimatedStartTime", "eventType", "externalNumber", "guests", "guestsCount", "id", "order", "organizationId", "phone", "shouldRemind", "tableIds", "terminalGroupId", "transportToFrontTimeout"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "createReserveSettings": CreateOrderSettingsBase.from_dict(obj["createReserveSettings"]) if obj.get("createReserveSettings") is not None else None,
            ...
            "guests": ReserveGuestsInfo.from_dict(obj["guests"]) if obj.get("guests") is not None else None,
            "guestsCount": obj.get("guestsCount"),
            "id": obj.get("id"),
            "order": ReserveOrderRequest.from_dict(obj["order"]) if obj.get("order") is not None else None,
