...
class TableOrderResponse(BaseModel):
    ...
    order_info: TableOrderInfo = Field(description="Order.", alias="orderInfo")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "orderInfo": TableOrderInfo.from_dict(obj["orderInfo"]) if obj.get("orderInfo") is not None else None
        })
        return _obj
