...
class BarcodeInfo(BaseModel):
    ...
    Barcode.
    """ # noqa: E501
    barcode: StrictStr = Field(description="Barcode.")
    container: Optional[StrictStr] = Field(default=None, description="Container.")
    product_fiscal_code: Optional[StrictStr] = Field(default=None, description="Product fiscal code.", alias="productFiscalCode")
