...
class DeliveryOrderCreatePayload(BaseModel):
    """
    Order.
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["chequeAdditionalInfo", "combos", "comment", "completeBefore", "customer", "deliveryDuration", "deliveryPoint", "deliveryZone", "discountsInfo", "externalData", "externalNumber", "guests", "id", "items", "loyaltyInfo", "marketingSourceId", "operatorId", "orderServiceType", "orderTypeId", "payments", "phone", "phoneExtension", "priceCategoryId", "sourceKey", "tips"]
