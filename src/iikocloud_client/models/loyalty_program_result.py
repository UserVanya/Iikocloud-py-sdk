...
class LoyaltyProgramResult(BaseModel):
    ...
    available_combos: Optional[List[AvailableCombo]] = Field(default=None, description="Partially added combos, available for assembly.", alias="availableCombos")
    discounts: Optional[List[DiscountOperation]] = Field(default=None, description="Discount operations applied to order items.")
    free_products: Optional[List[FreeProductsGroup]] = Field(default=None, description="Program free products.", alias="freeProducts")
    ...
    upsales: Optional[List[Upsale]] = Field(default=None, description="Suggested items to add or advices for customer.")
    __properties: ClassVar[List[str]] = ["availableComboSpecifications", "availableCombos", "discounts", "freeProducts", "marketingCampaignId", "name", "needToActivateCertificate", "upsales"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "availableCombos": [AvailableCombo.from_dict(_item) for _item in obj["availableCombos"]] if obj.get("availableCombos") is not None else None,
            "discounts": [DiscountOperation.from_dict(_item) for _item in obj["discounts"]] if obj.get("discounts") is not None else None,
            "freeProducts": [FreeProductsGroup.from_dict(_item) for _item in obj["freeProducts"]] if obj.get("freeProducts") is not None else None,
            "marketingCampaignId": obj.get("marketingCampaignId"),
            "name": obj.get("name"),
            "needToActivateCertificate": obj.get("needToActivateCertificate"),
            "upsales": [Upsale.from_dict(_item) for _item in obj["upsales"]] if obj.get("upsales") is not None else None
        })
        return _obj
