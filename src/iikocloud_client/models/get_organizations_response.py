...
class GetOrganizationsResponse(BaseModel):
    ...
    organizations: List[OrganizationInfo] = Field(description="List of organizations.                Can be obtained by `/api/1/organizations` operation.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "organizations": [OrganizationInfo.from_dict(_item) for _item in obj["organizations"]] if obj.get("organizations") is not None else None
        })
        return _obj
