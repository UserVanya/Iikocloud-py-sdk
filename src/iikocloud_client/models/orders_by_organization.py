...
class OrdersByOrganization(BaseModel):
    """
    Orders grouped by organization.
    """ # noqa: E501
    orders: List[OrderInfo] = Field(description="List of orders by organization.")
    ...
    __properties: ClassVar[List[str]] = ["orders", "organizationId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "orders": [OrderInfo.from_dict(_item) for _item in obj["orders"]] if obj.get("orders") is not None else None,
