...
class ComboDto(BaseModel):
    ...
    image: List[Optional[ComboDtoImageInner]] = Field(description="Combo image")
    ...
    sizes: Optional[List[ComboSizeDto]] = Field(default=None, description="Available sizes for combo (can be empty)")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "id": obj.get("id"),
            "image": [ComboDtoImageInner.from_dict(_item) for _item in obj["image"]] if obj.get("image") is not None else None,
            "name": obj.get("name"),
            "price": obj.get("price"),
            "priceStrategy": obj.get("priceStrategy"),
            "sizes": [ComboSizeDto.from_dict(_item) for _item in obj["sizes"]] if obj.get("sizes") is not None else None,
