...
class AllowedItemWithDuration(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["deliveryDurationInMinutes", "deliveryServiceProductId", "organizationId", "terminalGroupId", "zone"]
