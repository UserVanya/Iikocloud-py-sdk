...
class ChangeBanquetOrderItemsRequest(BaseModel):
    """
    Request to change banquet order items.
    """ # noqa: E501
    combos: Optional[List[Combo]] = Field(default=None, description="Combos.")
    items: Optional[List[DeliveryOrderCreateItem]] = Field(default=None, description="Order items (may include ProductOrderItem or CompoundOrderItem).")
