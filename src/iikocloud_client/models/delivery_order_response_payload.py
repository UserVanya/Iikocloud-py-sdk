...
class DeliveryOrderResponsePayload(BaseModel):
    """
    Order details.
    """ # noqa: E501
    cancel_info: Optional[CancelInfo] = Field(default=None, description="Delivery cancellation details.  <remarks>  Required only if delivery is canceled, i.e. status=Canceled.  </remarks>", alias="cancelInfo")
    ...
    courier_info: Optional[CourierInfo] = Field(default=None, description="Driver information.", alias="courierInfo")
    customer: Optional[DeliveryOrderResponseCustomer] = Field(default=None, description="Delivery customer.")
    ...
    delivery_point: Optional[DeliveryOrderResponsePoint] = Field(default=None, description="Delivery point details.  <remarks>  Not required if order type is customer pickup. Otherwise, required.  </remarks>", alias="deliveryPoint")
    ...
    external_courier_service: Optional[ExternalCourierService] = Field(default=None, description="ECS info.   > Allowed from version `7.7.7`.", alias="externalCourierService")
    ...
    marketing_source: Optional[DeliveryOrderResponseMarketingSource] = Field(default=None, description="Marketing source.", alias="marketingSource")
    ...
    operator: Optional[DeliveryOrderResponseEmployee] = Field(default=None, description="Operator that took order.")
    ...
    problem: Optional[Problem] = Field(default=None, description="Problem flag.")
    ...
    status: DeliveryStatus = Field(description="Delivery status.                > Delivery status `ReadyForCooking` is deprecated from version `9.0.6`.")
    ...
    __properties: ClassVar[List[str]] = ["cancelInfo", "combos", "comment", "completeBefore", "conception", "cookingStartTime", "courierInfo", "customer", "deliveryDuration", "deliveryPoint", "deliveryZone", "discounts", "estimatedTime", "externalCourierService", "externalData", "guestsInfo", "indexInCourierRoute", "isAsap", "isDeleted", "items", "lockedAt", "loyaltyInfo", "marketingSource", "menuId", "movedFromDeliveryId", "movedFromOrganizationId", "movedFromTerminalGroupId", "movedToDeliveryId", "movedToOrganizationId", "movedToTerminalGroupId", "number", "operator", "orderType", "parentDeliveryId", "payments", "phone", "phoneExtension", "priceCategory", "problem", "processedPaymentsSum", "sourceKey", "status", "sum", "terminalGroupId", "tips", "trackingLink", "whenBillPrinted", "whenClosed", "whenConfirmed", "whenCookingCompleted", "whenCreated", "whenDelivered", "whenPacked", "whenPrinted", "whenReceivedByApi", "whenReceivedFromFront", "whenSended"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "cancelInfo": CancelInfo.from_dict(obj["cancelInfo"]) if obj.get("cancelInfo") is not None else None,
            ...
            "deliveryPoint": DeliveryOrderResponsePoint.from_dict(obj["deliveryPoint"]) if obj.get("deliveryPoint") is not None else None,
            ...
            "externalCourierService": ExternalCourierService.from_dict(obj["externalCourierService"]) if obj.get("externalCourierService") is not None else None,
            ...
            "marketingSource": DeliveryOrderResponseMarketingSource.from_dict(obj["marketingSource"]) if obj.get("marketingSource") is not None else None,
            ...
            "operator": DeliveryOrderResponseEmployee.from_dict(obj["operator"]) if obj.get("operator") is not None else None,
