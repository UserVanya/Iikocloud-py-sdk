...
class IncomingServiceGetResponse(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["comment", "conception", "contractDate", "contractNumber", "counteragent", "date", "dateCreated", "dateModified", "documentId", "dueDate", "employeePassToAccount", "incomingDate", "incomingDocumentNumber", "invoice", "isAutomatic", "isEditable", "items", "number", "revenueAccount", "status", "sum", "sumWithoutVat", "userCreated", "userModified"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "items": [IncomingServiceGetItem.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
