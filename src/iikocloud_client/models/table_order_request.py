...
class TableOrderRequest(BaseModel):
    ...
    customer: Optional[DeliveryOrderCreateRegularCustomer] = Field(default=None, description="Guest.   > Allowed from version `7.5.2`.")
    ...
    guests: Optional[TableOrderGuestsInfo] = Field(default=None, description="Guests information.   > Allowed from version `7.6.1`.")
    ...
    __properties: ClassVar[List[str]] = ["chequeAdditionalInfo", "combos", "customer", "discountsInfo", "externalData", "externalNumber", "guestCount", "guests", "id", "items", "loyaltyInfo", "menuId", "orderTypeId", "payments", "phone", "priceCategoryId", "sourceKey", "tabName", "tableIds", "tips"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "customer": DeliveryOrderCreateRegularCustomer.from_dict(obj["customer"]) if obj.get("customer") is not None else None,
            ...
            "guests": TableOrderGuestsInfo.from_dict(obj["guests"]) if obj.get("guests") is not None else None,
            "id": obj.get("id"),
