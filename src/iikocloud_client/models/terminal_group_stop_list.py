...
class TerminalGroupStopList(BaseModel):
    ...
    """ # noqa: E501
    items: List[StopListItem] = Field(description="Out-of-stock list.")
    terminal_group_id: Optional[UUID] = Field(default=None, description="Terminal ID.", alias="terminalGroupId")
    __properties: ClassVar[List[str]] = ["items", "terminalGroupId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [StopListItem.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
