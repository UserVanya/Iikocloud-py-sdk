...
class OrganizationSettings(BaseModel):
    ...
    """ # noqa: E501
    address_format_type: Optional[AddressFormatType] = Field(default=None, description="Address format type.                Available if `AddressFormatType` requested.", alias="addressFormatType")
    address_lookup: Optional[List[AddressHintsServiceType]] = Field(default=None, description="Available address lookup services.                Available if `AddressLookup` requested.", alias="addressLookup")
    ...
    delivery_order_payment_settings: Optional[DeliveryOrderPaymentSettings] = Field(default=None, description="Delivery order payment settings.                Available if `DeliveryOrderPaymentSettings` requested.", alias="deliveryOrderPaymentSettings")
    delivery_service_type: Optional[DeliverySettingsServiceType] = Field(default=None, description="Delivery type.                Available if `DeliveryServiceType` requested.", alias="deliveryServiceType")
    ...
    __properties: ClassVar[List[str]] = ["addressFormatType", "addressLookup", "confirmAllowedIntervalInMinutes", "country", "countryPhoneCode", "currencyIsoName", "defaultCallCenterPaymentTypeId", "defaultDeliveryCityId", "deliveryCityIds", "deliveryOrderPaymentSettings", "deliveryServiceType", "externalData", "id", "isAnonymousGuestsAllowed", "isConfirmationEnabled", "latitude", "longitude", "loyaltyDiscountAffectsVat", "marketingSourceRequiredInDelivery", "name", "orderItemCommentEnabled", "pricesVatInclusive", "restaurantAddress", "useBusinessHoursAndMapping", "useUaeAddressingSystem", "version"]
