...
class ComboCategoryDto(BaseModel):
    """
    ComboCategoryDto
    """ # noqa: E501
    combos: Optional[List[ComboDto]] = Field(default=None, description="Combos in category")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "combos": [ComboDto.from_dict(_item) for _item in obj["combos"]] if obj.get("combos") is not None else None,
            "id": obj.get("id"),
            "name": obj.get("name")
        })
