...
class ProductionDocumentCreateRequest(BaseModel):
    """
    ...
    items: List[ProductionDocumentCreateItem] = Field(description="List of document items")
    ...
    __properties: ClassVar[List[str]] = ["comment", "conception", "date", "documentId", "isAutomatic", "isEditable", "items", "number", "organizationId", "storeFrom", "storeTo"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "items": [ProductionDocumentCreateItem.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
