...
class IncomingReturnedInvoiceUpdateRequest(BaseModel):
    """
    ...
    items: List[IncomingReturnedInvoiceCreateItem] = Field(description="List of document items")
    ...
    processing_mode: StrictStr = Field(description="Processing mode (RETURN_DISH — return dish, RETURN_GOOD — return ingredients, DO_NOT_RETURN — no warehouse)", alias="processingMode")
    ...
    __properties: ClassVar[List[str]] = ["comment", "conception", "counteragent", "date", "defaultStore", "documentId", "expenseAccount", "isAutomatic", "isEditable", "items", "number", "organizationId", "outgoingInvoiceId", "processingMode", "revenueAccount"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "items": [IncomingReturnedInvoiceCreateItem.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
