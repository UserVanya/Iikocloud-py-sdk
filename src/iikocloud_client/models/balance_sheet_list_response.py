...
class BalanceSheetListResponse(BaseModel):
    ...
    """ # noqa: E501
    balance_at: Optional[StrictStr] = Field(default=None, description="Date to retrieve balances for (YYYY-MM-DD)", alias="balanceAt")
    balances: Optional[List[BalanceItem]] = Field(default=None, description="List of account balances")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["balanceAt", "balances"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "balances": [BalanceItem.from_dict(_item) for _item in obj["balances"]] if obj.get("balances") is not None else None
        })
