...
class OutgoingServiceUpdateRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["comment", "conception", "contractDate", "contractNumber", "counteragent", "date", "documentId", "dueDate", "isAutomatic", "isEditable", "items", "number", "organizationId", "revenueAccount"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "items": [OutgoingServiceCreateItem.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
