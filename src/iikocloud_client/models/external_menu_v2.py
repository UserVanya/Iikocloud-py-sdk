...
class ExternalMenuV2(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["buttonImageUrl", "comboCategories", "customerTagGroups", "description", "formatVersion", "id", "intervals", "itemCategories", "name", "productCategories", "revision"]
