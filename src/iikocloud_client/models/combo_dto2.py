...
class ComboDto2(BaseModel):
    ...
    groups: Optional[List[ComboGroupDto2]] = None
    id: UUID = Field(description="Combo id")
    image: List[Optional[ComboDto2ImageInner]] = Field(description="Combo image")
    ...
    sizes: Optional[List[ComboSizeDto2]] = Field(default=None, description="Available sizes for combo (can be empty)")
    start_date: StrictStr = Field(description="The date when the combo will be available until", alias="startDate")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["description", "expirationDate", "groups", "id", "image", "name", "price", "priceStrategy", "sizes", "startDate"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "groups": [ComboGroupDto2.from_dict(_item) for _item in obj["groups"]] if obj.get("groups") is not None else None,
            "id": obj.get("id"),
            "image": [ComboDto2ImageInner.from_dict(_item) for _item in obj["image"]] if obj.get("image") is not None else None,
            "name": obj.get("name"),
            "price": obj.get("price"),
            "priceStrategy": obj.get("priceStrategy"),
            "sizes": [ComboSizeDto2.from_dict(_item) for _item in obj["sizes"]] if obj.get("sizes") is not None else None,
