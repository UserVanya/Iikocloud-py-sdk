...
class GetRestaurantSectionsRequest(BaseModel):
    """
    ...
    terminal_group_ids: List[UUID] = Field(description="Collection of terminal group ID.                Can be obtained by `/api/1/terminal_groups` operation.", alias="terminalGroupIds")
    __properties: ClassVar[List[str]] = ["returnSchema", "revision", "terminalGroupIds"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "returnSchema": obj.get("returnSchema"),
