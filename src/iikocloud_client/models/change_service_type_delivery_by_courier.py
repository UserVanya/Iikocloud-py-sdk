...
class ChangeServiceTypeDeliveryByCourier(ChangeServiceTypeRequest):
    """
    ChangeServiceTypeDeliveryByCourier
    """ # noqa: E501
    delivery_point: DeliveryOrderCreatePoint = Field(description="Address of delivery.", alias="deliveryPoint")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["newServiceType", "orderId", "organizationId", "deliveryPoint"]
