...
class IikoCardDiscount(Discount):
    """
    IikoCardDiscount
    """ # noqa: E501
    discount_items: List[IikoCardDiscountItem] = Field(description="Discount information for order items.", alias="discountItems")
    ...
    __properties: ClassVar[List[str]] = ["type", "discountItems", "programId", "programName"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "discountItems": [IikoCardDiscountItem.from_dict(_item) for _item in obj["discountItems"]] if obj.get("discountItems") is not None else None,
