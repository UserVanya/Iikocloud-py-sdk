...
class OrganizationLicenseInfo(BaseModel):
    """
    OrganizationLicenseInfo
    """ # noqa: E501
    licenses: List[LicenseItem] = Field(description="List of licenses.")
    organization_id: UUID = Field(description="Organization Id.", alias="organizationId")
    __properties: ClassVar[List[str]] = ["licenses", "organizationId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "licenses": [LicenseItem.from_dict(_item) for _item in obj["licenses"]] if obj.get("licenses") is not None else None,
