...
class DeliveryOrderCreateStreet(BaseModel):
    """
    Street.
    """ # noqa: E501
    ...
    id: Optional[UUID] = Field(default=None, description="ID.                 Can be obtained by `/api/1/streets/by_city` operation.")
    name: Optional[Annotated[str, Field(min_length=0, strict=True, max_length=60)]] = Field(default=None, description="Name.")
    __properties: ClassVar[List[str]] = ["city", "classifierId", "id", "name"]
