...
class DeliveryOrderResponseStreet(BaseModel):
    """
    Street.
    """ # noqa: E501
    city: DeliveryOrderResponseCity = Field(description="City.")
    id: UUID = Field(description="ID.")
    name: StrictStr = Field(description="Name.")
    __properties: ClassVar[List[str]] = ["city", "id", "name"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "city": DeliveryOrderResponseCity.from_dict(obj["city"]) if obj.get("city") is not None else None,
            "id": obj.get("id"),
            "name": obj.get("name")
        })
        return _obj
