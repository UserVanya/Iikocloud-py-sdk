...
class GetTransactionsReportByRevisionResponse(BaseModel):
    """
    ...
    transactions: Optional[List[TransportTransactionsReportItem]] = Field(default=None, description="Transactions.")
    __properties: ClassVar[List[str]] = ["lastRevision", "lastTransactionId", "pageSize", "transactions"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "transactions": [TransportTransactionsReportItem.from_dict(_item) for _item in obj["transactions"]] if obj.get("transactions") is not None else None
        })
        return _obj
