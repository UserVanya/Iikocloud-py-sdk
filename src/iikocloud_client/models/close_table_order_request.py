...
class CloseTableOrderRequest(BaseModel):
    """
    Request for close table order.
    """ # noqa: E501
    cheque_additional_info: Optional[ChequeAdditionalInfo] = Field(default=None, description="Cheque additional information according to russian federal law #54.", alias="chequeAdditionalInfo")
    ...
    __properties: ClassVar[List[str]] = ["chequeAdditionalInfo", "orderId", "organizationId"]
