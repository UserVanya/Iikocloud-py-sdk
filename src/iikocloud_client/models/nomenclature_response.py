...
class NomenclatureResponse(BaseModel):
    ...
    groups: List[ProductsGroupInfo] = Field(description="Stock list group.")
    product_categories: List[ProductCategoryInfo] = Field(description="Menu item category.", alias="productCategories")
    products: List[ProductInfo] = Field(description="Menu items and modifiers.")
    ...
    sizes: List[Size] = Field(description="Item sizes.")
    __properties: ClassVar[List[str]] = ["correlationId", "groups", "productCategories", "products", "revision", "sizes"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "groups": [ProductsGroupInfo.from_dict(_item) for _item in obj["groups"]] if obj.get("groups") is not None else None,
            "productCategories": [ProductCategoryInfo.from_dict(_item) for _item in obj["productCategories"]] if obj.get("productCategories") is not None else None,
