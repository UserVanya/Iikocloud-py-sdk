...
class AddCustomerToTableOrderRequest(BaseModel):
    """
    Request for adding customer to order.
    """ # noqa: E501
    customer: TableOrderCustomer = Field(description="Guest info.")
    ...
    __properties: ClassVar[List[str]] = ["customer", "orderId", "organizationId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "customer": TableOrderCustomer.from_dict(obj["customer"]) if obj.get("customer") is not None else None,
