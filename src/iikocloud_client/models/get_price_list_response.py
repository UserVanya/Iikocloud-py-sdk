...
class GetPriceListResponse(BaseModel):
    ...
    """ # noqa: E501
    items: Optional[List[PriceListItem]] = Field(default=None, description="List of supplier price list items")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [PriceListItem.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None
        })
