...
class AddOrderPaymentsRequest(BaseModel):
    """
    ...
    payments: List[Payment] = Field(description="Order payments.")
    tips: Optional[List[TipsPayment]] = Field(default=None, description="Order tips.")
    __properties: ClassVar[List[str]] = ["orderId", "organizationId", "payments", "tips"]
