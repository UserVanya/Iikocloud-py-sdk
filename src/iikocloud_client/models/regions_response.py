...
class RegionsResponse(BaseModel):
    ...
    regions: List[RmsRegionItemsResponse] = Field(description="List of districts.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "regions": [RmsRegionItemsResponse.from_dict(_item) for _item in obj["regions"]] if obj.get("regions") is not None else None
        })
        return _obj
