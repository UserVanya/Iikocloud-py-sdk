...
class UpdateProductBarcodesRequest(BaseModel):
    """
    UpdateProductBarcodesRequest
    """ # noqa: E501
    barcodes: Optional[List[BarcodeItem]] = Field(default=None, description="Barcodes")
    ...
    __properties: ClassVar[List[str]] = ["barcodes", "organizationId", "productId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "barcodes": [BarcodeItem.from_dict(_item) for _item in obj["barcodes"]] if obj.get("barcodes") is not None else None,
