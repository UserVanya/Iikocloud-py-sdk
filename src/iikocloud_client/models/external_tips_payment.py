...
class ExternalTipsPayment(TipsPayment):
    """
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ExternalTipsPayment from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ExternalTipsPayment from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "paymentAdditionalData": PaymentAdditionalData.from_dict(obj["paymentAdditionalData"]) if obj.get("paymentAdditionalData") is not None else None,
