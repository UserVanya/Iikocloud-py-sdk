...
class OrderAttentionNotificationRequest(SendNotificationRequest):
    """
    ...
    __properties: ClassVar[List[str]] = ["messageType", "organizationId", "additionalInfo", "orderId", "orderSource"]
