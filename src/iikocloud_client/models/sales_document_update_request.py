...
class SalesDocumentUpdateRequest(BaseModel):
    """
    SalesDocumentUpdateRequest
    """ # noqa: E501
    banquet: Optional[StrictBool] = Field(default=None, description="Banquet order flag. Default false. Optional")
    ...
    items: List[SalesDocumentCreateItem] = Field(description="List of document items")
    ...
    __properties: ClassVar[List[str]] = ["banquet", "comment", "conception", "date", "defaultStore", "documentId", "expenseAccount", "isAutomatic", "isEditable", "items", "number", "organizationId", "revenueAccount"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "items": [SalesDocumentCreateItem.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
