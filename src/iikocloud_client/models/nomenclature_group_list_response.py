...
class NomenclatureGroupListResponse(BaseModel):
    """
    NomenclatureGroupListResponse
    """ # noqa: E501
    groups: Optional[List[NomenclatureGroupResponse]] = Field(default=None, description="List of nomenclature groups")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "groups": [NomenclatureGroupResponse.from_dict(_item) for _item in obj["groups"]] if obj.get("groups") is not None else None
        })
