...
class UpdateDeliveryStatusRequest(BaseModel):
    ...
    delivery_status: DeliveryStatusForUpdate = Field(description="Delivery status. Can be only switched between these three statuses.", alias="deliveryStatus")
    ...
    __properties: ClassVar[List[str]] = ["deliveryDate", "deliveryStatus", "orderId", "organizationId"]
