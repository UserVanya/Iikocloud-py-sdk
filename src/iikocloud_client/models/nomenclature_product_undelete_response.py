...
class NomenclatureProductUndeleteResponse(BaseModel):
    """
    NomenclatureProductUndeleteResponse
    """ # noqa: E501
    message: Optional[StrictStr] = Field(default=None, description="Message confirming successful restoration")
