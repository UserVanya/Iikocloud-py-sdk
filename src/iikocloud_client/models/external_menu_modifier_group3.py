...
class ExternalMenuModifierGroup3(BaseModel):
    """
    ...
    items: Optional[List[ExternalMenuModifierItem3]] = None
    name: Optional[StrictStr] = Field(default='', description="Modifiers group name")
    restrictions: Optional[ModifierRestrictionsDto3] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "items": [ExternalMenuModifierItem3.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
            "name": obj.get("name") if obj.get("name") is not None else '',
            "restrictions": ModifierRestrictionsDto3.from_dict(obj["restrictions"]) if obj.get("restrictions") is not None else None,
