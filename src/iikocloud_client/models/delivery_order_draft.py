...
class DeliveryOrderDraft(BaseModel):
    """
    ...
    delivery_point: Optional[DeliveryOrderCreatePoint] = Field(default=None, description="Delivery point details.  > Not required in case of customer pickup. Otherwise, required.", alias="deliveryPoint")
    ...
    guests: Optional[Guests] = Field(default=None, description="Guest details. Not equal to the customer who makes an order.")
    ...
    order_service_type: Optional[DeliveryOrderCreateServiceType] = Field(default=None, description="Order service type.  > Only one of the fields must be defined: **orderTypeId** or **orderServiceType**.   > Allowed from version `7.0.3`.", alias="orderServiceType")
    ...
    __properties: ClassVar[List[str]] = ["chequeAdditionalInfo", "combos", "comment", "completeBefore", "customer", "deliveryDuration", "deliveryPoint", "deliveryZone", "discountsInfo", "externalData", "externalNumber", "guests", "id", "items", "loyaltyInfo", "marketingSourceId", "menuId", "operatorId", "orderServiceType", "orderTypeId", "payments", "phone", "phoneExtension", "priceCategoryId", "sourceKey", "tips"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "customer": DeliveryOrderCreateCustomer.from_dict(obj["customer"]) if obj.get("customer") is not None else None,
            "deliveryDuration": obj.get("deliveryDuration"),
            "deliveryPoint": DeliveryOrderCreatePoint.from_dict(obj["deliveryPoint"]) if obj.get("deliveryPoint") is not None else None,
            ...
            "guests": Guests.from_dict(obj["guests"]) if obj.get("guests") is not None else None,
            "id": obj.get("id"),
