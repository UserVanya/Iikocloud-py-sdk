...
class GetWebHookSettingsResponse(BaseModel):
    """
    ...
    web_hooks_filter: Optional[WebHooksFilter] = Field(default=None, description="Webhooks filter.", alias="webHooksFilter")
    web_hooks_uri: Optional[StrictStr] = Field(description="Webhook handler url.", alias="webHooksUri")
    __properties: ClassVar[List[str]] = ["apiLoginName", "authToken", "correlationId", "webHooksFilter", "webHooksUri"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "webHooksFilter": WebHooksFilter.from_dict(obj["webHooksFilter"]) if obj.get("webHooksFilter") is not None else None,
