...
class ExtendedOrganizationInfo(OrganizationInfo):
    """
    ExtendedOrganizationInfo
    """ # noqa: E501
    address_format_type: AddressFormatType = Field(description="Address format type.", alias="addressFormatType")
    address_lookup: List[AddressHintsServiceType] = Field(description="Available address lookup services.", alias="addressLookup")
    ...
    delivery_order_payment_settings: Optional[DeliveryOrderPaymentSettings] = Field(default=None, description="Delivery order payment settings.", alias="deliveryOrderPaymentSettings")
    delivery_service_type: Optional[DeliverySettingsServiceType] = Field(description="Delivery type.", alias="deliveryServiceType")
    ...
    __properties: ClassVar[List[str]] = ["code", "externalData", "id", "name", "responseType", "addressFormatType", "addressLookup", "confirmAllowedIntervalInMinutes", "country", "countryPhoneCode", "currencyIsoName", "currencyMinimumDenomination", "defaultCallCenterPaymentTypeId", "defaultDeliveryCityId", "deliveryCityIds", "deliveryOrderPaymentSettings", "deliveryServiceType", "inn", "isAnonymousGuestsAllowed", "isCloud", "isConfirmationEnabled", "latitude", "longitude", "marketingSourceRequiredInDelivery", "orderItemCommentEnabled", "restaurantAddress", "useUaeAddressingSystem", "version"]
