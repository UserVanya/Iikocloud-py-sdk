...
class EmployeesResponse(BaseModel):
    ...
    employees: List[RmsEmployeeItemsResponse] = Field(description="List of drivers.")
    __properties: ClassVar[List[str]] = ["correlationId", "employees"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "employees": [RmsEmployeeItemsResponse.from_dict(_item) for _item in obj["employees"]] if obj.get("employees") is not None else None
        })
        return _obj
