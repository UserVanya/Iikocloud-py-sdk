...
class Payment(BaseModel):
    ...
    payment_additional_data: Optional[PaymentAdditionalData] = Field(default=None, description="Additional payment parameters.", alias="paymentAdditionalData")
    ...
    __properties: ClassVar[List[str]] = ["isFiscalizedExternally", "isPrepay", "isProcessedExternally", "paymentAdditionalData", "paymentTypeId", "paymentTypeKind", "sum"]
    ...
    __discriminator_value_class_map: ClassVar[Dict[str, str]] = {
        'Card': 'CardPayment','Cash': 'CashPayment','External': 'ExternalPayment','LoyaltyCard': 'LoyaltyCardPayment'
    }
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Optional[Union[CardPayment, CashPayment, ExternalPayment, LoyaltyCardPayment]]:
    ...
    @classmethod
    def from_dict(cls, obj: Dict[str, Any]) -> Optional[Union[CardPayment, CashPayment, ExternalPayment, LoyaltyCardPayment]]:
        """Create an instance of Payment from a dict"""
        # look up the object type based on discriminator mapping
        object_type = cls.get_discriminator_value(obj)
        if object_type ==  'CardPayment':
            return import_module("iikocloud_client.models.card_payment").CardPayment.from_dict(obj)
        if object_type ==  'CashPayment':
            return import_module("iikocloud_client.models.cash_payment").CashPayment.from_dict(obj)
        if object_type ==  'ExternalPayment':
            return import_module("iikocloud_client.models.external_payment").ExternalPayment.from_dict(obj)
        if object_type ==  'LoyaltyCardPayment':
            return import_module("iikocloud_client.models.loyalty_card_payment").LoyaltyCardPayment.from_dict(obj)

        raise ValueError("Payment failed to lookup discriminator value from " +
