...
class RestrictionsOrderItem(BaseModel):
    ...
    modifiers: Optional[List[RestrictionsOrderItemModifier]] = Field(default=None, description="Modifiers (absolute amount).")
    product: StrictStr = Field(description="Product.")
    __properties: ClassVar[List[str]] = ["amount", "id", "modifiers", "product"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "id": obj.get("id"),
            "modifiers": [RestrictionsOrderItemModifier.from_dict(_item) for _item in obj["modifiers"]] if obj.get("modifiers") is not None else None,
