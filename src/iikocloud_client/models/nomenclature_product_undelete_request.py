...
class NomenclatureProductUndeleteRequest(BaseModel):
    """
    NomenclatureProductUndeleteRequest
    """ # noqa: E501
    product_ids: List[UUID] = Field(description="List of nomenclature product UUIDs to restore", alias="productIds")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["productIds"]
