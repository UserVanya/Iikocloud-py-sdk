...
class WriteoffDocumentUpdateRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["comment", "conception", "date", "documentId", "expenseAccount", "isAutomatic", "isEditable", "items", "number", "organizationId", "storeFrom"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "items": [WriteoffDocumentCreateItem.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
