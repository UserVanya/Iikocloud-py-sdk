...
class TableOrderResponsePayload(BaseModel):
    """
    Order.
    """ # noqa: E501
    ...
    customer: Optional[DeliveryOrderResponseRegularCustomer] = Field(default=None, description="Guest.   > Allowed from version `7.5.2`.")
    ...
    split_order_between_cash_registers: Optional[SplitOrderBetweenCashRegisters] = Field(default=None, description="Need to split order between cash registers.  <remarks>  Not empty for orders in statuses New or Bill.  </remarks>", alias="splitOrderBetweenCashRegisters")
    status: DeliveryOrderResponseStatus = Field(description="Order status.")
    ...
    waiter: Optional[DeliveryOrderResponseEmployee] = Field(default=None, description="Order waiter.")
    ...
    __properties: ClassVar[List[str]] = ["combos", "conception", "customer", "discounts", "externalData", "guestsInfo", "items", "loyaltyInfo", "menuId", "number", "orderType", "payments", "phone", "priceCategory", "processedPaymentsSum", "sourceKey", "splitOrderBetweenCashRegisters", "status", "sum", "tabName", "tableIds", "terminalGroupId", "tips", "waiter", "whenBillPrinted", "whenClosed", "whenCreated"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "customer": DeliveryOrderResponseRegularCustomer.from_dict(obj["customer"]) if obj.get("customer") is not None else None,
            ...
            "waiter": DeliveryOrderResponseEmployee.from_dict(obj["waiter"]) if obj.get("waiter") is not None else None,
