...
class TipsTypeDefinition(BaseModel):
    """
    Tips type.
    """ # noqa: E501
    ...
    order_service_types: List[OrderTypeServiceType] = Field(description="Supported order service types.", alias="orderServiceTypes")
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "orderServiceTypes", "organizationIds", "paymentTypesIds"]
