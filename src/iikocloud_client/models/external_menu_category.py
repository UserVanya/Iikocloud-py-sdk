...
class ExternalMenuCategory(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["buttonImageUrl", "description", "headerImageUrl", "id", "iikoGroupId", "isHidden", "items", "labels", "name", "scheduleId", "scheduleName", "schedules", "tags"]
