...
class IncomingReturnedInvoiceGetResponse(BaseModel):
    """
    ...
    processing_mode: Optional[StrictStr] = Field(default=None, description="Processing mode (RETURN_DISH — return dish, RETURN_GOOD — return ingredients, DO_NOT_RETURN — no warehouse)", alias="processingMode")
    ...
    __properties: ClassVar[List[str]] = ["comment", "conception", "counteragent", "date", "dateCreated", "dateModified", "defaultStore", "documentId", "expenseAccount", "isAutomatic", "isEditable", "items", "number", "outgoingInvoiceId", "processingMode", "revenueAccount", "status", "userCreated", "userModified"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "items": [IncomingReturnedInvoiceGetItem.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
            "number": obj.get("number"),
            "outgoingInvoiceId": obj.get("outgoingInvoiceId"),
            "processingMode": obj.get("processingMode"),
