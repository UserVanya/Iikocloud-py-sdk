...
class ExternalMenuComboItem(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["barcodes", "description", "groups", "id", "isMarked", "name", "priceStrategy", "sizes", "sku", "type"]
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['COMBO']):
            raise ValueError("must be one of enum values ('COMBO')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "type": obj.get("type") if obj.get("type") is not None else 'COMBO'
        })
