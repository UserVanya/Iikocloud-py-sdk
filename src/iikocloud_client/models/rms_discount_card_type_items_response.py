...
class RmsDiscountCardTypeItemsResponse(BaseModel):
    """
    RMS pair wrapping - list of response items that belong to this RMS.
    """ # noqa: E501
    items: List[DiscountCardTypeInfo] = Field(description="Items for organization.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [DiscountCardTypeInfo.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
