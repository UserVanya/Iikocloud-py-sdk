...
class NomenclatureProductRateSchedule(BaseModel):
    """
    NomenclatureProductRateSchedule
    """ # noqa: E501
    rates: Optional[List[NomenclatureProductRate]] = Field(default=None, description="List of time-pay service rates")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "rates": [NomenclatureProductRate.from_dict(_item) for _item in obj["rates"]] if obj.get("rates") is not None else None
        })
