...
class CustomerCategoriesApi:
    ...
    async def add_customer_category(
        ...
        change_category_for_customer_request: Optional[ChangeCategoryForCustomerRequest] = None,
        ...
        :type timeout: int
        :param change_category_for_customer_request:
        :type change_category_for_customer_request: ChangeCategoryForCustomerRequest
        ...
        _param = self._add_customer_category_serialize(
            timeout=timeout,
            change_category_for_customer_request=change_category_for_customer_request,
    ...
    @validate_call
    async def add_customer_category_with_http_info(
        self,
        timeout: Annotated[Optional[StrictInt], Field(description="Timeout in seconds.")] = None,
        change_category_for_customer_request: Optional[ChangeCategoryForCustomerRequest] = None,
        _request_timeout: Union[
    ...
    @validate_call
    async def add_customer_category_without_preload_content(
        self,
        timeout: Annotated[Optional[StrictInt], Field(description="Timeout in seconds.")] = None,
        change_category_for_customer_request: Optional[ChangeCategoryForCustomerRequest] = None,
        _request_timeout: Union[
    ...
    def _add_customer_category_serialize(
        self,
        timeout,
        ...
        if change_category_for_customer_request is not None:
            _body_params = change_category_for_customer_request
    ...
    async def get_customer_categories(
        ...
        _param = self._get_customer_categories_serialize(
            timeout=timeout,
    ...
    @validate_call
    async def get_customer_categories_with_http_info(
        self,
        timeout: Annotated[Optional[StrictInt], Field(description="Timeout in seconds.")] = None,
        get_categories_request: Optional[GetCategoriesRequest] = None,
        _request_timeout: Union[
    ...
    @validate_call
    async def get_customer_categories_without_preload_content(
        self,
        timeout: Annotated[Optional[StrictInt], Field(description="Timeout in seconds.")] = None,
        get_categories_request: Optional[GetCategoriesRequest] = None,
        _request_timeout: Union[
    ...
    def _get_customer_categories_serialize(
        self,
        timeout,
    ...
    async def remove_customer_category(
        ...
        _param = self._remove_customer_category_serialize(
            timeout=timeout,
            change_category_for_customer_request=change_category_for_customer_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    async def remove_customer_category_with_http_info(
        self,
        timeout: Annotated[Optional[StrictInt], Field(description="Timeout in seconds.")] = None,
        change_category_for_customer_request: Optional[ChangeCategoryForCustomerRequest] = None,
        _request_timeout: Union[
    ...
    @validate_call
    async def remove_customer_category_without_preload_content(
        self,
        timeout: Annotated[Optional[StrictInt], Field(description="Timeout in seconds.")] = None,
        change_category_for_customer_request: Optional[ChangeCategoryForCustomerRequest] = None,
        _request_timeout: Union[
    ...
    def _remove_customer_category_serialize(
        self,
        timeout,
        change_category_for_customer_request,
        _request_auth,
