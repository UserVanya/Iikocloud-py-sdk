...
class OrganizationsApi:
    ...
    async def get_organization_settings(
        ...
        organizations_settings_request: Optional[OrganizationsSettingsRequest] = None,
        ...
        :type timeout: int
        :param organizations_settings_request:
        :type organizations_settings_request: OrganizationsSettingsRequest
        ...
        _param = self._get_organization_settings_serialize(
            timeout=timeout,
            organizations_settings_request=organizations_settings_request,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "OrganizationsSettingsResponse",
    ...
    @validate_call
    async def get_organization_settings_with_http_info(
        self,
        timeout: Annotated[Optional[StrictInt], Field(description="Timeout in seconds.")] = None,
        organizations_settings_request: Optional[OrganizationsSettingsRequest] = None,
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[OrganizationsSettingsResponse]:
        """Returns available to api-login user organizations specified settings.
    ...
    @validate_call
    async def get_organization_settings_without_preload_content(
        self,
        timeout: Annotated[Optional[StrictInt], Field(description="Timeout in seconds.")] = None,
        organizations_settings_request: Optional[OrganizationsSettingsRequest] = None,
        _request_timeout: Union[
    ...
    def _get_organization_settings_serialize(
        self,
        timeout,
        organizations_settings_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        if organizations_settings_request is not None:
            _body_params = organizations_settings_request
    ...
    @validate_call
    async def get_organizations_without_preload_content(
        self,
        timeout: Annotated[Optional[StrictInt], Field(description="Timeout in seconds.")] = None,
        get_organizations_request: Optional[GetOrganizationsRequest] = None,
        _request_timeout: Union[
