...
class AuthorizationApi:
    ...
    async def authenticate(
        ...
        get_access_token_request: Optional[GetAccessTokenRequest] = None,
        ...
        """(Deprecated) Retrieve session key for API user.

          > Deprecated: use `/api/v2/access_token` instead.

        :param timeout: Timeout in seconds.
        :type timeout: int
        :param get_access_token_request:
        :type get_access_token_request: GetAccessTokenRequest
        ...
        """ # noqa: E501
        warnings.warn("POST /api/1/access_token is deprecated.", DeprecationWarning)
    ...
    def _authenticate_serialize(
        ...
        if get_access_token_request is not None:
            _body_params = get_access_token_request
    ...
    async def authenticate_v2(
        self,
        timeout: Annotated[Optional[StrictInt], Field(description="Timeout in seconds.")] = None,
        get_access_token_v2_request: Optional[GetAccessTokenV2Request] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param timeout: Timeout in seconds.
        :type timeout: int
        :param get_access_token_v2_request:
        :type get_access_token_v2_request: GetAccessTokenV2Request
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._authenticate_v2_serialize(
            timeout=timeout,
            get_access_token_v2_request=get_access_token_v2_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    async def authenticate_v2_with_http_info(
        self,
        timeout: Annotated[Optional[StrictInt], Field(description="Timeout in seconds.")] = None,
        get_access_token_v2_request: Optional[GetAccessTokenV2Request] = None,
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetAccessTokenV2Response]:
        """Retrieve session key for API access (v2)
    ...
    @validate_call
    async def authenticate_v2_without_preload_content(
        self,
        timeout: Annotated[Optional[StrictInt], Field(description="Timeout in seconds.")] = None,
        get_access_token_v2_request: Optional[GetAccessTokenV2Request] = None,
        _request_timeout: Union[
    ...
    def _authenticate_v2_serialize(
        self,
        timeout,
        get_access_token_v2_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if get_access_token_v2_request is not None:
            _body_params = get_access_token_v2_request
