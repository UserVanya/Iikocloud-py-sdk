...
class OperationsApi:
    ...
    async def get_command_status(
        ...
        get_command_status_request: Optional[GetCommandStatusRequest] = None,
        ...
        :type timeout: int
        :param get_command_status_request:
        :type get_command_status_request: GetCommandStatusRequest
        ...
        _param = self._get_command_status_serialize(
            timeout=timeout,
            get_command_status_request=get_command_status_request,
    ...
    @validate_call
    async def get_command_status_with_http_info(
        self,
        timeout: Annotated[Optional[StrictInt], Field(description="Timeout in seconds.")] = None,
        get_command_status_request: Optional[GetCommandStatusRequest] = None,
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetCommandStatusResponse]:
        """Get status of command.
    ...
    @validate_call
    async def get_command_status_without_preload_content(
        self,
        timeout: Annotated[Optional[StrictInt], Field(description="Timeout in seconds.")] = None,
        get_command_status_request: Optional[GetCommandStatusRequest] = None,
        _request_timeout: Union[
    ...
    def _get_command_status_serialize(
        self,
        timeout,
        ...
        if get_command_status_request is not None:
            _body_params = get_command_status_request
