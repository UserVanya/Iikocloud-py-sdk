...
class MarketingSourcesApi:
    ...
    async def get_marketing_sources(
        ...
        marketing_sources_request: Optional[MarketingSourcesRequest] = None,
        ...
        :type timeout: int
        :param marketing_sources_request:
        :type marketing_sources_request: MarketingSourcesRequest
        ...
        _param = self._get_marketing_sources_serialize(
            timeout=timeout,
            marketing_sources_request=marketing_sources_request,
    ...
    @validate_call
    async def get_marketing_sources_with_http_info(
        self,
        timeout: Annotated[Optional[StrictInt], Field(description="Timeout in seconds.")] = None,
        marketing_sources_request: Optional[MarketingSourcesRequest] = None,
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[MarketingSourcesResponse]:
        """Marketing sources.
    ...
    @validate_call
    async def get_marketing_sources_without_preload_content(
        self,
        timeout: Annotated[Optional[StrictInt], Field(description="Timeout in seconds.")] = None,
        marketing_sources_request: Optional[MarketingSourcesRequest] = None,
        _request_timeout: Union[
    ...
    def _get_marketing_sources_serialize(
        self,
        timeout,
        marketing_sources_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        if marketing_sources_request is not None:
            _body_params = marketing_sources_request
