...
class LicensesApi:
    ...
    async def list_licenses(
        ...
        get_license_list_request: Optional[GetLicenseListRequest] = None,
        ...
        :type timeout: int
        :param get_license_list_request:
        :type get_license_list_request: GetLicenseListRequest
    ...
    @validate_call
    async def list_licenses_with_http_info(
        self,
        timeout: Annotated[Optional[StrictInt], Field(description="Timeout in seconds.")] = None,
        get_license_list_request: Optional[GetLicenseListRequest] = None,
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetLicenseListResponse]:
        """Get license list information for the API login.
    ...
    @validate_call
    async def list_licenses_without_preload_content(
        self,
        timeout: Annotated[Optional[StrictInt], Field(description="Timeout in seconds.")] = None,
        get_license_list_request: Optional[GetLicenseListRequest] = None,
        _request_timeout: Union[
    ...
    def _list_licenses_serialize(
        ...
        if get_license_list_request is not None:
            _body_params = get_license_list_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/licenses/v2/list',
