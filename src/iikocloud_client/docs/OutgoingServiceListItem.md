...
json = "{}"
# create an instance of OutgoingServiceListItem from a JSON string
outgoing_service_list_item_instance = OutgoingServiceListItem.from_json(json)
# print the JSON string representation of the object
print(OutgoingServiceListItem.to_json())

# convert the object into a dict
outgoing_service_list_item_dict = outgoing_service_list_item_instance.to_dict()
# create an instance of OutgoingServiceListItem from a dict
outgoing_service_list_item_from_dict = OutgoingServiceListItem.from_dict(outgoing_service_list_item_dict)
```
