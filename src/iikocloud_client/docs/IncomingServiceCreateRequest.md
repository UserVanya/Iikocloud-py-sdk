...
json = "{}"
# create an instance of IncomingServiceCreateRequest from a JSON string
incoming_service_create_request_instance = IncomingServiceCreateRequest.from_json(json)
# print the JSON string representation of the object
print(IncomingServiceCreateRequest.to_json())

# convert the object into a dict
incoming_service_create_request_dict = incoming_service_create_request_instance.to_dict()
# create an instance of IncomingServiceCreateRequest from a dict
incoming_service_create_request_from_dict = IncomingServiceCreateRequest.from_dict(incoming_service_create_request_dict)
```
