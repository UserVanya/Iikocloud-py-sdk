...
json = "{}"
# create an instance of OutgoingServiceUpdateRequest from a JSON string
outgoing_service_update_request_instance = OutgoingServiceUpdateRequest.from_json(json)
# print the JSON string representation of the object
print(OutgoingServiceUpdateRequest.to_json())

# convert the object into a dict
outgoing_service_update_request_dict = outgoing_service_update_request_instance.to_dict()
# create an instance of OutgoingServiceUpdateRequest from a dict
outgoing_service_update_request_from_dict = OutgoingServiceUpdateRequest.from_dict(outgoing_service_update_request_dict)
```
