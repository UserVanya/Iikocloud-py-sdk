...
json = "{}"
# create an instance of DeliveryOrderDraft from a JSON string
delivery_order_draft_instance = DeliveryOrderDraft.from_json(json)
# print the JSON string representation of the object
print(DeliveryOrderDraft.to_json())

# convert the object into a dict
delivery_order_draft_dict = delivery_order_draft_instance.to_dict()
# create an instance of DeliveryOrderDraft from a dict
delivery_order_draft_from_dict = DeliveryOrderDraft.from_dict(delivery_order_draft_dict)
```
