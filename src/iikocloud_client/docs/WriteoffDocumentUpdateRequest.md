...
json = "{}"
# create an instance of WriteoffDocumentUpdateRequest from a JSON string
writeoff_document_update_request_instance = WriteoffDocumentUpdateRequest.from_json(json)
# print the JSON string representation of the object
print(WriteoffDocumentUpdateRequest.to_json())

# convert the object into a dict
writeoff_document_update_request_dict = writeoff_document_update_request_instance.to_dict()
# create an instance of WriteoffDocumentUpdateRequest from a dict
writeoff_document_update_request_from_dict = WriteoffDocumentUpdateRequest.from_dict(writeoff_document_update_request_dict)
```
