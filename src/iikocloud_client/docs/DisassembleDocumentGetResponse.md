...
**items** | [**List[DisassembleDocumentGetItem]**](DisassembleDocumentGetItem.md) | List of document items | [optional] 
...
json = "{}"
# create an instance of DisassembleDocumentGetResponse from a JSON string
disassemble_document_get_response_instance = DisassembleDocumentGetResponse.from_json(json)
# print the JSON string representation of the object
print(DisassembleDocumentGetResponse.to_json())

# convert the object into a dict
disassemble_document_get_response_dict = disassemble_document_get_response_instance.to_dict()
# create an instance of DisassembleDocumentGetResponse from a dict
disassemble_document_get_response_from_dict = DisassembleDocumentGetResponse.from_dict(disassemble_document_get_response_dict)
```
