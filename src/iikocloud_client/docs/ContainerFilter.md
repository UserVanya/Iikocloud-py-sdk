...
json = "{}"
# create an instance of ContainerFilter from a JSON string
container_filter_instance = ContainerFilter.from_json(json)
# print the JSON string representation of the object
print(ContainerFilter.to_json())

# convert the object into a dict
container_filter_dict = container_filter_instance.to_dict()
# create an instance of ContainerFilter from a dict
container_filter_from_dict = ContainerFilter.from_dict(container_filter_dict)
```
