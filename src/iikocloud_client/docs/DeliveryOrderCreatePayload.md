...
**guests** | [**Guests**](Guests.md) | Guest details. Not equal to the customer who makes an order. | [optional] 
...
**order_service_type** | [**DeliveryOrderCreateServiceType**](DeliveryOrderCreateServiceType.md) | Order service type.  &gt; Only one of the fields must be defined: **orderTypeId** or **orderServiceType**.   &gt; Allowed from version &#x60;7.0.3&#x60;. | [optional] 
...
json = "{}"
# create an instance of DeliveryOrderCreatePayload from a JSON string
delivery_order_create_payload_instance = DeliveryOrderCreatePayload.from_json(json)
# print the JSON string representation of the object
print(DeliveryOrderCreatePayload.to_json())

# convert the object into a dict
delivery_order_create_payload_dict = delivery_order_create_payload_instance.to_dict()
# create an instance of DeliveryOrderCreatePayload from a dict
delivery_order_create_payload_from_dict = DeliveryOrderCreatePayload.from_dict(delivery_order_create_payload_dict)
```
