...
json = "{}"
# create an instance of DeliveryOrder from a JSON string
delivery_order_instance = DeliveryOrder.from_json(json)
# print the JSON string representation of the object
print(DeliveryOrder.to_json())

# convert the object into a dict
delivery_order_dict = delivery_order_instance.to_dict()
# create an instance of DeliveryOrder from a dict
delivery_order_from_dict = DeliveryOrder.from_dict(delivery_order_dict)
```
