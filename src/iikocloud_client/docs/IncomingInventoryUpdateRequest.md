...
json = "{}"
# create an instance of IncomingInventoryUpdateRequest from a JSON string
incoming_inventory_update_request_instance = IncomingInventoryUpdateRequest.from_json(json)
# print the JSON string representation of the object
print(IncomingInventoryUpdateRequest.to_json())

# convert the object into a dict
incoming_inventory_update_request_dict = incoming_inventory_update_request_instance.to_dict()
# create an instance of IncomingInventoryUpdateRequest from a dict
incoming_inventory_update_request_from_dict = IncomingInventoryUpdateRequest.from_dict(incoming_inventory_update_request_dict)
```
