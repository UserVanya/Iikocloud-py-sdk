...
json = "{}"
# create an instance of MenuSectionFilter from a JSON string
menu_section_filter_instance = MenuSectionFilter.from_json(json)
# print the JSON string representation of the object
print(MenuSectionFilter.to_json())

# convert the object into a dict
menu_section_filter_dict = menu_section_filter_instance.to_dict()
# create an instance of MenuSectionFilter from a dict
menu_section_filter_from_dict = MenuSectionFilter.from_dict(menu_section_filter_dict)
```
