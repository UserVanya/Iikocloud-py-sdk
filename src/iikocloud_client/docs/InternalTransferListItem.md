...
json = "{}"
# create an instance of InternalTransferListItem from a JSON string
internal_transfer_list_item_instance = InternalTransferListItem.from_json(json)
# print the JSON string representation of the object
print(InternalTransferListItem.to_json())

# convert the object into a dict
internal_transfer_list_item_dict = internal_transfer_list_item_instance.to_dict()
# create an instance of InternalTransferListItem from a dict
internal_transfer_list_item_from_dict = InternalTransferListItem.from_dict(internal_transfer_list_item_dict)
```
