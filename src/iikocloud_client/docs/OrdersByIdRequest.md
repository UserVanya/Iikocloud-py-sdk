...
json = "{}"
# create an instance of OrdersByIdRequest from a JSON string
orders_by_id_request_instance = OrdersByIdRequest.from_json(json)
# print the JSON string representation of the object
print(OrdersByIdRequest.to_json())

# convert the object into a dict
orders_by_id_request_dict = orders_by_id_request_instance.to_dict()
# create an instance of OrdersByIdRequest from a dict
orders_by_id_request_from_dict = OrdersByIdRequest.from_dict(orders_by_id_request_dict)
```
