...
**product_id** | **UUID** | UUID of the product to update | 
...
nomenclature_product_update_request_instance = NomenclatureProductUpdateRequest.from_json(json)
# print the JSON string representation of the object
print(NomenclatureProductUpdateRequest.to_json())

# convert the object into a dict
nomenclature_product_update_request_dict = nomenclature_product_update_request_instance.to_dict()
# create an instance of NomenclatureProductUpdateRequest from a dict
nomenclature_product_update_request_from_dict = NomenclatureProductUpdateRequest.from_dict(nomenclature_product_update_request_dict)
```
