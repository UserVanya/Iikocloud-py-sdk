...
**group_id** | **UUID** | UUID of the group to update | 
...
json = "{}"
# create an instance of NomenclatureGroupUpdateRequest from a JSON string
nomenclature_group_update_request_instance = NomenclatureGroupUpdateRequest.from_json(json)
# print the JSON string representation of the object
print(NomenclatureGroupUpdateRequest.to_json())

# convert the object into a dict
nomenclature_group_update_request_dict = nomenclature_group_update_request_instance.to_dict()
# create an instance of NomenclatureGroupUpdateRequest from a dict
nomenclature_group_update_request_from_dict = NomenclatureGroupUpdateRequest.from_dict(nomenclature_group_update_request_dict)
```
