...
json = "{}"
# create an instance of NomenclatureRequest from a JSON string
nomenclature_request_instance = NomenclatureRequest.from_json(json)
# print the JSON string representation of the object
print(NomenclatureRequest.to_json())

# convert the object into a dict
nomenclature_request_dict = nomenclature_request_instance.to_dict()
# create an instance of NomenclatureRequest from a dict
nomenclature_request_from_dict = NomenclatureRequest.from_dict(nomenclature_request_dict)
```
