...
json = "{}"
# create an instance of IncomingServiceListItem from a JSON string
incoming_service_list_item_instance = IncomingServiceListItem.from_json(json)
# print the JSON string representation of the object
print(IncomingServiceListItem.to_json())

# convert the object into a dict
incoming_service_list_item_dict = incoming_service_list_item_instance.to_dict()
# create an instance of IncomingServiceListItem from a dict
incoming_service_list_item_from_dict = IncomingServiceListItem.from_dict(incoming_service_list_item_dict)
```
