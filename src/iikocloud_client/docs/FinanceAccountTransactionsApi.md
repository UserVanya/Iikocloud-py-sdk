# iikocloud_client.FinanceAccountTransactionsApi

All URIs are relative to *https://api-ru.iiko.services*

Method | HTTP request | Description
------------- | ------------- | -------------
[**list_finance_account_transactions**](FinanceAccountTransactionsApi.md#list_finance_account_transactions) | **POST** /api/finance/v1/account_transactions/list | Get account transactions


# **list_finance_account_transactions**
> AccountTransactionsResponse list_finance_account_transactions(account_transactions_list_request, timeout=timeout)
...
async with iikocloud_client.ApiClient(configuration) as api_client:
    ...
    api_instance = iikocloud_client.FinanceAccountTransactionsApi(api_client)
    ...
    try:
        # Get account transactions
        api_response = await api_instance.list_finance_account_transactions(account_transactions_list_request, timeout=timeout)
        print("The response of FinanceAccountTransactionsApi->list_finance_account_transactions:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling FinanceAccountTransactionsApi->list_finance_account_transactions: %s\n" % e)
```
