...
class TestExtendedOrganizationInfo(unittest.TestCase):
    """ExtendedOrganizationInfo unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ExtendedOrganizationInfo:
        """Test ExtendedOrganizationInfo
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ExtendedOrganizationInfo`
        """
        model = ExtendedOrganizationInfo()
        if include_optional:
            return ExtendedOrganizationInfo(
    ...
    def testExtendedOrganizationInfo(self):
        """Test ExtendedOrganizationInfo"""
