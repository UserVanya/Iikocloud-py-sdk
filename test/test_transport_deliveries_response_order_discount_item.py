...
class TestTransportDeliveriesResponseOrderDiscountItem(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> TransportDeliveriesResponseOrderDiscountItem:
        """Test TransportDeliveriesResponseOrderDiscountItem
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TransportDeliveriesResponseOrderDiscountItem`
        """
    ...
    def testTransportDeliveriesResponseOrderDiscountItem(self):
        """Test TransportDeliveriesResponseOrderDiscountItem"""
