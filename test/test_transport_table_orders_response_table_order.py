    ...
    def make_instance(self, include_optional) -> TransportTableOrdersResponseTableOrder:
        ...
        if include_optional:
            return TransportTableOrdersResponseTableOrder(
                ...
                customer = iikocloud_client.models.order_regular_customer_schema.OrderRegularCustomerSchema(
                    id = '', 
                    name = '', 
                    surname = '', 
                    comment = '', 
                ...
                waiter = iikocloud_client.models.order_employee_schema.OrderEmployeeSchema(
                    id = '', 
                    name = '', 
                    phone = '', ),
                tab_name = '',
