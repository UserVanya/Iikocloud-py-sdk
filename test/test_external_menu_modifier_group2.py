...
class TestExternalMenuModifierGroup2(unittest.TestCase):
    """ExternalMenuModifierGroup2 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ExternalMenuModifierGroup2:
        """Test ExternalMenuModifierGroup2
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ExternalMenuModifierGroup2`
        """
        model = ExternalMenuModifierGroup2()
        if include_optional:
    ...
    def testExternalMenuModifierGroup2(self):
        """Test ExternalMenuModifierGroup2"""
