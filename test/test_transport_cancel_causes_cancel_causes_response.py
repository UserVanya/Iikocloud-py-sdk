...
class TestTransportCancelCausesCancelCausesResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> TransportCancelCausesCancelCausesResponse:
        """Test TransportCancelCausesCancelCausesResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TransportCancelCausesCancelCausesResponse`
        """
        model = TransportCancelCausesCancelCausesResponse()
        if include_optional:
    ...
    def testTransportCancelCausesCancelCausesResponse(self):
        """Test TransportCancelCausesCancelCausesResponse"""
