...
class TestTransportDeliveriesRequestUpdateOrderChangePaymentsRequest(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> TransportDeliveriesRequestUpdateOrderChangePaymentsRequest:
        """Test TransportDeliveriesRequestUpdateOrderChangePaymentsRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TransportDeliveriesRequestUpdateOrderChangePaymentsRequest`
        """
        model = TransportDeliveriesRequestUpdateOrderChangePaymentsRequest()
        if include_optional:
            return TransportDeliveriesRequestUpdateOrderChangePaymentsRequest(
                organization_id = '',
                order_id = '',
                payments = [
    ...
    def testTransportDeliveriesRequestUpdateOrderChangePaymentsRequest(self):
        """Test TransportDeliveriesRequestUpdateOrderChangePaymentsRequest"""
