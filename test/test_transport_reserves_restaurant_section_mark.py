...
class TestTransportReservesRestaurantSectionMark(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> TransportReservesRestaurantSectionMark:
        """Test TransportReservesRestaurantSectionMark
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TransportReservesRestaurantSectionMark`
        """
        model = TransportReservesRestaurantSectionMark()
        if include_optional:
    ...
    def testTransportReservesRestaurantSectionMark(self):
        """Test TransportReservesRestaurantSectionMark"""
