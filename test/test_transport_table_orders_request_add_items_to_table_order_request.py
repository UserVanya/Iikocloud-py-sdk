...
class TestTransportTableOrdersRequestAddItemsToTableOrderRequest(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> TransportTableOrdersRequestAddItemsToTableOrderRequest:
        """Test TransportTableOrdersRequestAddItemsToTableOrderRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TransportTableOrdersRequestAddItemsToTableOrderRequest`
        """
    ...
    def testTransportTableOrdersRequestAddItemsToTableOrderRequest(self):
        """Test TransportTableOrdersRequestAddItemsToTableOrderRequest"""
