...
class TestComboGroupDto(unittest.TestCase):
    """ComboGroupDto unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ComboGroupDto:
        """Test ComboGroupDto
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ComboGroupDto`
        """
        model = ComboGroupDto()
        if include_optional:
            return ComboGroupDto(
                id = None,
                name = '',
                is_main_group = True,
                items = [
