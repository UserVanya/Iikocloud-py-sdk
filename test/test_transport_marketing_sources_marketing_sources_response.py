...
class TestTransportMarketingSourcesMarketingSourcesResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> TransportMarketingSourcesMarketingSourcesResponse:
        """Test TransportMarketingSourcesMarketingSourcesResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TransportMarketingSourcesMarketingSourcesResponse`
        """
        model = TransportMarketingSourcesMarketingSourcesResponse()
        if include_optional:
    ...
    def testTransportMarketingSourcesMarketingSourcesResponse(self):
        """Test TransportMarketingSourcesMarketingSourcesResponse"""
