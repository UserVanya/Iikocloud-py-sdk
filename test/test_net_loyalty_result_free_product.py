...
class TestNetLoyaltyResultFreeProduct(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> NetLoyaltyResultFreeProduct:
        """Test NetLoyaltyResultFreeProduct
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetLoyaltyResultFreeProduct`
        """
        model = NetLoyaltyResultFreeProduct()
        if include_optional:
            return NetLoyaltyResultFreeProduct(
                id = '',
                code = '',
                size = [
                    ''
    ...
    def testNetLoyaltyResultFreeProduct(self):
        """Test NetLoyaltyResultFreeProduct"""
