...
class TestNetReportGetTransactionsReportByPeriodResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> NetReportGetTransactionsReportByPeriodResponse:
        """Test NetReportGetTransactionsReportByPeriodResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetReportGetTransactionsReportByPeriodResponse`
        """
        model = NetReportGetTransactionsReportByPeriodResponse()
        if include_optional:
    ...
    def testNetReportGetTransactionsReportByPeriodResponse(self):
        """Test NetReportGetTransactionsReportByPeriodResponse"""
