...
class TestTransportCommonRmsItemsResponseWrapperCourierLocations(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> TransportCommonRmsItemsResponseWrapperCourierLocations:
        """Test TransportCommonRmsItemsResponseWrapperCourierLocations
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TransportCommonRmsItemsResponseWrapperCourierLocations`
        """
        model = TransportCommonRmsItemsResponseWrapperCourierLocations()
        if include_optional:
    ...
    def testTransportCommonRmsItemsResponseWrapperCourierLocations(self):
        """Test TransportCommonRmsItemsResponseWrapperCourierLocations"""
