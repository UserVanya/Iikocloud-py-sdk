...
class TestTransportOrganizationsOrganizationsSettingsResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> TransportOrganizationsOrganizationsSettingsResponse:
        """Test TransportOrganizationsOrganizationsSettingsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TransportOrganizationsOrganizationsSettingsResponse`
        """
        model = TransportOrganizationsOrganizationsSettingsResponse()
        if include_optional:
    ...
    def testTransportOrganizationsOrganizationsSettingsResponse(self):
        """Test TransportOrganizationsOrganizationsSettingsResponse"""
