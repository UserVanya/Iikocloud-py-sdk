...
class TestTransportOrderTypesOrderTypesResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> TransportOrderTypesOrderTypesResponse:
        """Test TransportOrderTypesOrderTypesResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TransportOrderTypesOrderTypesResponse`
        """
        model = TransportOrderTypesOrderTypesResponse()
        if include_optional:
    ...
    def testTransportOrderTypesOrderTypesResponse(self):
        """Test TransportOrderTypesOrderTypesResponse"""
