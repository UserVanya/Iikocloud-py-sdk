...
class TestNetLoyaltyResultLoyaltyProgramResult(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> NetLoyaltyResultLoyaltyProgramResult:
        """Test NetLoyaltyResultLoyaltyProgramResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetLoyaltyResultLoyaltyProgramResult`
        """
        model = NetLoyaltyResultLoyaltyProgramResult()
        if include_optional:
            return NetLoyaltyResultLoyaltyProgramResult(
    ...
    def testNetLoyaltyResultLoyaltyProgramResult(self):
        """Test NetLoyaltyResultLoyaltyProgramResult"""
