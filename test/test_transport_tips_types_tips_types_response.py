...
class TestTransportTipsTypesTipsTypesResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> TransportTipsTypesTipsTypesResponse:
        """Test TransportTipsTypesTipsTypesResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TransportTipsTypesTipsTypesResponse`
        """
        model = TransportTipsTypesTipsTypesResponse()
        if include_optional:
    ...
    def testTransportTipsTypesTipsTypesResponse(self):
        """Test TransportTipsTypesTipsTypesResponse"""
