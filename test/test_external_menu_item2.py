...
class TestExternalMenuItem2(unittest.TestCase):
    """ExternalMenuItem2 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ExternalMenuItem2:
        """Test ExternalMenuItem2
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ExternalMenuItem2`
        """
        model = ExternalMenuItem2()
        if include_optional:
            return ExternalMenuItem2(
                sku = '',
                name = '',
                description = '',
                item_sizes = [
    ...
    def testExternalMenuItem2(self):
        """Test ExternalMenuItem2"""
