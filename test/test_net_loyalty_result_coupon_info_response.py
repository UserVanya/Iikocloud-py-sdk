...
class TestNetLoyaltyResultCouponInfoResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> NetLoyaltyResultCouponInfoResponse:
        """Test NetLoyaltyResultCouponInfoResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetLoyaltyResultCouponInfoResponse`
        """
        model = NetLoyaltyResultCouponInfoResponse()
        if include_optional:
    ...
    def testNetLoyaltyResultCouponInfoResponse(self):
        """Test NetLoyaltyResultCouponInfoResponse"""
