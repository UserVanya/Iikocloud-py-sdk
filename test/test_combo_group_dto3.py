...
class TestComboGroupDto3(unittest.TestCase):
    """ComboGroupDto3 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ComboGroupDto3:
        """Test ComboGroupDto3
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ComboGroupDto3`
        """
        model = ComboGroupDto3()
        if include_optional:
            return ComboGroupDto3(
                id = None,
                name = '',
                is_main_group = True,
                items = [
