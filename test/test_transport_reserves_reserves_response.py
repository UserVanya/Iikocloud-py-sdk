...
class TestTransportReservesReservesResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> TransportReservesReservesResponse:
        """Test TransportReservesReservesResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TransportReservesReservesResponse`
        """
        model = TransportReservesReservesResponse()
        if include_optional:
    ...
    def testTransportReservesReservesResponse(self):
        """Test TransportReservesReservesResponse"""
