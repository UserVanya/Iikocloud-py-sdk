...
class TestNetLoyaltyResultComboGroup(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> NetLoyaltyResultComboGroup:
        """Test NetLoyaltyResultComboGroup
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetLoyaltyResultComboGroup`
        """
        model = NetLoyaltyResultComboGroup()
        if include_optional:
            return NetLoyaltyResultComboGroup(
                id = '',
                name = '',
                is_main_group = True,
                products = [
    ...
    def testNetLoyaltyResultComboGroup(self):
        """Test NetLoyaltyResultComboGroup"""
