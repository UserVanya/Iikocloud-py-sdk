...
class TestTransportNomenclatureMenusDataResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> TransportNomenclatureMenusDataResponse:
        """Test TransportNomenclatureMenusDataResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TransportNomenclatureMenusDataResponse`
        """
        model = TransportNomenclatureMenusDataResponse()
        if include_optional:
    ...
    def testTransportNomenclatureMenusDataResponse(self):
        """Test TransportNomenclatureMenusDataResponse"""
