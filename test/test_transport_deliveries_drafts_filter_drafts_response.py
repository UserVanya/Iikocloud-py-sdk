...
class TestTransportDeliveriesDraftsFilterDraftsResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> TransportDeliveriesDraftsFilterDraftsResponse:
        """Test TransportDeliveriesDraftsFilterDraftsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TransportDeliveriesDraftsFilterDraftsResponse`
        """
        model = TransportDeliveriesDraftsFilterDraftsResponse()
        if include_optional:
    ...
    def testTransportDeliveriesDraftsFilterDraftsResponse(self):
        """Test TransportDeliveriesDraftsFilterDraftsResponse"""
