...
class TestTransportDeliveriesResponseOrderDeletionMethod(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> TransportDeliveriesResponseOrderDeletionMethod:
        """Test TransportDeliveriesResponseOrderDeletionMethod
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TransportDeliveriesResponseOrderDeletionMethod`
        """
        model = TransportDeliveriesResponseOrderDeletionMethod()
        if include_optional:
    ...
    def testTransportDeliveriesResponseOrderDeletionMethod(self):
        """Test TransportDeliveriesResponseOrderDeletionMethod"""
