...
class TestTransportItemDto(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> TransportItemDto:
        """Test TransportItemDto
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TransportItemDto`
        """
        model = TransportItemDto()
        if include_optional:
