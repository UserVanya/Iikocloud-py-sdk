...
class TestNetOrganizationMarketingCampaignInfo(unittest.TestCase):
    """NetOrganizationMarketingCampaignInfo unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetOrganizationMarketingCampaignInfo:
        """Test NetOrganizationMarketingCampaignInfo
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetOrganizationMarketingCampaignInfo`
        """
        model = NetOrganizationMarketingCampaignInfo()
        if include_optional:
            return NetOrganizationMarketingCampaignInfo(
                id = '',
                program_id = '',
                name = '',
                description = '',
    ...
    def testNetOrganizationMarketingCampaignInfo(self):
        """Test NetOrganizationMarketingCampaignInfo"""
