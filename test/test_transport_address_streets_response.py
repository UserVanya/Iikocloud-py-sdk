...
class TestTransportAddressStreetsResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> TransportAddressStreetsResponse:
        """Test TransportAddressStreetsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TransportAddressStreetsResponse`
        """
        model = TransportAddressStreetsResponse()
        if include_optional:
    ...
    def testTransportAddressStreetsResponse(self):
        """Test TransportAddressStreetsResponse"""
