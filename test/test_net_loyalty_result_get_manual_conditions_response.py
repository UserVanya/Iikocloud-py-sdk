...
class TestNetLoyaltyResultGetManualConditionsResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> NetLoyaltyResultGetManualConditionsResponse:
        """Test NetLoyaltyResultGetManualConditionsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetLoyaltyResultGetManualConditionsResponse`
        """
        model = NetLoyaltyResultGetManualConditionsResponse()
        if include_optional:
    ...
    def testNetLoyaltyResultGetManualConditionsResponse(self):
        """Test NetLoyaltyResultGetManualConditionsResponse"""
