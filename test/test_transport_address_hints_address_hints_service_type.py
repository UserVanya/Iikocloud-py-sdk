...
class TestTransportAddressHintsAddressHintsServiceType(unittest.TestCase):
    ...
    def testTransportAddressHintsAddressHintsServiceType(self):
        """Test TransportAddressHintsAddressHintsServiceType"""
        # inst = TransportAddressHintsAddressHintsServiceType()
