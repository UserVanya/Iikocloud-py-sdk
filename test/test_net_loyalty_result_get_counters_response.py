...
class TestNetLoyaltyResultGetCountersResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> NetLoyaltyResultGetCountersResponse:
        """Test NetLoyaltyResultGetCountersResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetLoyaltyResultGetCountersResponse`
        """
        model = NetLoyaltyResultGetCountersResponse()
        if include_optional:
    ...
    def testNetLoyaltyResultGetCountersResponse(self):
        """Test NetLoyaltyResultGetCountersResponse"""
