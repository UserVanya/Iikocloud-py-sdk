...
class TestTransportNomenclatureGroupModifierInfo(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> TransportNomenclatureGroupModifierInfo:
        """Test TransportNomenclatureGroupModifierInfo
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TransportNomenclatureGroupModifierInfo`
        """
        model = TransportNomenclatureGroupModifierInfo()
        if include_optional:
            return TransportNomenclatureGroupModifierInfo(
                id = '',
                min_amount = 56,
                max_amount = 56,
                required = True,
    ...
    def testTransportNomenclatureGroupModifierInfo(self):
        """Test TransportNomenclatureGroupModifierInfo"""
