...
class TestTransportDeliveriesRequestCreateOrderOrder(unittest.TestCase):
    """TransportDeliveriesRequestCreateOrderOrder unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TransportDeliveriesRequestCreateOrderOrder:
        """Test TransportDeliveriesRequestCreateOrderOrder
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TransportDeliveriesRequestCreateOrderOrder`
        """
        model = TransportDeliveriesRequestCreateOrderOrder()
        if include_optional:
            return TransportDeliveriesRequestCreateOrderOrder(
                id = '',
                external_number = '',
    ...
    def testTransportDeliveriesRequestCreateOrderOrder(self):
        """Test TransportDeliveriesRequestCreateOrderOrder"""
