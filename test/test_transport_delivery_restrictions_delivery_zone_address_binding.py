...
class TestTransportDeliveryRestrictionsDeliveryZoneAddressBinding(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> TransportDeliveryRestrictionsDeliveryZoneAddressBinding:
        """Test TransportDeliveryRestrictionsDeliveryZoneAddressBinding
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TransportDeliveryRestrictionsDeliveryZoneAddressBinding`
        """
        model = TransportDeliveryRestrictionsDeliveryZoneAddressBinding()
        if include_optional:
    ...
    def testTransportDeliveryRestrictionsDeliveryZoneAddressBinding(self):
        """Test TransportDeliveryRestrictionsDeliveryZoneAddressBinding"""
