...
class TestTransportTableOrdersRequestAddCustomerToTableOrderRequest(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> TransportTableOrdersRequestAddCustomerToTableOrderRequest:
        """Test TransportTableOrdersRequestAddCustomerToTableOrderRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TransportTableOrdersRequestAddCustomerToTableOrderRequest`
        """
        model = TransportTableOrdersRequestAddCustomerToTableOrderRequest()
        if include_optional:
    ...
    def testTransportTableOrdersRequestAddCustomerToTableOrderRequest(self):
        """Test TransportTableOrdersRequestAddCustomerToTableOrderRequest"""
