...
class TestTransportAddressRegionsResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> TransportAddressRegionsResponse:
        """Test TransportAddressRegionsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TransportAddressRegionsResponse`
        """
        model = TransportAddressRegionsResponse()
        if include_optional:
    ...
    def testTransportAddressRegionsResponse(self):
        """Test TransportAddressRegionsResponse"""
