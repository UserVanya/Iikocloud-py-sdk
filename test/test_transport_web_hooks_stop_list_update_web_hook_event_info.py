...
class TestTransportWebHooksStopListUpdateWebHookEventInfo(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> TransportWebHooksStopListUpdateWebHookEventInfo:
        """Test TransportWebHooksStopListUpdateWebHookEventInfo
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TransportWebHooksStopListUpdateWebHookEventInfo`
        """
        model = TransportWebHooksStopListUpdateWebHookEventInfo()
        if include_optional:
            return TransportWebHooksStopListUpdateWebHookEventInfo(
    ...
    def testTransportWebHooksStopListUpdateWebHookEventInfo(self):
        """Test TransportWebHooksStopListUpdateWebHookEventInfo"""
