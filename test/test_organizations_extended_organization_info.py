...
class TestOrganizationsExtendedOrganizationInfo(unittest.TestCase):
    """OrganizationsExtendedOrganizationInfo unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OrganizationsExtendedOrganizationInfo:
        """Test OrganizationsExtendedOrganizationInfo
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OrganizationsExtendedOrganizationInfo`
        """
        model = OrganizationsExtendedOrganizationInfo()
        if include_optional:
            return OrganizationsExtendedOrganizationInfo(
                country = '',
                restaurant_address = '',
                latitude = 1.337,
                longitude = 1.337,
    ...
    def testOrganizationsExtendedOrganizationInfo(self):
        """Test OrganizationsExtendedOrganizationInfo"""
