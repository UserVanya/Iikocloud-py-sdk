...
class TestTransportReservesSectionSchema(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> TransportReservesSectionSchema:
        """Test TransportReservesSectionSchema
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TransportReservesSectionSchema`
        """
        model = TransportReservesSectionSchema()
        if include_optional:
            return TransportReservesSectionSchema(
                width = 56,
                height = 56,
                mark_elements = [
    ...
    def testTransportReservesSectionSchema(self):
        """Test TransportReservesSectionSchema"""
