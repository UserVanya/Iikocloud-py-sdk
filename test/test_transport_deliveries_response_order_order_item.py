...
class TestTransportDeliveriesResponseOrderOrderItem(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> TransportDeliveriesResponseOrderOrderItem:
        """Test TransportDeliveriesResponseOrderOrderItem
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TransportDeliveriesResponseOrderOrderItem`
        """
        model = TransportDeliveriesResponseOrderOrderItem()
        if include_optional:
    ...
    def testTransportDeliveriesResponseOrderOrderItem(self):
        """Test TransportDeliveriesResponseOrderOrderItem"""
