...
class TestTransportReservesGetRestaurantSectionsResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> TransportReservesGetRestaurantSectionsResponse:
        """Test TransportReservesGetRestaurantSectionsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TransportReservesGetRestaurantSectionsResponse`
        """
        model = TransportReservesGetRestaurantSectionsResponse()
        if include_optional:
    ...
    def testTransportReservesGetRestaurantSectionsResponse(self):
        """Test TransportReservesGetRestaurantSectionsResponse"""
