...
class TestNetNotificationCheckSmsStatusResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> NetNotificationCheckSmsStatusResponse:
        """Test NetNotificationCheckSmsStatusResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetNotificationCheckSmsStatusResponse`
        """
        model = NetNotificationCheckSmsStatusResponse()
        if include_optional:
    ...
    def testNetNotificationCheckSmsStatusResponse(self):
        """Test NetNotificationCheckSmsStatusResponse"""
