...
class TestTransportTableOrdersResponseSplitOrderBetweenCashRegisters(unittest.TestCase):
    ...
    def testTransportTableOrdersResponseSplitOrderBetweenCashRegisters(self):
        """Test TransportTableOrdersResponseSplitOrderBetweenCashRegisters"""
        # inst = TransportTableOrdersResponseSplitOrderBetweenCashRegisters()
