...
class TestTransportDeliveriesDraftsGetDraftResponse(unittest.TestCase):
    """TransportDeliveriesDraftsGetDraftResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TransportDeliveriesDraftsGetDraftResponse:
        """Test TransportDeliveriesDraftsGetDraftResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TransportDeliveriesDraftsGetDraftResponse`
        """
        model = TransportDeliveriesDraftsGetDraftResponse()
        if include_optional:
            return TransportDeliveriesDraftsGetDraftResponse(
                correlation_id = '',
    ...
    def testTransportDeliveriesDraftsGetDraftResponse(self):
        """Test TransportDeliveriesDraftsGetDraftResponse"""
