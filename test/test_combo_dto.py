...
class TestComboDto(unittest.TestCase):
    """ComboDto unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ComboDto:
        """Test ComboDto
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ComboDto`
        """
        model = ComboDto()
        if include_optional:
            return ComboDto(
