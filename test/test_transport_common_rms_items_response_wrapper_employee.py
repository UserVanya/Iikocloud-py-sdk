...
class TestTransportCommonRmsItemsResponseWrapperEmployee(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> TransportCommonRmsItemsResponseWrapperEmployee:
        """Test TransportCommonRmsItemsResponseWrapperEmployee
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TransportCommonRmsItemsResponseWrapperEmployee`
        """
        model = TransportCommonRmsItemsResponseWrapperEmployee()
        if include_optional:
    ...
    def testTransportCommonRmsItemsResponseWrapperEmployee(self):
        """Test TransportCommonRmsItemsResponseWrapperEmployee"""
