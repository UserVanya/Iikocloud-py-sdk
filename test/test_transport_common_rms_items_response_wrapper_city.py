...
class TestTransportCommonRmsItemsResponseWrapperCity(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> TransportCommonRmsItemsResponseWrapperCity:
        """Test TransportCommonRmsItemsResponseWrapperCity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TransportCommonRmsItemsResponseWrapperCity`
        """
        model = TransportCommonRmsItemsResponseWrapperCity()
        if include_optional:
    ...
    def testTransportCommonRmsItemsResponseWrapperCity(self):
        """Test TransportCommonRmsItemsResponseWrapperCity"""
