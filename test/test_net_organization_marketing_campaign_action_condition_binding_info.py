...
class TestNetOrganizationMarketingCampaignActionConditionBindingInfo(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> NetOrganizationMarketingCampaignActionConditionBindingInfo:
        """Test NetOrganizationMarketingCampaignActionConditionBindingInfo
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetOrganizationMarketingCampaignActionConditionBindingInfo`
        """
        model = NetOrganizationMarketingCampaignActionConditionBindingInfo()
        if include_optional:
            return NetOrganizationMarketingCampaignActionConditionBindingInfo(
                id = '',
    ...
    def testNetOrganizationMarketingCampaignActionConditionBindingInfo(self):
        """Test NetOrganizationMarketingCampaignActionConditionBindingInfo"""
