...
class TestTransportDeliveryRestrictionsDeliveryGeocodeServiceType(unittest.TestCase):
    ...
    def testTransportDeliveryRestrictionsDeliveryGeocodeServiceType(self):
        """Test TransportDeliveryRestrictionsDeliveryGeocodeServiceType"""
        # inst = TransportDeliveryRestrictionsDeliveryGeocodeServiceType()
