...
class TestTransportReservesRestaurantSectionRectangle(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> TransportReservesRestaurantSectionRectangle:
        """Test TransportReservesRestaurantSectionRectangle
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TransportReservesRestaurantSectionRectangle`
        """
    ...
    def testTransportReservesRestaurantSectionRectangle(self):
        """Test TransportReservesRestaurantSectionRectangle"""
