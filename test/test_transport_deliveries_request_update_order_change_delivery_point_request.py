...
class TestTransportDeliveriesRequestUpdateOrderChangeDeliveryPointRequest(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> TransportDeliveriesRequestUpdateOrderChangeDeliveryPointRequest:
        """Test TransportDeliveriesRequestUpdateOrderChangeDeliveryPointRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TransportDeliveriesRequestUpdateOrderChangeDeliveryPointRequest`
        """
        model = TransportDeliveriesRequestUpdateOrderChangeDeliveryPointRequest()
        if include_optional:
    ...
    def testTransportDeliveriesRequestUpdateOrderChangeDeliveryPointRequest(self):
        """Test TransportDeliveriesRequestUpdateOrderChangeDeliveryPointRequest"""
