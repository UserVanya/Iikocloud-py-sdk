...
class TestTransportDeliveryRestrictionsAllowedRestrictionsGetAllowedRestrictionsRequest(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> TransportDeliveryRestrictionsAllowedRestrictionsGetAllowedRestrictionsRequest:
        """Test TransportDeliveryRestrictionsAllowedRestrictionsGetAllowedRestrictionsRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TransportDeliveryRestrictionsAllowedRestrictionsGetAllowedRestrictionsRequest`
        """
        model = TransportDeliveryRestrictionsAllowedRestrictionsGetAllowedRestrictionsRequest()
        if include_optional:
            return TransportDeliveryRestrictionsAllowedRestrictionsGetAllowedRestrictionsRequest(
                organization_id = '',
                organization_ids = [
                    ''
                    ],
    ...
    def testTransportDeliveryRestrictionsAllowedRestrictionsGetAllowedRestrictionsRequest(self):
        """Test TransportDeliveryRestrictionsAllowedRestrictionsGetAllowedRestrictionsRequest"""
