...
class TestNetLoyaltyResultAvailableCombo(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> NetLoyaltyResultAvailableCombo:
        """Test NetLoyaltyResultAvailableCombo
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetLoyaltyResultAvailableCombo`
        """
        model = NetLoyaltyResultAvailableCombo()
        if include_optional:
    ...
    def testNetLoyaltyResultAvailableCombo(self):
        """Test NetLoyaltyResultAvailableCombo"""
