...
class TestTransportDeliveryRestrictionsActionOnValidationRejection(unittest.TestCase):
    ...
    def testTransportDeliveryRestrictionsActionOnValidationRejection(self):
        """Test TransportDeliveryRestrictionsActionOnValidationRejection"""
        # inst = TransportDeliveryRestrictionsActionOnValidationRejection()
