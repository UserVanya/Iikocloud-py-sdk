...
class TestTransportOrganizationsDeliverySettingsServiceType(unittest.TestCase):
    ...
    def testTransportOrganizationsDeliverySettingsServiceType(self):
        """Test TransportOrganizationsDeliverySettingsServiceType"""
        # inst = TransportOrganizationsDeliverySettingsServiceType()
