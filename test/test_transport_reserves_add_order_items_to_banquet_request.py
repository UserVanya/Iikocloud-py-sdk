...
class TestTransportReservesAddOrderItemsToBanquetRequest(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> TransportReservesAddOrderItemsToBanquetRequest:
        """Test TransportReservesAddOrderItemsToBanquetRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TransportReservesAddOrderItemsToBanquetRequest`
        """
        model = TransportReservesAddOrderItemsToBanquetRequest()
        if include_optional:
            return TransportReservesAddOrderItemsToBanquetRequest(
                reserve_id = '',
                organization_id = '',
                items = [
    ...
    def testTransportReservesAddOrderItemsToBanquetRequest(self):
        """Test TransportReservesAddOrderItemsToBanquetRequest"""
