...
class TestTransportOrganizationsOrganizationSettings(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> TransportOrganizationsOrganizationSettings:
        """Test TransportOrganizationsOrganizationSettings
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TransportOrganizationsOrganizationSettings`
        """
        model = TransportOrganizationsOrganizationSettings()
        if include_optional:
            return TransportOrganizationsOrganizationSettings(
                id = '',
    ...
    def testTransportOrganizationsOrganizationSettings(self):
        """Test TransportOrganizationsOrganizationSettings"""
