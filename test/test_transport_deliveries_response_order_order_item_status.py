...
class TestTransportDeliveriesResponseOrderOrderItemStatus(unittest.TestCase):
    ...
    def testTransportDeliveriesResponseOrderOrderItemStatus(self):
        """Test TransportDeliveriesResponseOrderOrderItemStatus"""
        # inst = TransportDeliveriesResponseOrderOrderItemStatus()
