...
class TestTransportReservesGetRestaurantSectionsWorkloadResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> TransportReservesGetRestaurantSectionsWorkloadResponse:
        """Test TransportReservesGetRestaurantSectionsWorkloadResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TransportReservesGetRestaurantSectionsWorkloadResponse`
        """
        model = TransportReservesGetRestaurantSectionsWorkloadResponse()
        if include_optional:
    ...
    def testTransportReservesGetRestaurantSectionsWorkloadResponse(self):
        """Test TransportReservesGetRestaurantSectionsWorkloadResponse"""
