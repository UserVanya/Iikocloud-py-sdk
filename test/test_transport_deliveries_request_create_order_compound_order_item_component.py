...
class TestTransportDeliveriesRequestCreateOrderCompoundOrderItemComponent(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> TransportDeliveriesRequestCreateOrderCompoundOrderItemComponent:
        """Test TransportDeliveriesRequestCreateOrderCompoundOrderItemComponent
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TransportDeliveriesRequestCreateOrderCompoundOrderItemComponent`
        """
        model = TransportDeliveriesRequestCreateOrderCompoundOrderItemComponent()
        if include_optional:
    ...
    def testTransportDeliveriesRequestCreateOrderCompoundOrderItemComponent(self):
        """Test TransportDeliveriesRequestCreateOrderCompoundOrderItemComponent"""
