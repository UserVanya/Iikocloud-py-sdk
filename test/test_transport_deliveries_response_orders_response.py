...
class TestTransportDeliveriesResponseOrdersResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> TransportDeliveriesResponseOrdersResponse:
        """Test TransportDeliveriesResponseOrdersResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TransportDeliveriesResponseOrdersResponse`
        """
        model = TransportDeliveriesResponseOrdersResponse()
        if include_optional:
    ...
    def testTransportDeliveriesResponseOrdersResponse(self):
        """Test TransportDeliveriesResponseOrdersResponse"""
