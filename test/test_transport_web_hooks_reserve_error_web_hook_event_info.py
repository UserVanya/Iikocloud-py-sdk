...
class TestTransportWebHooksReserveErrorWebHookEventInfo(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> TransportWebHooksReserveErrorWebHookEventInfo:
        """Test TransportWebHooksReserveErrorWebHookEventInfo
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TransportWebHooksReserveErrorWebHookEventInfo`
        """
        model = TransportWebHooksReserveErrorWebHookEventInfo()
        if include_optional:
            return TransportWebHooksReserveErrorWebHookEventInfo(
    ...
    def testTransportWebHooksReserveErrorWebHookEventInfo(self):
        """Test TransportWebHooksReserveErrorWebHookEventInfo"""
