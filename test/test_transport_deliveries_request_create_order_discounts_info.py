...
class TestTransportDeliveriesRequestCreateOrderDiscountsInfo(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> TransportDeliveriesRequestCreateOrderDiscountsInfo:
        """Test TransportDeliveriesRequestCreateOrderDiscountsInfo
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TransportDeliveriesRequestCreateOrderDiscountsInfo`
        """
    ...
    def testTransportDeliveriesRequestCreateOrderDiscountsInfo(self):
        """Test TransportDeliveriesRequestCreateOrderDiscountsInfo"""
