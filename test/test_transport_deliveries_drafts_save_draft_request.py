...
class TestTransportDeliveriesDraftsSaveDraftRequest(unittest.TestCase):
    """TransportDeliveriesDraftsSaveDraftRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TransportDeliveriesDraftsSaveDraftRequest:
        """Test TransportDeliveriesDraftsSaveDraftRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TransportDeliveriesDraftsSaveDraftRequest`
        """
        model = TransportDeliveriesDraftsSaveDraftRequest()
        if include_optional:
            return TransportDeliveriesDraftsSaveDraftRequest(
                employee_id = '',
                organization_id = '',
    ...
    def testTransportDeliveriesDraftsSaveDraftRequest(self):
        """Test TransportDeliveriesDraftsSaveDraftRequest"""
