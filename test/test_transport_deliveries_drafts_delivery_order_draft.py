...
class TestTransportDeliveriesDraftsDeliveryOrderDraft(unittest.TestCase):
    """TransportDeliveriesDraftsDeliveryOrderDraft unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TransportDeliveriesDraftsDeliveryOrderDraft:
        """Test TransportDeliveriesDraftsDeliveryOrderDraft
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TransportDeliveriesDraftsDeliveryOrderDraft`
        """
        model = TransportDeliveriesDraftsDeliveryOrderDraft()
        if include_optional:
            return TransportDeliveriesDraftsDeliveryOrderDraft(
                menu_id = '',
                id = '',
                external_number = '',
    ...
    def testTransportDeliveriesDraftsDeliveryOrderDraft(self):
        """Test TransportDeliveriesDraftsDeliveryOrderDraft"""
