...
class TestTransportOrganizationsDeliveryOrderPaymentSettings(unittest.TestCase):
    ...
    def testTransportOrganizationsDeliveryOrderPaymentSettings(self):
        """Test TransportOrganizationsDeliveryOrderPaymentSettings"""
        # inst = TransportOrganizationsDeliveryOrderPaymentSettings()
