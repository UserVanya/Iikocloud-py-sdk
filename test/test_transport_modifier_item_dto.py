...
class TestTransportModifierItemDto(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> TransportModifierItemDto:
        """Test TransportModifierItemDto
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TransportModifierItemDto`
        """
        model = TransportModifierItemDto()
        if include_optional:
    ...
    def testTransportModifierItemDto(self):
        """Test TransportModifierItemDto"""
