...
class TestTransportMenuCategoryDto(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> TransportMenuCategoryDto:
        """Test TransportMenuCategoryDto
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TransportMenuCategoryDto`
        """
        model = TransportMenuCategoryDto()
        if include_optional:
    ...
    def testTransportMenuCategoryDto(self):
        """Test TransportMenuCategoryDto"""
