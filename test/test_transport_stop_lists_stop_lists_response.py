...
class TestTransportStopListsStopListsResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> TransportStopListsStopListsResponse:
        """Test TransportStopListsStopListsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TransportStopListsStopListsResponse`
        """
        model = TransportStopListsStopListsResponse()
        if include_optional:
    ...
    def testTransportStopListsStopListsResponse(self):
        """Test TransportStopListsStopListsResponse"""
