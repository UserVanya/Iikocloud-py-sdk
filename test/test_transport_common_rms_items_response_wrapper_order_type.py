...
class TestTransportCommonRmsItemsResponseWrapperOrderType(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> TransportCommonRmsItemsResponseWrapperOrderType:
        """Test TransportCommonRmsItemsResponseWrapperOrderType
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TransportCommonRmsItemsResponseWrapperOrderType`
        """
        model = TransportCommonRmsItemsResponseWrapperOrderType()
        if include_optional:
    ...
    def testTransportCommonRmsItemsResponseWrapperOrderType(self):
        """Test TransportCommonRmsItemsResponseWrapperOrderType"""
