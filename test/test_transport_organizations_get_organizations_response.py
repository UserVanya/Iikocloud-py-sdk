...
class TestTransportOrganizationsGetOrganizationsResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> TransportOrganizationsGetOrganizationsResponse:
        """Test TransportOrganizationsGetOrganizationsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TransportOrganizationsGetOrganizationsResponse`
        """
        model = TransportOrganizationsGetOrganizationsResponse()
        if include_optional:
    ...
    def testTransportOrganizationsGetOrganizationsResponse(self):
        """Test TransportOrganizationsGetOrganizationsResponse"""
