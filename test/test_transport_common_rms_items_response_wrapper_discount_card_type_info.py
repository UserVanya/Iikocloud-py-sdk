...
class TestTransportCommonRmsItemsResponseWrapperDiscountCardTypeInfo(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> TransportCommonRmsItemsResponseWrapperDiscountCardTypeInfo:
        """Test TransportCommonRmsItemsResponseWrapperDiscountCardTypeInfo
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TransportCommonRmsItemsResponseWrapperDiscountCardTypeInfo`
        """
        model = TransportCommonRmsItemsResponseWrapperDiscountCardTypeInfo()
        if include_optional:
    ...
    def testTransportCommonRmsItemsResponseWrapperDiscountCardTypeInfo(self):
        """Test TransportCommonRmsItemsResponseWrapperDiscountCardTypeInfo"""
