...
class TestTransportCommonRmsItemsResponseWrapperActiveCourierLocation(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> TransportCommonRmsItemsResponseWrapperActiveCourierLocation:
        """Test TransportCommonRmsItemsResponseWrapperActiveCourierLocation
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TransportCommonRmsItemsResponseWrapperActiveCourierLocation`
        """
        model = TransportCommonRmsItemsResponseWrapperActiveCourierLocation()
        if include_optional:
    ...
    def testTransportCommonRmsItemsResponseWrapperActiveCourierLocation(self):
        """Test TransportCommonRmsItemsResponseWrapperActiveCourierLocation"""
