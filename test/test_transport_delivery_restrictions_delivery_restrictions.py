...
class TestTransportDeliveryRestrictionsDeliveryRestrictions(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> TransportDeliveryRestrictionsDeliveryRestrictions:
        """Test TransportDeliveryRestrictionsDeliveryRestrictions
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TransportDeliveryRestrictionsDeliveryRestrictions`
        """
        model = TransportDeliveryRestrictionsDeliveryRestrictions()
        if include_optional:
            return TransportDeliveryRestrictionsDeliveryRestrictions(
                organization_id = '',
    ...
    def testTransportDeliveryRestrictionsDeliveryRestrictions(self):
        """Test TransportDeliveryRestrictionsDeliveryRestrictions"""
