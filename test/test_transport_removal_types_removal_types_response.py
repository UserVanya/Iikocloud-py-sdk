...
class TestTransportRemovalTypesRemovalTypesResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> TransportRemovalTypesRemovalTypesResponse:
        """Test TransportRemovalTypesRemovalTypesResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TransportRemovalTypesRemovalTypesResponse`
        """
        model = TransportRemovalTypesRemovalTypesResponse()
        if include_optional:
    ...
    def testTransportRemovalTypesRemovalTypesResponse(self):
        """Test TransportRemovalTypesRemovalTypesResponse"""
