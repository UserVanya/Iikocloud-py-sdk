...
class TestTransportEmployeesEmployeeInfoResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> TransportEmployeesEmployeeInfoResponse:
        """Test TransportEmployeesEmployeeInfoResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TransportEmployeesEmployeeInfoResponse`
        """
        model = TransportEmployeesEmployeeInfoResponse()
        if include_optional:
    ...
    def testTransportEmployeesEmployeeInfoResponse(self):
        """Test TransportEmployeesEmployeeInfoResponse"""
