...
class TestTransportNomenclatureSizePrice(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> TransportNomenclatureSizePrice:
        """Test TransportNomenclatureSizePrice
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TransportNomenclatureSizePrice`
        """
        model = TransportNomenclatureSizePrice()
        if include_optional:
    ...
    def testTransportNomenclatureSizePrice(self):
        """Test TransportNomenclatureSizePrice"""
