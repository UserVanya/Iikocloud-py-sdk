...
class TestNetOrganizationLoyaltyProgram(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> NetOrganizationLoyaltyProgram:
        """Test NetOrganizationLoyaltyProgram
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetOrganizationLoyaltyProgram`
        """
        model = NetOrganizationLoyaltyProgram()
        if include_optional:
            return NetOrganizationLoyaltyProgram(
                id = '',
                name = '',
                description = '',
    ...
    def testNetOrganizationLoyaltyProgram(self):
        """Test NetOrganizationLoyaltyProgram"""
