...
class TestTransportCommonRmsItemsResponseWrapperRegion(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> TransportCommonRmsItemsResponseWrapperRegion:
        """Test TransportCommonRmsItemsResponseWrapperRegion
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TransportCommonRmsItemsResponseWrapperRegion`
        """
        model = TransportCommonRmsItemsResponseWrapperRegion()
        if include_optional:
    ...
    def testTransportCommonRmsItemsResponseWrapperRegion(self):
        """Test TransportCommonRmsItemsResponseWrapperRegion"""
