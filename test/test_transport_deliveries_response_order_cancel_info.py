...
class TestTransportDeliveriesResponseOrderCancelInfo(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> TransportDeliveriesResponseOrderCancelInfo:
        """Test TransportDeliveriesResponseOrderCancelInfo
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TransportDeliveriesResponseOrderCancelInfo`
        """
        model = TransportDeliveriesResponseOrderCancelInfo()
        if include_optional:
    ...
    def testTransportDeliveriesResponseOrderCancelInfo(self):
        """Test TransportDeliveriesResponseOrderCancelInfo"""
