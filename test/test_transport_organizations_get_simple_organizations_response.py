...
class TestTransportOrganizationsGetSimpleOrganizationsResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> TransportOrganizationsGetSimpleOrganizationsResponse:
        """Test TransportOrganizationsGetSimpleOrganizationsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TransportOrganizationsGetSimpleOrganizationsResponse`
        """
        model = TransportOrganizationsGetSimpleOrganizationsResponse()
        if include_optional:
    ...
    def testTransportOrganizationsGetSimpleOrganizationsResponse(self):
        """Test TransportOrganizationsGetSimpleOrganizationsResponse"""
