...
class TestTransportDeliveriesCommonIikoCardSearchScope(unittest.TestCase):
    ...
    def testTransportDeliveriesCommonIikoCardSearchScope(self):
        """Test TransportDeliveriesCommonIikoCardSearchScope"""
        # inst = TransportDeliveriesCommonIikoCardSearchScope()
