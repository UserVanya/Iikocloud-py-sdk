...
class TestExternalMenuModifierItem2(unittest.TestCase):
    """ExternalMenuModifierItem2 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ExternalMenuModifierItem2:
        """Test ExternalMenuModifierItem2
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ExternalMenuModifierItem2`
        """
        model = ExternalMenuModifierItem2()
        if include_optional:
    ...
    def testExternalMenuModifierItem2(self):
        """Test ExternalMenuModifierItem2"""
