...
class TestDeliveriesCreateAndUpdateApi(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_deliveries_update_tracking_link_post(self) -> None:
        """Test case for deliveries_update_tracking_link_post

        Update tracking link of an order.
        """
        pass

    async def test_order_print_bill_post(self) -> None:
        """Test case for order_print_bill_post
