...
class TestTransportDeliveriesResponseCheckCreateOrderResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> TransportDeliveriesResponseCheckCreateOrderResponse:
        """Test TransportDeliveriesResponseCheckCreateOrderResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TransportDeliveriesResponseCheckCreateOrderResponse`
        """
        model = TransportDeliveriesResponseCheckCreateOrderResponse()
        if include_optional:
    ...
    def testTransportDeliveriesResponseCheckCreateOrderResponse(self):
        """Test TransportDeliveriesResponseCheckCreateOrderResponse"""
