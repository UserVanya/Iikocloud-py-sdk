...
class TestNetOrganizationGetProgramsResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> NetOrganizationGetProgramsResponse:
        """Test NetOrganizationGetProgramsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetOrganizationGetProgramsResponse`
        """
        model = NetOrganizationGetProgramsResponse()
        if include_optional:
    ...
    def testNetOrganizationGetProgramsResponse(self):
        """Test NetOrganizationGetProgramsResponse"""
