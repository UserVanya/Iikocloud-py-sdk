...
class TestComboDto3(unittest.TestCase):
    """ComboDto3 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ComboDto3:
        """Test ComboDto3
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ComboDto3`
        """
        model = ComboDto3()
        if include_optional:
            return ComboDto3(
