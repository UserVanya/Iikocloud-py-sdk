...
class TestTransportDeliveriesResponseOrdersByOrganization(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> TransportDeliveriesResponseOrdersByOrganization:
        """Test TransportDeliveriesResponseOrdersByOrganization
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TransportDeliveriesResponseOrdersByOrganization`
        """
        model = TransportDeliveriesResponseOrdersByOrganization()
        if include_optional:
    ...
    def testTransportDeliveriesResponseOrdersByOrganization(self):
        """Test TransportDeliveriesResponseOrdersByOrganization"""
