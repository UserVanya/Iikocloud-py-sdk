...
class TestExternalMenuModifierItem(unittest.TestCase):
    """ExternalMenuModifierItem unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ExternalMenuModifierItem:
        """Test ExternalMenuModifierItem
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ExternalMenuModifierItem`
        """
        model = ExternalMenuModifierItem()
        if include_optional:
    ...
    def testExternalMenuModifierItem(self):
        """Test ExternalMenuModifierItem"""
