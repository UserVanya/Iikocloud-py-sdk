...
class TestBanquetsReservesApi(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_reserve_change_estimated_start_time_post(self) -> None:
        """Test case for reserve_change_estimated_start_time_post

        Change reserve/banquet estimated start time.
        """
        pass

    async def test_reserve_change_items_post(self) -> None:
        """Test case for reserve_change_items_post

        Change order items.
        """
        pass

    async def test_reserve_change_tables_post(self) -> None:
        """Test case for reserve_change_tables_post
