...
class TestTransportDiscountsDiscountsResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> TransportDiscountsDiscountsResponse:
        """Test TransportDiscountsDiscountsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TransportDiscountsDiscountsResponse`
        """
        model = TransportDiscountsDiscountsResponse()
        if include_optional:
    ...
    def testTransportDiscountsDiscountsResponse(self):
        """Test TransportDiscountsDiscountsResponse"""
