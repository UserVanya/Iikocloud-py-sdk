...
class TestTransportCommonRmsItemsResponseWrapperEmployeeWithCheckedRole(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> TransportCommonRmsItemsResponseWrapperEmployeeWithCheckedRole:
        """Test TransportCommonRmsItemsResponseWrapperEmployeeWithCheckedRole
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TransportCommonRmsItemsResponseWrapperEmployeeWithCheckedRole`
        """
        model = TransportCommonRmsItemsResponseWrapperEmployeeWithCheckedRole()
        if include_optional:
    ...
    def testTransportCommonRmsItemsResponseWrapperEmployeeWithCheckedRole(self):
        """Test TransportCommonRmsItemsResponseWrapperEmployeeWithCheckedRole"""
