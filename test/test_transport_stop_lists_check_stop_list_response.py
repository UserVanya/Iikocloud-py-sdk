...
class TestTransportStopListsCheckStopListResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> TransportStopListsCheckStopListResponse:
        """Test TransportStopListsCheckStopListResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TransportStopListsCheckStopListResponse`
        """
        model = TransportStopListsCheckStopListResponse()
        if include_optional:
    ...
    def testTransportStopListsCheckStopListResponse(self):
        """Test TransportStopListsCheckStopListResponse"""
