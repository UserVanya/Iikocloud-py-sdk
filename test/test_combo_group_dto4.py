...
class TestComboGroupDto4(unittest.TestCase):
    """ComboGroupDto4 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ComboGroupDto4:
        """Test ComboGroupDto4
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ComboGroupDto4`
        """
        model = ComboGroupDto4()
        if include_optional:
            return ComboGroupDto4(
                id = None,
                name = '',
                is_main_group = True,
                items = [
