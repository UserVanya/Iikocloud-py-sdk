...
class TestNetLoyaltyResultUpsale(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> NetLoyaltyResultUpsale:
        """Test NetLoyaltyResultUpsale
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetLoyaltyResultUpsale`
        """
        model = NetLoyaltyResultUpsale()
        if include_optional:
            return NetLoyaltyResultUpsale(
                source_action_id = '',
                suggestion_text = '',
    ...
    def testNetLoyaltyResultUpsale(self):
        """Test NetLoyaltyResultUpsale"""
