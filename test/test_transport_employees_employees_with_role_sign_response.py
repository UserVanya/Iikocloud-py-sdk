...
class TestTransportEmployeesEmployeesWithRoleSignResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> TransportEmployeesEmployeesWithRoleSignResponse:
        """Test TransportEmployeesEmployeesWithRoleSignResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TransportEmployeesEmployeesWithRoleSignResponse`
        """
        model = TransportEmployeesEmployeesWithRoleSignResponse()
        if include_optional:
    ...
    def testTransportEmployeesEmployeesWithRoleSignResponse(self):
        """Test TransportEmployeesEmployeesWithRoleSignResponse"""
