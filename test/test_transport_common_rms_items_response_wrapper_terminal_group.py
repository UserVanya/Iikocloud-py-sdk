...
class TestTransportCommonRmsItemsResponseWrapperTerminalGroup(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> TransportCommonRmsItemsResponseWrapperTerminalGroup:
        """Test TransportCommonRmsItemsResponseWrapperTerminalGroup
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TransportCommonRmsItemsResponseWrapperTerminalGroup`
        """
        model = TransportCommonRmsItemsResponseWrapperTerminalGroup()
        if include_optional:
    ...
    def testTransportCommonRmsItemsResponseWrapperTerminalGroup(self):
        """Test TransportCommonRmsItemsResponseWrapperTerminalGroup"""
