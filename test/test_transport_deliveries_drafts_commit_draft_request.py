...
class TestTransportDeliveriesDraftsCommitDraftRequest(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> TransportDeliveriesDraftsCommitDraftRequest:
        """Test TransportDeliveriesDraftsCommitDraftRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TransportDeliveriesDraftsCommitDraftRequest`
        """
        model = TransportDeliveriesDraftsCommitDraftRequest()
        if include_optional:
    ...
    def testTransportDeliveriesDraftsCommitDraftRequest(self):
        """Test TransportDeliveriesDraftsCommitDraftRequest"""
