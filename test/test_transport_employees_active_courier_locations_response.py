...
class TestTransportEmployeesActiveCourierLocationsResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> TransportEmployeesActiveCourierLocationsResponse:
        """Test TransportEmployeesActiveCourierLocationsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TransportEmployeesActiveCourierLocationsResponse`
        """
        model = TransportEmployeesActiveCourierLocationsResponse()
        if include_optional:
    ...
    def testTransportEmployeesActiveCourierLocationsResponse(self):
        """Test TransportEmployeesActiveCourierLocationsResponse"""
