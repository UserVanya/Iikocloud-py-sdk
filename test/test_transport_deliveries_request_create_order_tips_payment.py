...
class TestTransportDeliveriesRequestCreateOrderTipsPayment(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> TransportDeliveriesRequestCreateOrderTipsPayment:
        """Test TransportDeliveriesRequestCreateOrderTipsPayment
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TransportDeliveriesRequestCreateOrderTipsPayment`
        """
        model = TransportDeliveriesRequestCreateOrderTipsPayment()
        if include_optional:
            return TransportDeliveriesRequestCreateOrderTipsPayment(
                payment_type_kind = '',
                tips_type_id = '',
                sum = 0,
                payment_type_id = '',
    ...
    def testTransportDeliveriesRequestCreateOrderTipsPayment(self):
        """Test TransportDeliveriesRequestCreateOrderTipsPayment"""
