...
class TestNetCustomerGetCategoriesResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> NetCustomerGetCategoriesResponse:
        """Test NetCustomerGetCategoriesResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetCustomerGetCategoriesResponse`
        """
        model = NetCustomerGetCategoriesResponse()
        if include_optional:
    ...
    def testNetCustomerGetCategoriesResponse(self):
        """Test NetCustomerGetCategoriesResponse"""
