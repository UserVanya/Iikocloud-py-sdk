...
class TestTransportTerminalsTerminalGroupsIsAliveResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> TransportTerminalsTerminalGroupsIsAliveResponse:
        """Test TransportTerminalsTerminalGroupsIsAliveResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TransportTerminalsTerminalGroupsIsAliveResponse`
        """
        model = TransportTerminalsTerminalGroupsIsAliveResponse()
        if include_optional:
    ...
    def testTransportTerminalsTerminalGroupsIsAliveResponse(self):
        """Test TransportTerminalsTerminalGroupsIsAliveResponse"""
