...
class TestTransportOrdersCommonAddOrderPaymentsRequest(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> TransportOrdersCommonAddOrderPaymentsRequest:
        """Test TransportOrdersCommonAddOrderPaymentsRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TransportOrdersCommonAddOrderPaymentsRequest`
        """
        model = TransportOrdersCommonAddOrderPaymentsRequest()
        if include_optional:
    ...
    def testTransportOrdersCommonAddOrderPaymentsRequest(self):
        """Test TransportOrdersCommonAddOrderPaymentsRequest"""
