...
class TestTransportPaymentTypesPaymentTypesResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> TransportPaymentTypesPaymentTypesResponse:
        """Test TransportPaymentTypesPaymentTypesResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TransportPaymentTypesPaymentTypesResponse`
        """
        model = TransportPaymentTypesPaymentTypesResponse()
        if include_optional:
    ...
    def testTransportPaymentTypesPaymentTypesResponse(self):
        """Test TransportPaymentTypesPaymentTypesResponse"""
