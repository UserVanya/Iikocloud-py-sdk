...
class TestTransportStopListsTerminalGroupStopList(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> TransportStopListsTerminalGroupStopList:
        """Test TransportStopListsTerminalGroupStopList
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TransportStopListsTerminalGroupStopList`
        """
        model = TransportStopListsTerminalGroupStopList()
        if include_optional:
    ...
    def testTransportStopListsTerminalGroupStopList(self):
        """Test TransportStopListsTerminalGroupStopList"""
