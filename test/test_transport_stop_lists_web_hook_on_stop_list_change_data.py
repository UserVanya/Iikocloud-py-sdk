...
class TestTransportStopListsWebHookOnStopListChangeData(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> TransportStopListsWebHookOnStopListChangeData:
        """Test TransportStopListsWebHookOnStopListChangeData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TransportStopListsWebHookOnStopListChangeData`
        """
        model = TransportStopListsWebHookOnStopListChangeData()
        if include_optional:
    ...
    def testTransportStopListsWebHookOnStopListChangeData(self):
        """Test TransportStopListsWebHookOnStopListChangeData"""
