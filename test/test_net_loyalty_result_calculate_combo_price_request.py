...
class TestNetLoyaltyResultCalculateComboPriceRequest(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> NetLoyaltyResultCalculateComboPriceRequest:
        """Test NetLoyaltyResultCalculateComboPriceRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetLoyaltyResultCalculateComboPriceRequest`
        """
        model = NetLoyaltyResultCalculateComboPriceRequest()
        if include_optional:
    ...
    def testNetLoyaltyResultCalculateComboPriceRequest(self):
        """Test NetLoyaltyResultCalculateComboPriceRequest"""
