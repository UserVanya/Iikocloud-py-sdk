...
class TestTransportReservesRestaurantSectionEllipse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> TransportReservesRestaurantSectionEllipse:
        """Test TransportReservesRestaurantSectionEllipse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TransportReservesRestaurantSectionEllipse`
        """
    ...
    def testTransportReservesRestaurantSectionEllipse(self):
        """Test TransportReservesRestaurantSectionEllipse"""
