...
class TestTransportTableOrdersRequestTableOrder(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> TransportTableOrdersRequestTableOrder:
        """Test TransportTableOrdersRequestTableOrder
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TransportTableOrdersRequestTableOrder`
        """
        model = TransportTableOrdersRequestTableOrder()
        if include_optional:
    ...
    def testTransportTableOrdersRequestTableOrder(self):
        """Test TransportTableOrdersRequestTableOrder"""
