...
class TestNetLoyaltyResultCalculateCheckinResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> NetLoyaltyResultCalculateCheckinResponse:
        """Test NetLoyaltyResultCalculateCheckinResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetLoyaltyResultCalculateCheckinResponse`
        """
        model = NetLoyaltyResultCalculateCheckinResponse()
        if include_optional:
    ...
    def testNetLoyaltyResultCalculateCheckinResponse(self):
        """Test NetLoyaltyResultCalculateCheckinResponse"""
