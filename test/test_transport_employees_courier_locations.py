...
class TestTransportEmployeesCourierLocations(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> TransportEmployeesCourierLocations:
        """Test TransportEmployeesCourierLocations
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TransportEmployeesCourierLocations`
        """
        model = TransportEmployeesCourierLocations()
        if include_optional:
    ...
    def testTransportEmployeesCourierLocations(self):
        """Test TransportEmployeesCourierLocations"""
