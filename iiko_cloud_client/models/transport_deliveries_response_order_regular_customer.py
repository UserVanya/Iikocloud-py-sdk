...
class TransportDeliveriesResponseOrderRegularCustomer(TransportDeliveriesResponseOrderCustomer):
    """
    TransportDeliveriesResponseOrderRegularCustomer
    """ # noqa: E501
    id: StrictStr = Field(description="Customer ID.")
    ...
    gender: Optional[TransportDeliveriesCommonGender] = Field(default=None, description="Sex.")
