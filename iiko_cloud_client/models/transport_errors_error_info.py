...
class TransportErrorsErrorInfo(BaseModel):
    """
    DTO for error details transfer.
    """ # noqa: E501
    code: TransportErrorsErrorCode = Field(description="Error code.")
    ...
    __properties: ClassVar[List[str]] = ["code", "message", "description", "additionalData"]
