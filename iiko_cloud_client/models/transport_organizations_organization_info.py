...
class TransportOrganizationsOrganizationInfo(BaseModel):
    """
    ...
    __discriminator_value_class_map: ClassVar[Dict[str, str]] = {
        'Extended': 'TransportOrganizationsExtendedOrganizationInfo','Simple': 'TransportOrganizationsSimpleOrganizationInfo'
    }
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Optional[Union[TransportOrganizationsExtendedOrganizationInfo, TransportOrganizationsSimpleOrganizationInfo]]:
    ...
    @classmethod
    def from_dict(cls, obj: Dict[str, Any]) -> Optional[Union[TransportOrganizationsExtendedOrganizationInfo, TransportOrganizationsSimpleOrganizationInfo]]:
        """Create an instance of TransportOrganizationsOrganizationInfo from a dict"""
        # look up the object type based on discriminator mapping
        object_type = cls.get_discriminator_value(obj)
        if object_type ==  'TransportOrganizationsExtendedOrganizationInfo':
            return import_module("iiko_cloud_client.models.transport_organizations_extended_organization_info").TransportOrganizationsExtendedOrganizationInfo.from_dict(obj)
        if object_type ==  'TransportOrganizationsSimpleOrganizationInfo':
            return import_module("iiko_cloud_client.models.transport_organizations_simple_organization_info").TransportOrganizationsSimpleOrganizationInfo.from_dict(obj)

        raise ValueError("TransportOrganizationsOrganizationInfo failed to lookup discriminator value from " +
