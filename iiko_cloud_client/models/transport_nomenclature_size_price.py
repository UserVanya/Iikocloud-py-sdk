...
class TransportNomenclatureSizePrice(BaseModel):
    """
    Price per item size.
    """ # noqa: E501
    size_id: Optional[StrictStr] = Field(description="Item size ID.", alias="sizeId")
    price: TransportNomenclaturePrice = Field(description="Price per this item size.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "price": TransportNomenclaturePrice.from_dict(obj["price"]) if obj.get("price") is not None else None
        })
        return _obj
