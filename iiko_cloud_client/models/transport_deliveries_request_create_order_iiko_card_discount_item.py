...
class TransportDeliveriesRequestCreateOrderIikoCardDiscountItem(BaseModel):
    """
    Card discount/surcharge item.
    """ # noqa: E501
    position_id: StrictStr = Field(description="Position ID of order item.", alias="positionId")
