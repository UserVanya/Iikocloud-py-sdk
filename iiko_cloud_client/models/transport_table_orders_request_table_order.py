...
class TransportTableOrdersRequestTableOrder(BaseModel):
    """
    ...
    table_ids: Optional[List[StrictStr]] = Field(default=None, description="Table IDs.                Can be obtained by `/api/1/reserve/available_restaurant_sections` operation.", alias="tableIds")
    customer: Optional[TransportDeliveriesRequestCreateOrderRegularCustomer] = Field(default=None, description="Guest.   > Allowed from version `7.5.2`.")
    ...
    guests: Optional[TransportTableOrdersRequestGuestsInfo] = Field(default=None, description="Guests information.   > Allowed from version `7.6.1`.")
    ...
    __properties: ClassVar[List[str]] = ["id", "externalNumber", "tableIds", "customer", "phone", "guestCount", "guests", "tabName", "menuId", "items", "combos", "payments", "tips", "sourceKey", "discountsInfo", "loyaltyInfo", "orderTypeId", "chequeAdditionalInfo", "externalData"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "guests": TransportTableOrdersRequestGuestsInfo.from_dict(obj["guests"]) if obj.get("guests") is not None else None,
