...
class TransportDeliveriesResponseOrdersByOrganization(BaseModel):
    """
    ...
    orders: List[TransportDeliveriesResponseOrderOrderInfo] = Field(description="List of orders by organization.")
