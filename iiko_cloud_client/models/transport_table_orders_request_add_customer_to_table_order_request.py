...
class TransportTableOrdersRequestAddCustomerToTableOrderRequest(BaseModel):
    """
    ...
    customer: TransportTableOrdersRequestTableOrderCustomer = Field(description="Guest info.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "customer": TransportTableOrdersRequestTableOrderCustomer.from_dict(obj["customer"]) if obj.get("customer") is not None else None
        })
        return _obj
