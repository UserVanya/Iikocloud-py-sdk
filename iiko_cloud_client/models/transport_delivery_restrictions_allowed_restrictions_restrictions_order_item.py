...
class TransportDeliveryRestrictionsAllowedRestrictionsRestrictionsOrderItem(BaseModel):
    """
    Order item.
    """ # noqa: E501
    ...
    modifiers: Optional[List[TransportDeliveryRestrictionsAllowedRestrictionsRestrictionsOrderItemModifier]] = Field(default=None, description="Modifiers (absolute amount).")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "modifiers": [TransportDeliveryRestrictionsAllowedRestrictionsRestrictionsOrderItemModifier.from_dict(_item) for _item in obj["modifiers"]] if obj.get("modifiers") is not None else None
        })
        return _obj
