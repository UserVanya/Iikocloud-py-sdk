...
class TransportDeliveriesRequestCreateOrderIikoCardDiscount(TransportDeliveriesRequestCreateOrderDiscount):
    """
    Card discount/surcharge.
    """ # noqa: E501
    program_id: StrictStr = Field(description="Card program ID.", alias="programId")
    program_name: StrictStr = Field(description="Card program name.", alias="programName")
    discount_items: List[TransportDeliveriesRequestCreateOrderIikoCardDiscountItem] = Field(description="Discount information for order items.", alias="discountItems")
