...
class TransportDeliveriesCommonCardPaymentAdditionalData(TransportDeliveriesCommonPaymentAdditionalData):
    """
    Additional data for Card payment item.
    """ # noqa: E501
    custom_data: Annotated[str, Field(min_length=0, strict=True, max_length=5000)] = Field(description="Custom data.  > If this property is set, the above `number` property is ignored.   > Allowed from version `8.8.6`.", alias="customData")
