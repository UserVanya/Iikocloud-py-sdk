...
class TransportDeliveryRestrictionsAllowedRestrictionsRestrictionsAddress(BaseModel):
    """
    Address.
    """ # noqa: E501
    ...
    street_id: Optional[StrictStr] = Field(default=None, description="Street ID.", alias="streetId")
