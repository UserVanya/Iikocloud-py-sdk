...
class TransportTerminalsTerminalGroupAliveInfo(BaseModel):
    """
    ...
    terminal_group_id: StrictStr = Field(description="ID of front group of terminals.                Can be obtained by `/api/1/terminal_groups` operation.", alias="terminalGroupId")
    organization_id: StrictStr = Field(description="Organizations ID.                Can be obtained by `/api/1/organizations` operation.", alias="organizationId")
