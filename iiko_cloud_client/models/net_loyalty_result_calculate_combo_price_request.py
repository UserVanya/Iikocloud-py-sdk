...
class NetLoyaltyResultCalculateComboPriceRequest(BaseModel):
    """
    Calculate combo price request.
    """ # noqa: E501
    items: List[TransportDeliveriesRequestCreateOrderOrderItem] = Field(description="Items with modifiers included in combo.")
