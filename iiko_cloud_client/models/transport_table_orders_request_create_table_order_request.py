...
class TransportTableOrdersRequestCreateTableOrderRequest(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "order": TransportTableOrdersRequestTableOrder.from_dict(obj["order"]) if obj.get("order") is not None else None,
            "createOrderSettings": TransportTableOrdersRequestCreateTableOrderSettings.from_dict(obj["createOrderSettings"]) if obj.get("createOrderSettings") is not None else None
        })
        return _obj
