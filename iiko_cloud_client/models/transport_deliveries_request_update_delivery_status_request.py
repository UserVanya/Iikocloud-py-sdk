...
class TransportDeliveriesRequestUpdateDeliveryStatusRequest(BaseModel):
    """
    ...
    delivery_status: TransportDeliveriesCommonDeliveryStatusForUpdate = Field(description="Delivery status. Can be only switched between these three statuses.", alias="deliveryStatus")
