...
class TransportDeliveriesRequestCreateOrderPayment(BaseModel):
    ...
    def from_dict(cls, obj: Dict[str, Any]) -> Optional[Union[TransportDeliveriesRequestCreateOrderCardPayment, TransportDeliveriesRequestCreateOrderCashPayment, TransportDeliveriesRequestCreateOrderExternalPayment, TransportDeliveriesRequestCreateOrderLoyaltyCardPayment]]:
        ...
        if object_type ==  'TransportDeliveriesRequestCreateOrderCardPayment':
            return import_module("iiko_cloud_client.models.transport_deliveries_request_create_order_card_payment").TransportDeliveriesRequestCreateOrderCardPayment.from_dict(obj)
        if object_type ==  'TransportDeliveriesRequestCreateOrderCashPayment':
            return import_module("iiko_cloud_client.models.transport_deliveries_request_create_order_cash_payment").TransportDeliveriesRequestCreateOrderCashPayment.from_dict(obj)
        if object_type ==  'TransportDeliveriesRequestCreateOrderExternalPayment':
            return import_module("iiko_cloud_client.models.transport_deliveries_request_create_order_external_payment").TransportDeliveriesRequestCreateOrderExternalPayment.from_dict(obj)
        if object_type ==  'TransportDeliveriesRequestCreateOrderLoyaltyCardPayment':
            return import_module("iiko_cloud_client.models.transport_deliveries_request_create_order_loyalty_card_payment").TransportDeliveriesRequestCreateOrderLoyaltyCardPayment.from_dict(obj)
