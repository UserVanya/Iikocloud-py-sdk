...
class TransportEmployeesEmployeesResponse(BaseModel):
    """
    ...
    employees: List[TransportCommonRmsItemsResponseWrapperEmployee] = Field(description="List of drivers.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "employees": [TransportCommonRmsItemsResponseWrapperEmployee.from_dict(_item) for _item in obj["employees"]] if obj.get("employees") is not None else None
        })
        return _obj
