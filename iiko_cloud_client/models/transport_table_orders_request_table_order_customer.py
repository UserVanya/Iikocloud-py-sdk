...
class TransportTableOrdersRequestTableOrderCustomer(BaseModel):
    """
    TransportTableOrdersRequestTableOrderCustomer
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="Existing customer ID in RMS.   > If null - the phone number and name is searched in database, otherwise the new customer is created in RMS.")
