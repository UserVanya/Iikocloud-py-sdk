...
class TransportDeliveriesRequestCreateOrderRequest(BaseModel):
    """
    ...
    order: TransportDeliveriesRequestCreateOrderDeliveryOrder = Field(description="Order.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "order": TransportDeliveriesRequestCreateOrderDeliveryOrder.from_dict(obj["order"]) if obj.get("order") is not None else None
        })
        return _obj
