...
class TransportTableOrdersResponseTableOrderInfo(BaseModel):
    """
    Order.
    """ # noqa: E501
    id: StrictStr = Field(description="Order ID.")
    pos_id: Optional[StrictStr] = Field(default=None, description="POS order ID.", alias="posId")
    ...
    order: Optional[TransportTableOrdersResponseTableOrder] = Field(default=None, description="Order creation details.  > Field is filled up if \"creationStatus\"=\"Success\".")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "order": TransportTableOrdersResponseTableOrder.from_dict(obj["order"]) if obj.get("order") is not None else None
        })
        return _obj
