...
class TransportDeliveryRestrictionsDeliveryZoneAddressBinding(BaseModel):
    """
    Delivery zone polygon, defined by the combination of street, index and house numbers.
    """ # noqa: E501
    street_id: StrictStr = Field(description="ID of the delivery zone's street.", alias="streetId")
    postcode: StrictStr = Field(description="Postcode.")
    houses: TransportDeliveryRestrictionsHousesRange = Field(description="Range of house numbers in the delivery zone.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "houses": TransportDeliveryRestrictionsHousesRange.from_dict(obj["houses"]) if obj.get("houses") is not None else None
        })
        return _obj
