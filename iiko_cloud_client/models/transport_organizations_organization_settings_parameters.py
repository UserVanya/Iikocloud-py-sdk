...
class TransportOrganizationsOrganizationSettingsParameters(str, Enum):
    """
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of TransportOrganizationsOrganizationSettingsParameters from a JSON string"""
