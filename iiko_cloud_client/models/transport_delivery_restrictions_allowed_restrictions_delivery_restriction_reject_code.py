...
class TransportDeliveryRestrictionsAllowedRestrictionsDeliveryRestrictionRejectCode(str, Enum):
    """
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of TransportDeliveryRestrictionsAllowedRestrictionsDeliveryRestrictionRejectCode from a JSON string"""
