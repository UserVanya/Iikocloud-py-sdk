...
class WebhooksApi:
    ...
    async def api1_webhooks_settings_post(
        ...
        :type transport_web_hooks_get_web_hook_settings_request: TransportWebHooksGetWebHookSettingsRequest
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "TransportWebHooksGetWebHookSettingsResponse",
    ...
    async def api1_webhooks_settings_post_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[TransportWebHooksGetWebHookSettingsResponse]:
        """Get webhooks settings for specified organization and authorized API login.
    ...
    def _api1_webhooks_settings_post_serialize(
        ...
        if transport_web_hooks_get_web_hook_settings_request is not None:
            _body_params = transport_web_hooks_get_web_hook_settings_request
    ...
    async def api1_webhooks_update_settings_post(
        ...
        :type transport_web_hooks_update_web_hook_settings_request: TransportWebHooksUpdateWebHookSettingsRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
    ...
    def _api1_webhooks_update_settings_post_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if transport_web_hooks_update_web_hook_settings_request is not None:
            _body_params = transport_web_hooks_update_web_hook_settings_request
