...
class AuthorizationApi:
    ...
    async def api1_access_token_post(
        ...
        :type timeout: int
        :param transport_auth_get_access_token_request:
        :type transport_auth_get_access_token_request: TransportAuthGetAccessTokenRequest
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "TransportAuthGetAccessTokenResponse",
    ...
    async def api1_access_token_post_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[TransportAuthGetAccessTokenResponse]:
        """Retrieve session key for API user.
    ...
    def _api1_access_token_post_serialize(
        ...
        if transport_auth_get_access_token_request is not None:
            _body_params = transport_auth_get_access_token_request
