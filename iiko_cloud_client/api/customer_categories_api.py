...
class CustomerCategoriesApi:
    ...
    async def api1_loyalty_iiko_customer_category_add_post(
        ...
        :type net_customer_change_category_for_customer_request: NetCustomerChangeCategoryForCustomerRequest
    ...
    def _api1_loyalty_iiko_customer_category_add_post_serialize(
        ...
        if net_customer_change_category_for_customer_request is not None:
            _body_params = net_customer_change_category_for_customer_request
    ...
    async def api1_loyalty_iiko_customer_category_post(
        ...
        :type net_customer_get_categories_request: NetCustomerGetCategoriesRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "NetCustomerGetCategoriesResponse",
            '400': "TransportErrorsErrorResponse",
            '401': "TransportErrorsErrorResponse",
            '500': "TransportErrorsErrorResponse",
            '408': "TransportErrorsErrorResponse",
    ...
    async def api1_loyalty_iiko_customer_category_post_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[NetCustomerGetCategoriesResponse]:
        """Get customer categories.
    ...
    def _api1_loyalty_iiko_customer_category_post_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if net_customer_get_categories_request is not None:
            _body_params = net_customer_get_categories_request
