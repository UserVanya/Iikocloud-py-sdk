...
class OperationsApi:
    ...
    async def api1_commands_status_post(
        ...
        :type timeout: int
        :param transport_commands_get_command_status_request:
        :type transport_commands_get_command_status_request: TransportCommandsGetCommandStatusRequest
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "TransportCommandsGetCommandStatusResponse",
            ...
            '410': "TransportErrorsErrorResponse",
        }
    ...
    async def api1_commands_status_post_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[TransportCommandsGetCommandStatusResponse]:
        """Get status of command.
    ...
    def _api1_commands_status_post_serialize(
        ...
        if transport_commands_get_command_status_request is not None:
            _body_params = transport_commands_get_command_status_request
