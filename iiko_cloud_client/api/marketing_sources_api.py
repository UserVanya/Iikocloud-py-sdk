...
class MarketingSourcesApi:
    ...
    async def api1_marketing_sources_post(
        ...
        :type timeout: int
        :param transport_marketing_sources_marketing_sources_request:
        :type transport_marketing_sources_marketing_sources_request: TransportMarketingSourcesMarketingSourcesRequest
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "TransportMarketingSourcesMarketingSourcesResponse",
    ...
    async def api1_marketing_sources_post_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[TransportMarketingSourcesMarketingSourcesResponse]:
        """Marketing sources.
    ...
    def _api1_marketing_sources_post_serialize(
        ...
        if transport_marketing_sources_marketing_sources_request is not None:
            _body_params = transport_marketing_sources_marketing_sources_request
