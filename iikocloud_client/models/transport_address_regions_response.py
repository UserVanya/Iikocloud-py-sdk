...
class TransportAddressRegionsResponse(BaseModel):
    """
    Service response with list of districts.
    """ # noqa: E501
    correlation_id: StrictStr = Field(description="Operation ID.", alias="correlationId")
    regions: List[TransportCommonRmsItemsResponseWrapperRegion] = Field(description="List of districts.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "regions": [TransportCommonRmsItemsResponseWrapperRegion.from_dict(_item) for _item in obj["regions"]] if obj.get("regions") is not None else None
        })
        return _obj
