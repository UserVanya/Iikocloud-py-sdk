...
class IikoTransportPublicApiContractsReservesRestaurantSection(BaseModel):
    """
    Restaurant section.
    """ # noqa: E501
    ...
    tables: List[IikoTransportPublicApiContractsReservesTable] = Field(description="Tables.")
    var_schema: Optional[IikoTransportPublicApiContractsReservesSectionSchema] = Field(default=None, description="Table layout.", alias="schema")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "name": obj.get("name"),
            "tables": [IikoTransportPublicApiContractsReservesTable.from_dict(_item) for _item in obj["tables"]] if obj.get("tables") is not None else None,
            "schema": IikoTransportPublicApiContractsReservesSectionSchema.from_dict(obj["schema"]) if obj.get("schema") is not None else None
        })
        return _obj
