...
class TransportDeliveryRestrictionsAllowedRestrictionsAllowedItemWithDuration(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["terminalGroupId", "organizationId", "deliveryDurationInMinutes", "zone", "deliveryServiceProductId"]
