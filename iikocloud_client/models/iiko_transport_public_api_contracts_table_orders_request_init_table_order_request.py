...
class IikoTransportPublicApiContractsTableOrdersRequestInitTableOrderRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["organizationId", "terminalGroupId", "tableIds"]
