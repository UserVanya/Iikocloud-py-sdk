...
class DeliveryRestrictionsAllowedRestrictionsGetAllowedRestrictionsRequest(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "deliveryAddress": DeliveryRestrictionsAllowedRestrictionsRestrictionsAddress.from_dict(obj["deliveryAddress"]) if obj.get("deliveryAddress") is not None else None,
            "orderLocation": DeliveryRestrictionsAllowedRestrictionsOrderLocation.from_dict(obj["orderLocation"]) if obj.get("orderLocation") is not None else None,
            "orderItems": [DeliveryRestrictionsAllowedRestrictionsRestrictionsOrderItem.from_dict(_item) for _item in obj["orderItems"]] if obj.get("orderItems") is not None else None,
