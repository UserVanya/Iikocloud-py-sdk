...
class TransportDeliveriesRequestCreateOrderModifier(BaseModel):
    ...
    Modifier.
    """ # noqa: E501
    product_id: StrictStr = Field(description="Modifier item ID.                Can be obtained by `/nomenclature` operation.", alias="productId")
    amount: Union[StrictFloat, StrictInt] = Field(description="Quantity.")
    product_group_id: Optional[StrictStr] = Field(default=None, description="Modifiers group ID (for group modifier). Required for a group modifier.                Can be obtained by `/nomenclature` operation.", alias="productGroupId")
