...
class TransportReservesRestaurantSection(BaseModel):
    """
    Restaurant section.
    """ # noqa: E501
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "name": obj.get("name"),
            "tables": [TransportReservesTable.from_dict(_item) for _item in obj["tables"]] if obj.get("tables") is not None else None,
            "schema": TransportReservesSectionSchema.from_dict(obj["schema"]) if obj.get("schema") is not None else None
        })
        return _obj
