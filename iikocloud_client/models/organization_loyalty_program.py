...
class OrganizationLoyaltyProgram(BaseModel):
    """
    Loyalty program.
    """ # noqa: E501
    ...
    marketing_campaigns: Optional[List[OrganizationMarketingCampaignInfo]] = Field(default=None, description="Program marketing campaigns.", alias="marketingCampaigns")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "marketingCampaigns": [OrganizationMarketingCampaignInfo.from_dict(_item) for _item in obj["marketingCampaigns"]] if obj.get("marketingCampaigns") is not None else None,
