...
class ComboGroupItemSizeDto3(BaseModel):
    """
    ...
    prices: Optional[List[ExternalMenuPriceByDepartmentsDto7]] = None
    __properties: ClassVar[List[str]] = ["comboSizeId", "sizeId", "name", "shortName", "prices"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "prices": [ExternalMenuPriceByDepartmentsDto7.from_dict(_item) for _item in obj["prices"]] if obj.get("prices") is not None else None
        })
        return _obj
