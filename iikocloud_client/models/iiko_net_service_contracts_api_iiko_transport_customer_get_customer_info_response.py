...
class IikoNetServiceContractsApiIikoTransportCustomerGetCustomerInfoResponse(BaseModel):
    """
    ...
    sex: Optional[IikoNetServiceContractsApiIikoTransportCustomerIikoNetUserSex] = Field(default=None, description="Sex.  <br>0 - not specified,<br />1 - male,<br />2 - female.")
    consent_status: Optional[IikoNetServiceContractsApiIikoTransportCustomerPersonalDataConsentStatus] = Field(default=None, description="Guest consent status.  <br>0 - unknown,<br />1 - given,<br />2 - revoked.", alias="consentStatus")
    anonymized: Optional[StrictBool] = Field(default=None, description="Guest anonymized.")
    cards: Optional[List[IikoNetServiceContractsApiIikoTransportCustomerGuestCardInfo]] = Field(default=None, description="Customer's cards.")
    categories: Optional[List[IikoNetServiceContractsApiIikoTransportCustomerGuestCategoryShortInfo]] = Field(default=None, description="Customer categories.")
    wallet_balances: Optional[List[IikoNetServiceContractsApiIikoTransportCustomerGuestBalanceInfo]] = Field(default=None, description="Customer's user wallets. Contains bonus balances of different loyalty programs.", alias="walletBalances")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "cards": [IikoNetServiceContractsApiIikoTransportCustomerGuestCardInfo.from_dict(_item) for _item in obj["cards"]] if obj.get("cards") is not None else None,
            "categories": [IikoNetServiceContractsApiIikoTransportCustomerGuestCategoryShortInfo.from_dict(_item) for _item in obj["categories"]] if obj.get("categories") is not None else None,
            "walletBalances": [IikoNetServiceContractsApiIikoTransportCustomerGuestBalanceInfo.from_dict(_item) for _item in obj["walletBalances"]] if obj.get("walletBalances") is not None else None,
