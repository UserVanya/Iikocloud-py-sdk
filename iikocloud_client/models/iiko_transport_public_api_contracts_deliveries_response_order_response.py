...
class IikoTransportPublicApiContractsDeliveriesResponseOrderResponse(BaseModel):
    """
    ...
    order_info: IikoTransportPublicApiContractsDeliveriesResponseOrderOrderInfo = Field(description="Delivery order.", alias="orderInfo")
    __properties: ClassVar[List[str]] = ["correlationId", "orderInfo"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.order_info:
            _dict['orderInfo'] = self.order_info.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "orderInfo": IikoTransportPublicApiContractsDeliveriesResponseOrderOrderInfo.from_dict(obj["orderInfo"]) if obj.get("orderInfo") is not None else None
        })
        return _obj
