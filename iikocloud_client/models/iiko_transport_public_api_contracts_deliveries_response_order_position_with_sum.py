...
class IikoTransportPublicApiContractsDeliveriesResponseOrderPositionWithSum(BaseModel):
    """
    Order item positions with position discount sum.
    """ # noqa: E501
    position_id: UUID = Field(description="Order item position ID.", alias="positionId")
    sum: Union[StrictFloat, StrictInt] = Field(description="Position discount sum.")
    __properties: ClassVar[List[str]] = ["positionId", "sum"]
