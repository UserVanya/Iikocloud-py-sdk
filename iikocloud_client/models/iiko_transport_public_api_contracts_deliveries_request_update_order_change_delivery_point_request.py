...
class IikoTransportPublicApiContractsDeliveriesRequestUpdateOrderChangeDeliveryPointRequest(BaseModel):
    """
    ...
    new_delivery_point: IikoTransportPublicApiContractsDeliveriesRequestCreateOrderDeliveryPoint = Field(description="New address of delivery.", alias="newDeliveryPoint")
    __properties: ClassVar[List[str]] = ["organizationId", "orderId", "newDeliveryPoint"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of new_delivery_point
        if self.new_delivery_point:
            _dict['newDeliveryPoint'] = self.new_delivery_point.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "newDeliveryPoint": IikoTransportPublicApiContractsDeliveriesRequestCreateOrderDeliveryPoint.from_dict(obj["newDeliveryPoint"]) if obj.get("newDeliveryPoint") is not None else None
        })
        return _obj
