...
class EmployeesEmployeesResponse(BaseModel):
    """
    ...
    employees: List[WrapperEmployeesEmployee] = Field(description="List of drivers.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "employees": [WrapperEmployeesEmployee.from_dict(_item) for _item in obj["employees"]] if obj.get("employees") is not None else None
        })
        return _obj
