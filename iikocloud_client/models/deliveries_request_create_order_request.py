...
class DeliveriesRequestCreateOrderRequest(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "createOrderSettings": OrdersCommonCreateOrderSettings.from_dict(obj["createOrderSettings"]) if obj.get("createOrderSettings") is not None else None,
            "order": DeliveriesRequestCreateOrderDeliveryOrder.from_dict(obj["order"]) if obj.get("order") is not None else None
        })
        return _obj
