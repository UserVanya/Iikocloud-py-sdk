...
class IikoTransportPublicApiContractsDeliveriesRequestUpdateDeliveryStatusRequest(BaseModel):
    """
    ...
    delivery_status: IikoTransportPublicApiContractsDeliveriesCommonDeliveryStatusForUpdate = Field(description="Delivery status. Can be only switched between these three statuses.", alias="deliveryStatus")
    ...
    __properties: ClassVar[List[str]] = ["organizationId", "orderId", "deliveryStatus", "deliveryDate"]
