...
class ExternalMenuItem3(BaseModel):
    """
    ExternalMenuItem3
    """ # noqa: E501
    ...
    item_sizes: List[ExternalMenuItemSize3] = Field(alias="itemSizes")
    ...
    customer_tag_groups: Optional[List[SelectedCustomerTag3]] = Field(default=None, alias="customerTagGroups")
    ...
    barcodes: Optional[List[BarcodeDto3]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "itemSizes": [ExternalMenuItemSize3.from_dict(_item) for _item in obj["itemSizes"]] if obj.get("itemSizes") is not None else None,
            ...
            "customerTagGroups": [SelectedCustomerTag3.from_dict(_item) for _item in obj["customerTagGroups"]] if obj.get("customerTagGroups") is not None else None,
            ...
            "barcodes": [BarcodeDto3.from_dict(_item) for _item in obj["barcodes"]] if obj.get("barcodes") is not None else None,
