...
class IikoTransportPublicApiContractsDeliveriesRequestOrdersByDeliveryDateAndFilterRequest(BaseModel):
    """
    ...
    statuses: Optional[List[IikoTransportPublicApiContractsDeliveriesCommonDeliveryStatus]] = Field(default=None, description="Allowed order statuses.")
    ...
    order_service_type: Optional[IikoTransportPublicApiContractsDeliveriesRequestCreateOrderOrderServiceType] = Field(default=None, description="Order service type.", alias="orderServiceType")
    ...
    sort_property: Optional[IikoTransportPublicApiContractsDeliveriesRequestOrderSortProperty] = Field(default=None, description="Sorting property.", alias="sortProperty")
    sort_direction: Optional[IikoTransportPublicApiContractsCommonSortDirection] = Field(default=None, description="Sorting direction.", alias="sortDirection")
