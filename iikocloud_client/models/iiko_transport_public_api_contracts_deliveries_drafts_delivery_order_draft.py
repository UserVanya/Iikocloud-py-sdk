...
class IikoTransportPublicApiContractsDeliveriesDraftsDeliveryOrderDraft(BaseModel):
    """
    ...
    order_type_id: Optional[UUID] = Field(default=None, description="Order type ID.     Can be obtained by `/deliveries/order_types` operation.    > Only one of the fields must be defined: **orderTypeId** or **orderServiceType**.", alias="orderTypeId")
    order_service_type: Optional[IikoTransportPublicApiContractsDeliveriesRequestCreateOrderOrderServiceType] = Field(default=None, description="Order service type.  > Only one of the fields must be defined: **orderTypeId** or **orderServiceType**.   > Allowed from version `7.0.3`.", alias="orderServiceType")
    delivery_point: Optional[IikoTransportPublicApiContractsDeliveriesRequestCreateOrderDeliveryPoint] = Field(default=None, description="Delivery point details.  > Not required in case of customer pickup. Otherwise, required.", alias="deliveryPoint")
    comment: Optional[StrictStr] = Field(default=None, description="Order comment.")
    customer: Optional[IikoTransportPublicApiContractsDeliveriesRequestCreateOrderCustomer] = Field(default=None, description="Customer.                'Regular' customer:    - can be used only if a customer agrees to take part in the store's loyalty programs  - customer details will be added (updated) to the store's customer database  - benefits (accumulation of rewards, etc.) of active loyalty programs will be made available to the customer     'One-time' customer:    - should be used if a customer does not agree to take part in the store's loyalty programs or an aggregator (external system) does not provide customer details  - customer details will NOT be added to the store's customer database and will be used ONLY to complete the current order")
    guests: Optional[IikoTransportPublicApiContractsDeliveriesRequestCreateOrderGuests] = Field(default=None, description="Guest details. Not equal to the customer who makes an order.")
    marketing_source_id: Optional[UUID] = Field(default=None, description="Marketing source (advertisement) ID.                 Can be obtained by `/marketing_sources` operation.", alias="marketingSourceId")
    ...
    items: List[IikoTransportPublicApiContractsDeliveriesRequestCreateOrderOrderItem] = Field(description="Order items.")
    combos: Optional[List[IikoTransportPublicApiContractsDeliveriesRequestCreateOrderCombo]] = Field(default=None, description="Combos included in order.")
    payments: Optional[List[IikoTransportPublicApiContractsDeliveriesRequestCreateOrderPayment]] = Field(default=None, description="Order payment components.   > Type **LoyaltyCard** allowed from version `7.1.5`.")
    tips: Optional[List[IikoTransportPublicApiContractsDeliveriesRequestCreateOrderTipsPayment]] = Field(default=None, description="Order tips components.")
    ...
    discounts_info: Optional[IikoTransportPublicApiContractsDeliveriesRequestCreateOrderDiscountsInfo] = Field(default=None, description="Discounts/surcharges.", alias="discountsInfo")
    loyalty_info: Optional[IikoTransportPublicApiContractsDeliveriesRequestCreateOrderLoyaltyInfo] = Field(default=None, description="Information about Loyalty app.", alias="loyaltyInfo")
    cheque_additional_info: Optional[IikoTransportPublicApiContractsDeliveriesCommonChequeAdditionalInfo] = Field(default=None, description="Cheque additional information.", alias="chequeAdditionalInfo")
    external_data: Optional[List[IikoTransportPublicApiContractsDeliveriesRequestCreateOrderExternalData]] = Field(default=None, description="Order external data.   > Allowed from version `8.0.6`.", alias="externalData")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "deliveryPoint": IikoTransportPublicApiContractsDeliveriesRequestCreateOrderDeliveryPoint.from_dict(obj["deliveryPoint"]) if obj.get("deliveryPoint") is not None else None,
            "comment": obj.get("comment"),
            "customer": IikoTransportPublicApiContractsDeliveriesRequestCreateOrderCustomer.from_dict(obj["customer"]) if obj.get("customer") is not None else None,
            "guests": IikoTransportPublicApiContractsDeliveriesRequestCreateOrderGuests.from_dict(obj["guests"]) if obj.get("guests") is not None else None,
            ...
            "items": [IikoTransportPublicApiContractsDeliveriesRequestCreateOrderOrderItem.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
            "combos": [IikoTransportPublicApiContractsDeliveriesRequestCreateOrderCombo.from_dict(_item) for _item in obj["combos"]] if obj.get("combos") is not None else None,
            "payments": [IikoTransportPublicApiContractsDeliveriesRequestCreateOrderPayment.from_dict(_item) for _item in obj["payments"]] if obj.get("payments") is not None else None,
            "tips": [IikoTransportPublicApiContractsDeliveriesRequestCreateOrderTipsPayment.from_dict(_item) for _item in obj["tips"]] if obj.get("tips") is not None else None,
            "sourceKey": obj.get("sourceKey"),
            "discountsInfo": IikoTransportPublicApiContractsDeliveriesRequestCreateOrderDiscountsInfo.from_dict(obj["discountsInfo"]) if obj.get("discountsInfo") is not None else None,
            "loyaltyInfo": IikoTransportPublicApiContractsDeliveriesRequestCreateOrderLoyaltyInfo.from_dict(obj["loyaltyInfo"]) if obj.get("loyaltyInfo") is not None else None,
            "chequeAdditionalInfo": IikoTransportPublicApiContractsDeliveriesCommonChequeAdditionalInfo.from_dict(obj["chequeAdditionalInfo"]) if obj.get("chequeAdditionalInfo") is not None else None,
            "externalData": [IikoTransportPublicApiContractsDeliveriesRequestCreateOrderExternalData.from_dict(_item) for _item in obj["externalData"]] if obj.get("externalData") is not None else None
        })
        return _obj
