...
class IikoTransportPublicApiContractsReservesCreateReserveRequest(BaseModel):
    """
    ...
    order: Optional[IikoTransportPublicApiContractsReservesRequestReserveOrder] = Field(default=None, description="Order. Used only at a banquet.")
    customer: IikoTransportPublicApiContractsDeliveriesRequestCreateOrderRegularCustomer = Field(description="Customer.")
    ...
    guests: Optional[IikoTransportPublicApiContractsReservesGuestsInfo] = Field(default=None, description="Guests information.")
    ...
    create_reserve_settings: Optional[IikoTransportPublicApiContractsOrdersCommonCreateOrderSettingsBase] = Field(default=None, description="Reserve creation parameters.", alias="createReserveSettings")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "order": IikoTransportPublicApiContractsReservesRequestReserveOrder.from_dict(obj["order"]) if obj.get("order") is not None else None,
            ...
            "guests": IikoTransportPublicApiContractsReservesGuestsInfo.from_dict(obj["guests"]) if obj.get("guests") is not None else None,
            "eventType": obj.get("eventType"),
            "createReserveSettings": IikoTransportPublicApiContractsOrdersCommonCreateOrderSettingsBase.from_dict(obj["createReserveSettings"]) if obj.get("createReserveSettings") is not None else None
        })
        return _obj
