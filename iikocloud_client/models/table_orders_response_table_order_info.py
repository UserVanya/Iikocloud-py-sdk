...
class TableOrdersResponseTableOrderInfo(BaseModel):
    """
    Order.
    """ # noqa: E501
    ...
    order: Optional[TableOrdersResponseTableOrder] = Field(default=None, description="Order creation details.  > Field is filled up if \"creationStatus\"=\"Success\".")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "order": TableOrdersResponseTableOrder.from_dict(obj["order"]) if obj.get("order") is not None else None
        })
        return _obj
