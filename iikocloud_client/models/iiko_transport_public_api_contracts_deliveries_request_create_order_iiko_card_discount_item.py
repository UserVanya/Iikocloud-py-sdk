...
class IikoTransportPublicApiContractsDeliveriesRequestCreateOrderIikoCardDiscountItem(BaseModel):
    """
    Card discount/surcharge item.
    """ # noqa: E501
    position_id: UUID = Field(description="Position ID of order item.", alias="positionId")
    sum: Union[StrictFloat, StrictInt] = Field(description="Discount/surcharge sum.")
    amount: Union[StrictFloat, StrictInt] = Field(description="Amount.")
    __properties: ClassVar[List[str]] = ["positionId", "sum", "amount"]
