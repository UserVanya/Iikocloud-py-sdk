...
class TransportDeliveriesResponseOrderCompoundOrderItem(TransportDeliveriesResponseOrderOrderItem):
    """
    Order item: composite item.
    """ # noqa: E501
    primary_component: TransportDeliveriesResponseOrderCompoundOrderItemComponent = Field(description="Main component.", alias="primaryComponent")
    secondary_component: Optional[TransportDeliveriesResponseOrderCompoundOrderItemComponent] = Field(default=None, description="Additional component.", alias="secondaryComponent")
    common_modifiers: Optional[List[TransportDeliveriesResponseOrderOrderItemModifier]] = Field(default=None, description="Indivisible modifiers.", alias="commonModifiers")
    template: Optional[TransportDeliveriesResponseOrderCompoundItemTemplate] = Field(default=None, description="Modifier scheme.")
