...
class IikoTransportPublicApiContractsStopListsCheckStopListResponse(BaseModel):
    """
    Response for check items in out-of-stock list.
    """ # noqa: E501
    correlation_id: UUID = Field(description="Operation ID.", alias="correlationId")
    rejected_items: Optional[List[IikoTransportPublicApiContractsStopListsStopListItem]] = Field(default=None, description="Set of items in out-of-stock list.                If null, none of requested items are in out-of-stock list.  > Present in response only if **not null**.", alias="rejectedItems")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "rejectedItems": [IikoTransportPublicApiContractsStopListsStopListItem.from_dict(_item) for _item in obj["rejectedItems"]] if obj.get("rejectedItems") is not None else None
        })
        return _obj
