...
class IikoTransportPublicApiContractsNomenclatureNomenclatureResponse(BaseModel):
    """
    Response with stock lists.
    """ # noqa: E501
    correlation_id: UUID = Field(description="Operation ID.", alias="correlationId")
    groups: List[IikoTransportPublicApiContractsNomenclatureProductsGroupInfo] = Field(description="Stock list group.")
    product_categories: List[IikoTransportPublicApiContractsNomenclatureProductCategoryInfo] = Field(description="Menu item category.", alias="productCategories")
    products: List[IikoTransportPublicApiContractsNomenclatureProductInfo] = Field(description="Menu items and modifiers.")
    sizes: List[IikoTransportPublicApiContractsNomenclatureSize] = Field(description="Item sizes.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "groups": [IikoTransportPublicApiContractsNomenclatureProductsGroupInfo.from_dict(_item) for _item in obj["groups"]] if obj.get("groups") is not None else None,
            "productCategories": [IikoTransportPublicApiContractsNomenclatureProductCategoryInfo.from_dict(_item) for _item in obj["productCategories"]] if obj.get("productCategories") is not None else None,
            "products": [IikoTransportPublicApiContractsNomenclatureProductInfo.from_dict(_item) for _item in obj["products"]] if obj.get("products") is not None else None,
            "sizes": [IikoTransportPublicApiContractsNomenclatureSize.from_dict(_item) for _item in obj["sizes"]] if obj.get("sizes") is not None else None,
