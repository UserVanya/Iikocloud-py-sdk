...
class ComboGroupItemDto4(BaseModel):
    """
    ComboGroupItemDto4
    """ # noqa: E501
    ...
    sizes: Optional[List[ComboGroupItemSizeDto4]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "sizes": [ComboGroupItemSizeDto4.from_dict(_item) for _item in obj["sizes"]] if obj.get("sizes") is not None else None
        })
        return _obj
