...
class DeliveriesRequestCreateOrderPayment(BaseModel):
    """
    ...
    def from_dict(cls, obj: Dict[str, Any]) -> Optional[Union[IikoTransportPublicApiContractsDeliveriesRequestCreateOrderCardPayment, IikoTransportPublicApiContractsDeliveriesRequestCreateOrderCashPayment, IikoTransportPublicApiContractsDeliveriesRequestCreateOrderExternalPayment, IikoTransportPublicApiContractsDeliveriesRequestCreateOrderLoyaltyCardPayment, DeliveriesRequestCreateOrderCardPayment, DeliveriesRequestCreateOrderCashPayment, DeliveriesRequestCreateOrderExternalPayment, DeliveriesRequestCreateOrderLoyaltyCardPayment]]:
        ...
        if object_type ==  'DeliveriesRequestCreateOrderCashPayment':
            return import_module("iikocloud_client.models.deliveries_request_create_order_cash_payment").DeliveriesRequestCreateOrderCashPayment.from_dict(obj)
        if object_type ==  'DeliveriesRequestCreateOrderExternalPayment':
            return import_module("iikocloud_client.models.deliveries_request_create_order_external_payment").DeliveriesRequestCreateOrderExternalPayment.from_dict(obj)
        if object_type ==  'DeliveriesRequestCreateOrderLoyaltyCardPayment':
            return import_module("iikocloud_client.models.deliveries_request_create_order_loyalty_card_payment").DeliveriesRequestCreateOrderLoyaltyCardPayment.from_dict(obj)

        raise ValueError("DeliveriesRequestCreateOrderPayment failed to lookup discriminator value from " +
