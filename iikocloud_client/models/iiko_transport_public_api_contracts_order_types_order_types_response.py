...
class IikoTransportPublicApiContractsOrderTypesOrderTypesResponse(BaseModel):
    """
    ...
    order_types: List[RmsItemsResponseWrapperOrderTypesOrderType] = Field(description="List of order types.", alias="orderTypes")
    __properties: ClassVar[List[str]] = ["correlationId", "orderTypes"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "orderTypes": [RmsItemsResponseWrapperOrderTypesOrderType.from_dict(_item) for _item in obj["orderTypes"]] if obj.get("orderTypes") is not None else None
        })
        return _obj
