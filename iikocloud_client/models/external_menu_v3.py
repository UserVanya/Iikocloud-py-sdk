...
class ExternalMenuV3(BaseModel):
    ...
    override_tax_categories: Optional[List[OverrideTaxesDto]] = Field(default=None, description="Tax benefits", alias="overrideTaxCategories")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "overrideTaxCategories": [OverrideTaxesDto.from_dict(_item) for _item in obj["overrideTaxCategories"]] if obj.get("overrideTaxCategories") is not None else None,
