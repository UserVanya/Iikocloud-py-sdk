...
class IikoTransportPublicApiContractsDeliveryRestrictionsAllowedRestrictionsGetAllowedRestrictionsResponse(BaseModel):
    """
    ...
    location: Optional[IikoTransportPublicApiContractsDeliveryRestrictionsAllowedRestrictionsOrderLocation] = Field(description="Coordinates returned by geocoding service.")
    allowed_items: List[IikoTransportPublicApiContractsDeliveryRestrictionsAllowedRestrictionsAllowedItemWithDuration] = Field(description="Suitable terminal groups with a delivery duration for them.", alias="allowedItems")
    rejected_items: List[IikoTransportPublicApiContractsDeliveryRestrictionsAllowedRestrictionsRejectItem] = Field(description="Rejected items with cause.", alias="rejectedItems")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "location": IikoTransportPublicApiContractsDeliveryRestrictionsAllowedRestrictionsOrderLocation.from_dict(obj["location"]) if obj.get("location") is not None else None,
            "allowedItems": [IikoTransportPublicApiContractsDeliveryRestrictionsAllowedRestrictionsAllowedItemWithDuration.from_dict(_item) for _item in obj["allowedItems"]] if obj.get("allowedItems") is not None else None,
            "rejectedItems": [IikoTransportPublicApiContractsDeliveryRestrictionsAllowedRestrictionsRejectItem.from_dict(_item) for _item in obj["rejectedItems"]] if obj.get("rejectedItems") is not None else None
        })
        return _obj
