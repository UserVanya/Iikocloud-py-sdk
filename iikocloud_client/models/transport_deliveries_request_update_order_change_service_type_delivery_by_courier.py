...
class TransportDeliveriesRequestUpdateOrderChangeServiceTypeDeliveryByCourier(TransportDeliveriesRequestUpdateOrderChangeServiceTypeRequest):
    """
    Change order's delivery type to DeliveryByCourier.
    """ # noqa: E501
    delivery_point: TransportDeliveriesRequestCreateOrderDeliveryPoint = Field(description="Address of delivery.", alias="deliveryPoint")
