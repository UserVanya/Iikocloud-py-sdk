...
class DeliveriesRequestCreateOrderOrderItem(BaseModel):
    """
    Order item.
    """ # noqa: E501
    type: StrictStr
    ...
    combo_information: Optional[DeliveriesRequestCreateOrderComboItemInformation] = Field(default=None, description="Combo details if combo includes order item.", alias="comboInformation")
    ...
    def from_dict(cls, obj: Dict[str, Any]) -> Optional[Union[DeliveriesRequestCreateOrderCompoundOrderItem, DeliveriesRequestCreateOrderProductOrderItem]]:
        ...
        if object_type ==  'DeliveriesRequestCreateOrderProductOrderItem':
            return import_module("iikocloud_client.models.deliveries_request_create_order_product_order_item").DeliveriesRequestCreateOrderProductOrderItem.from_dict(obj)

        raise ValueError("DeliveriesRequestCreateOrderOrderItem failed to lookup discriminator value from " +
