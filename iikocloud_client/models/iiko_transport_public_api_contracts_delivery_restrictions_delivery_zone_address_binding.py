...
class IikoTransportPublicApiContractsDeliveryRestrictionsDeliveryZoneAddressBinding(BaseModel):
    """
    Delivery zone polygon, defined by the combination of street, index and house numbers.
    """ # noqa: E501
    street_id: UUID = Field(description="ID of the delivery zone's street.", alias="streetId")
    postcode: StrictStr = Field(description="Postcode.")
    houses: IikoTransportPublicApiContractsDeliveryRestrictionsHousesRange = Field(description="Range of house numbers in the delivery zone.")
    __properties: ClassVar[List[str]] = ["streetId", "postcode", "houses"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "houses": IikoTransportPublicApiContractsDeliveryRestrictionsHousesRange.from_dict(obj["houses"]) if obj.get("houses") is not None else None
        })
        return _obj
