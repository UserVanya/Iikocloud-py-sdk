...
class ReportGetTransactionsReportByPeriodResponse(BaseModel):
    """
    Get transactions report by period response.
    """ # noqa: E501
    transactions: Optional[List[ReportTransportTransactionsReportItem]] = Field(default=None, description="Transactions.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "transactions": [ReportTransportTransactionsReportItem.from_dict(_item) for _item in obj["transactions"]] if obj.get("transactions") is not None else None,
