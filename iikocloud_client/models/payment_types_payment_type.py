...
class PaymentTypesPaymentType(BaseModel):
    """
    ...
    payment_processing_type: Optional[PaymentTypesPaymentProcessingType] = Field(default=None, description="Describes operation processing type.", alias="paymentProcessingType")
    payment_type_kind: Optional[PaymentTypesPaymentTypeKind] = Field(default=None, description="Payment type category.", alias="paymentTypeKind")
    terminal_groups: List[TerminalsTerminalGroup] = Field(description="Terminal groups where this payment type is available.", alias="terminalGroups")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "terminalGroups": [TerminalsTerminalGroup.from_dict(_item) for _item in obj["terminalGroups"]] if obj.get("terminalGroups") is not None else None
        })
        return _obj
