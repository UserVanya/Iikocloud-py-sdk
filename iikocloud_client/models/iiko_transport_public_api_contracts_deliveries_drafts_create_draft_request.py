...
class IikoTransportPublicApiContractsDeliveriesDraftsCreateDraftRequest(BaseModel):
    """
    ...
    order: IikoTransportPublicApiContractsDeliveriesDraftsDeliveryOrderDraft = Field(description="Order item.")
