...
class IikoTransportPublicApiContractsDeliveriesRequestUpdateOrderChangeExternalDataRequest(BaseModel):
    """
    ...
    external_data: List[IikoTransportPublicApiContractsDeliveriesRequestCreateOrderExternalData] = Field(description="External data to change.", alias="externalData")
    __properties: ClassVar[List[str]] = ["organizationId", "orderId", "externalData"]
