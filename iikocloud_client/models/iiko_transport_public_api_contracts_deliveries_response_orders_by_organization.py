...
class IikoTransportPublicApiContractsDeliveriesResponseOrdersByOrganization(BaseModel):
    """
    ...
    orders: List[IikoTransportPublicApiContractsDeliveriesResponseOrderOrderInfo] = Field(description="List of orders by organization.")
