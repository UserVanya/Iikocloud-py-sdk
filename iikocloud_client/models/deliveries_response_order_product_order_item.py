...
class DeliveriesResponseOrderProductOrderItem(DeliveriesResponseOrderOrderItem):
    ...
    codes: Optional[List[List[DeliveriesResponseOrderOrderItemIdentifierCode]]] = Field(default=None, description="List of product codes. Each outer list item represents a separate product unit;  each inner list contains codes associated with that unit.   > Allowed from version `9.2.6`.")
