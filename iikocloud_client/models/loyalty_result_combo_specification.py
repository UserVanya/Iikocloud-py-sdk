...
class LoyaltyResultComboSpecification(BaseModel):
    """
    ...
    price_modification_type: Optional[LoyaltyResultComboPriceModificationType] = Field(default=None, description="Price modification type.  <br>0 - fixed combo price,<br />1 - fixed position price,<br />2 - cheapest position discount,<br />3 - most expensive position discount,<br />4 - percentage discount for each position.", alias="priceModificationType")
    ...
    groups: Optional[List[LoyaltyResultComboGroup]] = Field(default=None, description="Groups.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "groups": [LoyaltyResultComboGroup.from_dict(_item) for _item in obj["groups"]] if obj.get("groups") is not None else None
        })
        return _obj
