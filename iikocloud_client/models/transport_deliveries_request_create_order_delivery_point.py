...
class TransportDeliveriesRequestCreateOrderDeliveryPoint(BaseModel):
    ...
    address: Optional[TransportDeliveriesRequestCreateOrderAddress] = Field(default=None, description="Order delivery address.                > The use of type **City** is allowed if the parameter **addressFormatType == City**.                > Can be obtained by `/organizations` or `/organizations/settings` operations (`addressFormatType` parameter).")
