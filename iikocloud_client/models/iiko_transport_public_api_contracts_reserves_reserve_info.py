...
class IikoTransportPublicApiContractsReservesReserveInfo(BaseModel):
    """
    Banquet/reserve.
    """ # noqa: E501
    ...
    creation_status: IikoTransportPublicApiContractsDeliveriesResponseOrderCreationStatus = Field(description="Banquet/reserve creation status. In case of asynchronous creation, it allows to track the instance an banquet/reserve was validated/created in iikoFront.", alias="creationStatus")
    error_info: Optional[IikoTransportPublicApiContractsErrorsErrorInfo] = Field(default=None, description="Banquet/reserve creation error details.  > Required only if \"creationStatus\"=\"Error\".", alias="errorInfo")
    is_deleted: StrictBool = Field(description="Banquet/reserve is deleted.", alias="isDeleted")
    reserve: Optional[IikoTransportPublicApiContractsReservesReserve] = Field(default=None, description="Banquet/reserve.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "reserve": IikoTransportPublicApiContractsReservesReserve.from_dict(obj["reserve"]) if obj.get("reserve") is not None else None
        })
        return _obj
