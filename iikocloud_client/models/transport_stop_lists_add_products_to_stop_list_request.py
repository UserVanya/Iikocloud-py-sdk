...
class TransportStopListsAddProductsToStopListRequest(BaseModel):
    """
    ...
    items: List[TransportStopListsAddProductsToStopListItem] = Field(description="Items for adding to out-of-stock list.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "items": [TransportStopListsAddProductsToStopListItem.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None
        })
        return _obj
