...
class ExternalMenuCategory3(BaseModel):
    """
    ...
    items: List[ExternalMenuCategory3ItemsInner]
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "description", "buttonImageUrl", "iikoGroupId", "scheduleId", "scheduleName", "schedules", "isHidden", "items", "labels", "tags"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "items": [ExternalMenuCategory3ItemsInner.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
