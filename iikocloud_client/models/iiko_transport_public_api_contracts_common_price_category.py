...
class IikoTransportPublicApiContractsCommonPriceCategory(BaseModel):
    """
    Price category of the order.
    """ # noqa: E501
    id: UUID = Field(description="Id of price category.")
    name: Optional[StrictStr] = Field(default=None, description="Name of price category.")
