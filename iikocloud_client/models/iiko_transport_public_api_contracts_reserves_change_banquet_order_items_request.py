...
class IikoTransportPublicApiContractsReservesChangeBanquetOrderItemsRequest(BaseModel):
    """
    ...
    items: Optional[List[IikoTransportPublicApiContractsDeliveriesRequestCreateOrderOrderItem]] = Field(default=None, description="Order items (may include ProductOrderItem or CompoundOrderItem).")
    combos: Optional[List[IikoTransportPublicApiContractsDeliveriesRequestCreateOrderCombo]] = Field(default=None, description="Combos.")
    __properties: ClassVar[List[str]] = ["organizationId", "reserveId", "items", "combos"]
