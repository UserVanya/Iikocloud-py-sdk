...
class TransportDeliveriesResponseOrderTipsPaymentItem(BaseModel):
    """
    Delivery order tips payment component.
    """ # noqa: E501
    tips_type: Optional[TransportDeliveriesResponseOrderTipsType] = Field(default=None, description="Tips type.", alias="tipsType")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "tipsType": TransportDeliveriesResponseOrderTipsType.from_dict(obj["tipsType"]) if obj.get("tipsType") is not None else None,
            "paymentType": TransportDeliveriesResponseOrderPaymentType.from_dict(obj["paymentType"]) if obj.get("paymentType") is not None else None,
            "sum": obj.get("sum"),
