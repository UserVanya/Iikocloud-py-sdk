...
class IikoNetServiceContractsApiIikoTransportOrganizationLoyaltyProgram(BaseModel):
    """
    Loyalty program.
    """ # noqa: E501
    ...
    program_type: Optional[IikoNetServiceContractsApiIikoTransportProgramType] = Field(default=None, description="Program type.  <br>0 - deposit or corporate nutrition,<br />1 - bonus program,<br />2 - products program,<br />3 - discount program,<br />4 - certificate program.", alias="programType")
    ...
    marketing_campaigns: Optional[List[IikoNetServiceContractsApiIikoTransportOrganizationMarketingCampaignInfo]] = Field(default=None, description="Program marketing campaigns.", alias="marketingCampaigns")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "marketingCampaigns": [IikoNetServiceContractsApiIikoTransportOrganizationMarketingCampaignInfo.from_dict(_item) for _item in obj["marketingCampaigns"]] if obj.get("marketingCampaigns") is not None else None,
