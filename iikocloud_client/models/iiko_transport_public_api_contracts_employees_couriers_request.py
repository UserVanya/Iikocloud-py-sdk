...
class IikoTransportPublicApiContractsEmployeesCouriersRequest(BaseModel):
    """
    Request for list of drivers for organizations in OrganizationIds.
    """ # noqa: E501
    organization_ids: List[UUID] = Field(description="List of organizations.", alias="organizationIds")
