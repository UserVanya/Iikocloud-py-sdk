...
class LoyaltyResultGetCountersResponse(BaseModel):
    """
    Get counters response.
    """ # noqa: E501
    counters: Optional[List[LoyaltyResultGuestCounter]] = Field(default=None, description="Counters.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "counters": [LoyaltyResultGuestCounter.from_dict(_item) for _item in obj["counters"]] if obj.get("counters") is not None else None
        })
        return _obj
