...
class WebHooksGetWebHookSettingsResponse(BaseModel):
    """
    ...
    web_hooks_filter: Optional[IntegrationWebHooksFiltersWebHooksFilter] = Field(default=None, description="Webhooks filter.", alias="webHooksFilter")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "webHooksFilter": IntegrationWebHooksFiltersWebHooksFilter.from_dict(obj["webHooksFilter"]) if obj.get("webHooksFilter") is not None else None
        })
        return _obj
