...
class IikoTransportPublicApiContractsDeliveriesRequestUpdateOrderChangeServiceTypeDeliveryByCourier(IikoTransportPublicApiContractsDeliveriesRequestUpdateOrderChangeServiceTypeRequest):
    """
    IikoTransportPublicApiContractsDeliveriesRequestUpdateOrderChangeServiceTypeDeliveryByCourier
    """ # noqa: E501
    delivery_point: IikoTransportPublicApiContractsDeliveriesRequestCreateOrderDeliveryPoint = Field(description="Address of delivery.", alias="deliveryPoint")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IikoTransportPublicApiContractsDeliveriesRequestUpdateOrderChangeServiceTypeDeliveryByCourier from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IikoTransportPublicApiContractsDeliveriesRequestUpdateOrderChangeServiceTypeDeliveryByCourier from a dict"""
        if obj is None:
            return None
