...
class OrganizationMarketingCampaignInfo(BaseModel):
    """
    ...
    order_action_condition_bindings: Optional[List[OrganizationMarketingCampaignActionConditionBindingInfo]] = Field(default=None, description="Conditions and actions that will be checked when order is processed.", alias="orderActionConditionBindings")
    periodic_action_condition_bindings: Optional[List[OrganizationMarketingCampaignActionConditionBindingInfo]] = Field(default=None, description="Conditions and actions that will be checked by schedule.", alias="periodicActionConditionBindings")
    overdraft_action_condition_bindings: Optional[List[OrganizationMarketingCampaignActionConditionBindingInfo]] = Field(default=None, description="Conditions and actions that will be checked by overdraft.", alias="overdraftActionConditionBindings")
    guest_registration_action_condition_bindings: Optional[List[OrganizationMarketingCampaignActionConditionBindingInfo]] = Field(default=None, description="Conditions and actions that will be checked by guest registration.", alias="guestRegistrationActionConditionBindings")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "orderActionConditionBindings": [OrganizationMarketingCampaignActionConditionBindingInfo.from_dict(_item) for _item in obj["orderActionConditionBindings"]] if obj.get("orderActionConditionBindings") is not None else None,
            "periodicActionConditionBindings": [OrganizationMarketingCampaignActionConditionBindingInfo.from_dict(_item) for _item in obj["periodicActionConditionBindings"]] if obj.get("periodicActionConditionBindings") is not None else None,
            "overdraftActionConditionBindings": [OrganizationMarketingCampaignActionConditionBindingInfo.from_dict(_item) for _item in obj["overdraftActionConditionBindings"]] if obj.get("overdraftActionConditionBindings") is not None else None,
            "guestRegistrationActionConditionBindings": [OrganizationMarketingCampaignActionConditionBindingInfo.from_dict(_item) for _item in obj["guestRegistrationActionConditionBindings"]] if obj.get("guestRegistrationActionConditionBindings") is not None else None
        })
        return _obj
