...
class IikoTransportPublicApiContractsReservesReserveInWorkload(BaseModel):
    """
    Banquet/reserve.
    """ # noqa: E501
    id: UUID = Field(description="Banquet/reserve ID.")
    table_ids: List[UUID] = Field(description="Reserved tables.", alias="tableIds")
    estimated_start_time: StrictStr = Field(description="Estimated time when reserve will be closed or banquet will be started (Local for the terminal).", alias="estimatedStartTime")
    duration_in_minutes: StrictInt = Field(description="Estimated banquet duration.", alias="durationInMinutes")
    guests_count: StrictInt = Field(description="Number of guests.", alias="guestsCount")
    __properties: ClassVar[List[str]] = ["id", "tableIds", "estimatedStartTime", "durationInMinutes", "guestsCount"]
