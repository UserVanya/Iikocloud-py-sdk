...
class OrganizationsOrganizationSettings(BaseModel):
    """
    ...
    address_format_type: Optional[OrganizationsAddressFormatType] = Field(default=None, description="Address format type.                Available if `AddressFormatType` requested.", alias="addressFormatType")
    ...
    delivery_service_type: Optional[OrganizationsDeliverySettingsServiceType] = Field(default=None, description="Delivery type.                Available if `DeliveryServiceType` requested.", alias="deliveryServiceType")
    delivery_order_payment_settings: Optional[OrganizationsDeliveryOrderPaymentSettings] = Field(default=None, description="Delivery order payment settings.                Available if `DeliveryOrderPaymentSettings` requested.", alias="deliveryOrderPaymentSettings")
    ...
    address_lookup: Optional[List[AddressHintsAddressHintsServiceType]] = Field(default=None, description="Available address lookup services.                Available if `AddressLookup` requested.", alias="addressLookup")
