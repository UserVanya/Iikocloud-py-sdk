...
class IikoTransportPublicApiContractsAddressRegion(BaseModel):
    """
    Delivery district DTO.
    """ # noqa: E501
    id: UUID = Field(description="Region ID in RMS.")
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "externalRevision", "isDeleted"]
