...
class TransportDeliveriesRequestCreateOrderOrder(BaseModel):
    """
    Order.
    """ # noqa: E501
    ...
    order_type_id: Optional[StrictStr] = Field(default=None, description="Order type ID.     Can be obtained by `/deliveries/order_types` operation.    > Only one of the fields must be defined: **orderTypeId** or **orderServiceType**.", alias="orderTypeId")
    ...
    marketing_source_id: Optional[StrictStr] = Field(default=None, description="Marketing source (advertisement) ID.                 Can be obtained by `/marketing_sources` operation.", alias="marketingSourceId")
    ...
    __properties: ClassVar[List[str]] = ["id", "externalNumber", "completeBefore", "phone", "orderTypeId", "orderServiceType", "deliveryPoint", "comment", "customer", "guests", "marketingSourceId", "operatorId", "deliveryDuration", "deliveryZone", "items", "combos", "payments", "tips", "sourceKey", "discountsInfo", "loyaltyInfo", "chequeAdditionalInfo", "externalData"]
