...
class ComboGroupDto3(BaseModel):
    """
    ComboGroupDto3
    """ # noqa: E501
    id: Uuid
    ...
    items: Optional[List[ComboGroupItemDto3]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "items": [ComboGroupItemDto3.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
