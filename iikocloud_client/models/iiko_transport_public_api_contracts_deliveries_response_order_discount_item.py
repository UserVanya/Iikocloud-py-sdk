...
class IikoTransportPublicApiContractsDeliveriesResponseOrderDiscountItem(BaseModel):
    """
    Discount.
    """ # noqa: E501
    discount_type: IikoTransportPublicApiContractsDeliveriesResponseOrderDiscountType = Field(description="Discount type.                 Can be obtained by `/discounts` operation.", alias="discountType")
    ...
    selective_positions_with_sum: Optional[List[IikoTransportPublicApiContractsDeliveriesResponseOrderPositionWithSum]] = Field(default=None, description="Order item positions with position discount sum.   > Allowed from version `8.5.6`.", alias="selectivePositionsWithSum")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "discountType": IikoTransportPublicApiContractsDeliveriesResponseOrderDiscountType.from_dict(obj["discountType"]) if obj.get("discountType") is not None else None,
            "sum": obj.get("sum"),
            "selectivePositions": obj.get("selectivePositions"),
            "selectivePositionsWithSum": [IikoTransportPublicApiContractsDeliveriesResponseOrderPositionWithSum.from_dict(_item) for _item in obj["selectivePositionsWithSum"]] if obj.get("selectivePositionsWithSum") is not None else None
        })
        return _obj
