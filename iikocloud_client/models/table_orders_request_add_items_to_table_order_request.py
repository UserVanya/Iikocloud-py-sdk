...
class TableOrdersRequestAddItemsToTableOrderRequest(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "addOrderItemsSettings": TableOrdersRequestAddTableOrderItemsSettings.from_dict(obj["addOrderItemsSettings"]) if obj.get("addOrderItemsSettings") is not None else None,
