...
class EmployeesActiveCourierLocationsByTerminalGroupRequest(BaseModel):
    """
    ...
    terminal_group_id: UUID = Field(description="iikoFront terminals group ID.                Can be obtained by `/api/1/terminal_groups` operation.", alias="terminalGroupId")
