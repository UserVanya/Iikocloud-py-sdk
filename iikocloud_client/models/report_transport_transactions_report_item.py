...
class ReportTransportTransactionsReportItem(BaseModel):
    """
    ...
    certificate: Optional[ReportTransportTransactionsCertificateReportItem] = Field(default=None, description="Certificate.")
    ...
    counteragent_type: Optional[ReportCertificateCounteragentType] = Field(default=None, description="Counteragent type.", alias="counteragentType")
    ...
    coupon: Optional[ReportTransportTransactionsCouponReportItem] = Field(default=None, description="Coupon.")
    ...
    type: Optional[ReportTransactionType] = Field(default=None, description="Type.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "certificate": ReportTransportTransactionsCertificateReportItem.from_dict(obj["certificate"]) if obj.get("certificate") is not None else None,
            ...
            "coupon": ReportTransportTransactionsCouponReportItem.from_dict(obj["coupon"]) if obj.get("coupon") is not None else None,
