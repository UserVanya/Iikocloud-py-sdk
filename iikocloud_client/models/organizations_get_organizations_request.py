...
class OrganizationsGetOrganizationsRequest(BaseModel):
    """
    Request for organizations.
    """ # noqa: E501
    organization_ids: Optional[List[UUID]] = Field(default=None, description="Organizations IDs which have to be returned. By default - all organizations from apiLogin.                Can be obtained by `/api/1/organizations` operation.", alias="organizationIds")
