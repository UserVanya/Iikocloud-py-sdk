...
class TableOrdersResponseTableOrder(BaseModel):
    """
    Order.
    """ # noqa: E501
    ...
    waiter: Optional[DeliveriesResponseOrderEmployee] = Field(default=None, description="Order waiter.")
    ...
    split_order_between_cash_registers: Optional[TableOrdersResponseSplitOrderBetweenCashRegisters] = Field(default=None, description="Need to split order between cash registers.  <remarks>  Not empty for orders in statuses New or Bill.  </remarks>", alias="splitOrderBetweenCashRegisters")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "customer": DeliveriesResponseOrderRegularCustomer.from_dict(obj["customer"]) if obj.get("customer") is not None else None,
            "phone": obj.get("phone"),
            "status": obj.get("status"),
            "whenCreated": obj.get("whenCreated"),
            "waiter": DeliveriesResponseOrderEmployee.from_dict(obj["waiter"]) if obj.get("waiter") is not None else None,
