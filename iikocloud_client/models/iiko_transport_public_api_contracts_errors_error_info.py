...
class IikoTransportPublicApiContractsErrorsErrorInfo(BaseModel):
    """
    DTO for error details transfer.
    """ # noqa: E501
    code: IikoTransportPublicApiContractsErrorsErrorCode = Field(description="Error code.")
    message: Optional[StrictStr] = Field(default=None, description="Localized message.")
    description: Optional[StrictStr] = Field(default=None, description="Localized message.")
    additional_data: Optional[Any] = Field(default=None, description="Additional information.", alias="additionalData")
    error_reason: Optional[StrictStr] = Field(default=None, description="Error reason.", alias="errorReason")
    __properties: ClassVar[List[str]] = ["code", "message", "description", "additionalData", "errorReason"]
