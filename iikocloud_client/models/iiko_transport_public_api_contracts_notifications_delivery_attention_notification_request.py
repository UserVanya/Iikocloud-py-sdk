...
class IikoTransportPublicApiContractsNotificationsDeliveryAttentionNotificationRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["orderSource", "orderId", "additionalInfo", "organizationId"]
