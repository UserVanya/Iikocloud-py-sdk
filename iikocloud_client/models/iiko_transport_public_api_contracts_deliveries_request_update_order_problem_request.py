...
class IikoTransportPublicApiContractsDeliveriesRequestUpdateOrderProblemRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["organizationId", "orderId", "hasProblem", "problem"]
