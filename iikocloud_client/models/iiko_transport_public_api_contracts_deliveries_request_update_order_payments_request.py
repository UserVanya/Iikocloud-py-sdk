...
class IikoTransportPublicApiContractsDeliveriesRequestUpdateOrderPaymentsRequest(BaseModel):
    """
    ...
    payment_items: Optional[List[IikoTransportPublicApiContractsDeliveriesRequestUpdateOrderOrderPaymentItem]] = Field(default=None, description="Payment details.", alias="paymentItems")
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in payment_items (list)
        _items = []
        if self.payment_items:
            for _item_payment_items in self.payment_items:
                if _item_payment_items:
                    _items.append(_item_payment_items.to_dict())
            _dict['paymentItems'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "paymentItems": [IikoTransportPublicApiContractsDeliveriesRequestUpdateOrderOrderPaymentItem.from_dict(_item) for _item in obj["paymentItems"]] if obj.get("paymentItems") is not None else None
        })
        return _obj
