...
class TransportDeliveriesResponseOrderStreet(BaseModel):
    """
    Street.
    """ # noqa: E501
    id: StrictStr = Field(description="ID.")
    name: StrictStr = Field(description="Name.")
    city: TransportDeliveriesResponseOrderCity = Field(description="City.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "name": obj.get("name"),
            "city": TransportDeliveriesResponseOrderCity.from_dict(obj["city"]) if obj.get("city") is not None else None
        })
        return _obj
