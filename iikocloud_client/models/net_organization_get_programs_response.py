...
class NetOrganizationGetProgramsResponse(BaseModel):
    """
    Get programs response.
    """ # noqa: E501
    programs: Optional[List[NetOrganizationLoyaltyProgram]] = Field(default=None, description="Programs.", alias="Programs")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Programs": [NetOrganizationLoyaltyProgram.from_dict(_item) for _item in obj["Programs"]] if obj.get("Programs") is not None else None
        })
        return _obj
