...
class TransportDeliveriesResponseCheckCreateOrderResponse(BaseModel):
    """
    ...
    error_info: Optional[TransportErrorsErrorInfo] = Field(description="Order check creation error details.", alias="errorInfo")
    __properties: ClassVar[List[str]] = ["correlationId", "errorInfo"]
