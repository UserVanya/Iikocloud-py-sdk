...
class IikoTransportPublicApiContractsDeliveriesRequestCreateOrderCompoundOrderItemComponent(BaseModel):
    """
    Item component
    """ # noqa: E501
    product_id: UUID = Field(description="Item ID.", alias="productId")
