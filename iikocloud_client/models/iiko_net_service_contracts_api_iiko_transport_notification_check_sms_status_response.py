...
class IikoNetServiceContractsApiIikoTransportNotificationCheckSmsStatusResponse(BaseModel):
    """
    Check sms status response.
    """ # noqa: E501
    statuses: List[IikoNetServiceContractsApiIikoTransportNotificationSmsSendingStatusInfo] = Field(description="Information about the status of sending SMS.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "statuses": [IikoNetServiceContractsApiIikoTransportNotificationSmsSendingStatusInfo.from_dict(_item) for _item in obj["statuses"]] if obj.get("statuses") is not None else None
        })
        return _obj
