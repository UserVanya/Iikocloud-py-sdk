...
class IikoNetServiceContractsApiIikoTransportLoyaltyResultLoyaltyProgramResult(BaseModel):
    """
    ...
    discounts: Optional[List[IikoNetServiceContractsApiIikoTransportLoyaltyResultDiscountOperation]] = Field(default=None, description="Discount operations applied to order items.")
    upsales: Optional[List[IikoNetServiceContractsApiIikoTransportLoyaltyResultUpsale]] = Field(default=None, description="Suggested items to add or advices for customer.")
    free_products: Optional[List[IikoNetServiceContractsApiIikoTransportLoyaltyResultFreeProductsGroup]] = Field(default=None, description="Program free products.", alias="freeProducts")
    ...
    available_combos: Optional[List[IikoNetServiceContractsApiIikoTransportLoyaltyResultAvailableCombo]] = Field(default=None, description="Partially added combos, available for assembly.", alias="availableCombos")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "name": obj.get("name"),
            "discounts": [IikoNetServiceContractsApiIikoTransportLoyaltyResultDiscountOperation.from_dict(_item) for _item in obj["discounts"]] if obj.get("discounts") is not None else None,
            "upsales": [IikoNetServiceContractsApiIikoTransportLoyaltyResultUpsale.from_dict(_item) for _item in obj["upsales"]] if obj.get("upsales") is not None else None,
            "freeProducts": [IikoNetServiceContractsApiIikoTransportLoyaltyResultFreeProductsGroup.from_dict(_item) for _item in obj["freeProducts"]] if obj.get("freeProducts") is not None else None,
            "availableComboSpecifications": obj.get("availableComboSpecifications"),
            "availableCombos": [IikoNetServiceContractsApiIikoTransportLoyaltyResultAvailableCombo.from_dict(_item) for _item in obj["availableCombos"]] if obj.get("availableCombos") is not None else None,
