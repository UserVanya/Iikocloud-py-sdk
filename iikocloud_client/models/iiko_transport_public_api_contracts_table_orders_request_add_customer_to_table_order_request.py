...
class IikoTransportPublicApiContractsTableOrdersRequestAddCustomerToTableOrderRequest(BaseModel):
    """
    ...
    customer: IikoTransportPublicApiContractsTableOrdersRequestTableOrderCustomer = Field(description="Guest info.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "customer": IikoTransportPublicApiContractsTableOrdersRequestTableOrderCustomer.from_dict(obj["customer"]) if obj.get("customer") is not None else None
        })
        return _obj
