...
class IikoTransportPublicApiContractsReservesReservesByIdRequest(BaseModel):
    """
    ...
    reserve_ids: List[UUID] = Field(description="IDs of banquets/reserves information on which is required.", alias="reserveIds")
