...
class IikoNetServiceContractsApiIikoTransportReportGetTransactionsReportByPeriodResponse(BaseModel):
    """
    Get transactions report by period response.
    """ # noqa: E501
    transactions: Optional[List[IikoNetServiceContractsApiIikoTransportReportTransportTransactionsReportItem]] = Field(default=None, description="Transactions.")
    page_size: Optional[StrictInt] = Field(default=None, description="Page size.", alias="pageSize")
    page_number: Optional[StrictInt] = Field(default=None, description="Page number. Zero based.", alias="pageNumber")
    __properties: ClassVar[List[str]] = ["transactions", "pageSize", "pageNumber"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "transactions": [IikoNetServiceContractsApiIikoTransportReportTransportTransactionsReportItem.from_dict(_item) for _item in obj["transactions"]] if obj.get("transactions") is not None else None,
