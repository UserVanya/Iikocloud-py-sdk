...
class ComboGroupDto4(BaseModel):
    """
    ComboGroupDto4
    """ # noqa: E501
    id: UUID
    ...
    items: Optional[List[ComboGroupItemDto4]] = None
    skip_step: Optional[StrictBool] = Field(default=False, alias="skipStep")
    __properties: ClassVar[List[str]] = ["id", "name", "isMainGroup", "items", "skipStep"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "items": [ComboGroupItemDto4.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
            "skipStep": obj.get("skipStep") if obj.get("skipStep") is not None else False
        })
        return _obj
