...
class TransportWebHooksReserveUpdateWebHookEventInfo(BaseModel):
    """
    ...
    event_info: Optional[TransportReservesReserveInfo] = Field(default=None, description="Event details.", alias="eventInfo")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "eventInfo": TransportReservesReserveInfo.from_dict(obj["eventInfo"]) if obj.get("eventInfo") is not None else None
        })
        return _obj
