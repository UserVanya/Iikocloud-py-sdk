...
class IikoNetServiceContractsApiIikoTransportLoyaltyResultComboGroup(BaseModel):
    """
    ...
    products: Optional[List[IikoNetServiceContractsApiIikoTransportLoyaltyResultComboProduct]] = Field(default=None, description="Products.")
    __properties: ClassVar[List[str]] = ["id", "name", "isMainGroup", "products"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "products": [IikoNetServiceContractsApiIikoTransportLoyaltyResultComboProduct.from_dict(_item) for _item in obj["products"]] if obj.get("products") is not None else None
        })
        return _obj
