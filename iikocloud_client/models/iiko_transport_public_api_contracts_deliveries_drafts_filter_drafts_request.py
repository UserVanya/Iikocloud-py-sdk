...
class IikoTransportPublicApiContractsDeliveriesDraftsFilterDraftsRequest(BaseModel):
    """
    Request for the list of order drafts by several filters.
    """ # noqa: E501
    organization_ids: List[UUID] = Field(description="Organization ID for which the order drafts search will be performed.                Can be obtained by `/organizations` operation.", alias="organizationIds")
    ...
    sort_property: Optional[IikoTransportPublicApiContractsDeliveriesDraftsOrderDraftSortProperty] = Field(default=None, description="Sorting property.", alias="sortProperty")
