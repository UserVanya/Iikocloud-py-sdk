...
class TransportWebHooksPersonalShiftWebHookEventInfo(BaseModel):
    """
    ...
    event_info: Optional[TransportEmployeesPersonalShift] = Field(default=None, description="Event details.", alias="eventInfo")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "eventInfo": TransportEmployeesPersonalShift.from_dict(obj["eventInfo"]) if obj.get("eventInfo") is not None else None
        })
        return _obj
