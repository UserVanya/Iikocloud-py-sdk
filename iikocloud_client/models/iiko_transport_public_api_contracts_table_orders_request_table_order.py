...
class IikoTransportPublicApiContractsTableOrdersRequestTableOrder(BaseModel):
    """
    ...
    customer: Optional[IikoTransportPublicApiContractsDeliveriesRequestCreateOrderRegularCustomer] = Field(default=None, description="Guest.   > Allowed from version `7.5.2`.")
    ...
    guests: Optional[IikoTransportPublicApiContractsTableOrdersRequestGuestsInfo] = Field(default=None, description="Guests information.   > Allowed from version `7.6.1`.")
    tab_name: Optional[StrictStr] = Field(default=None, description="Tab name (only for fastfood terminals group in tab mode).   > Allowed from version `7.6.1`.", alias="tabName")
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if table_ids (nullable) is None
        # and model_fields_set contains the field
        if self.table_ids is None and "table_ids" in self.model_fields_set:
            _dict['tableIds'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "customer": IikoTransportPublicApiContractsDeliveriesRequestCreateOrderRegularCustomer.from_dict(obj["customer"]) if obj.get("customer") is not None else None,
            "phone": obj.get("phone"),
            "guestCount": obj.get("guestCount"),
            "guests": IikoTransportPublicApiContractsTableOrdersRequestGuestsInfo.from_dict(obj["guests"]) if obj.get("guests") is not None else None,
