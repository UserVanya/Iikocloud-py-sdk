...
class IikoTransportPublicApiContractsReservesSectionSchema(BaseModel):
    """
    Table layout.
    """ # noqa: E501
    width: StrictInt = Field(description="Layout width in px.")
    height: StrictInt = Field(description="Layout height in px.")
    mark_elements: List[IikoTransportPublicApiContractsReservesRestaurantSectionMark] = Field(description="Collection of restaurant section marks.", alias="markElements")
    table_elements: List[IikoTransportPublicApiContractsReservesRestaurantSectionTable] = Field(description="Collection of restaurant section tables.", alias="tableElements")
    rectangle_elements: List[IikoTransportPublicApiContractsReservesRestaurantSectionRectangle] = Field(description="Collection of restaurant section rectangles.", alias="rectangleElements")
    ellipse_elements: List[IikoTransportPublicApiContractsReservesRestaurantSectionEllipse] = Field(description="Collection of restaurant section ellipses.", alias="ellipseElements")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "markElements": [IikoTransportPublicApiContractsReservesRestaurantSectionMark.from_dict(_item) for _item in obj["markElements"]] if obj.get("markElements") is not None else None,
            "tableElements": [IikoTransportPublicApiContractsReservesRestaurantSectionTable.from_dict(_item) for _item in obj["tableElements"]] if obj.get("tableElements") is not None else None,
            "rectangleElements": [IikoTransportPublicApiContractsReservesRestaurantSectionRectangle.from_dict(_item) for _item in obj["rectangleElements"]] if obj.get("rectangleElements") is not None else None,
            "ellipseElements": [IikoTransportPublicApiContractsReservesRestaurantSectionEllipse.from_dict(_item) for _item in obj["ellipseElements"]] if obj.get("ellipseElements") is not None else None,
