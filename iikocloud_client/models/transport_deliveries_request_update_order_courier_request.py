...
class TransportDeliveriesRequestUpdateOrderCourierRequest(BaseModel):
    """
    ...
    employee_id: StrictStr = Field(description="Courier ID.                Can be obtained by `/api/1/employees/couriers` operation.", alias="employeeId")
