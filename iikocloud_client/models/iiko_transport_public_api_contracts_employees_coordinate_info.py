...
class IikoTransportPublicApiContractsEmployeesCoordinateInfo(BaseModel):
    """
    ...
    server_timestamp: StrictInt = Field(description="Time of coordinate saving on server in the Unix timestamp format.", alias="serverTimestamp")
    __properties: ClassVar[List[str]] = ["latitude", "longitude", "serverTimestamp"]
