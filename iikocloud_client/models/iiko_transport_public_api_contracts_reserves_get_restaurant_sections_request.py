...
class IikoTransportPublicApiContractsReservesGetRestaurantSectionsRequest(BaseModel):
    """
    Request for get all restaurant sections of specified terminal groups, for which banquet/reserve booking are available.
    """ # noqa: E501
    terminal_group_ids: List[UUID] = Field(description="Collection of terminal group ID.                Can be obtained by `/terminal_groups` operation.", alias="terminalGroupIds")
