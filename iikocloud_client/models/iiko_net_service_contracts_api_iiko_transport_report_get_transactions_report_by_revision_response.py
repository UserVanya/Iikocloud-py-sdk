...
class IikoNetServiceContractsApiIikoTransportReportGetTransactionsReportByRevisionResponse(BaseModel):
    """
    ...
    last_transaction_id: Optional[UUID] = Field(default=None, description="Last known transaction id.", alias="lastTransactionId")
