...
class IikoTransportPublicApiContractsOrganizationsGetOrganizationsResponse(BaseModel):
    """
    Response to request for organizations.
    """ # noqa: E501
    correlation_id: UUID = Field(description="Operation ID.", alias="correlationId")
    organizations: List[IikoTransportPublicApiContractsOrganizationsOrganizationInfo] = Field(description="List of organizations.                Can be obtained by `/organizations` operation.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "organizations": [IikoTransportPublicApiContractsOrganizationsOrganizationInfo.from_dict(_item) for _item in obj["organizations"]] if obj.get("organizations") is not None else None
        })
        return _obj
