...
class IikoTransportPublicApiContractsAuthGetAccessTokenResponse(BaseModel):
    """
    Response to authentication token request.
    """ # noqa: E501
    correlation_id: UUID = Field(description="Operation ID.", alias="correlationId")
    token: StrictStr = Field(description="Authentication token. The standard token lifetime is 1 hour.")
