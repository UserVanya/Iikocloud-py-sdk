...
class ComboGroupItemSizeDto4(BaseModel):
    """
    ...
    prices: Optional[List[ExternalMenuPriceByDepartmentsDto8]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "prices": [ExternalMenuPriceByDepartmentsDto8.from_dict(_item) for _item in obj["prices"]] if obj.get("prices") is not None else None
        })
        return _obj
