...
class ComboGroupItemSizeDto2(BaseModel):
    """
    ...
    prices: Optional[List[ExternalMenuPriceByDepartmentsDto6]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "prices": [ExternalMenuPriceByDepartmentsDto6.from_dict(_item) for _item in obj["prices"]] if obj.get("prices") is not None else None
        })
        return _obj
