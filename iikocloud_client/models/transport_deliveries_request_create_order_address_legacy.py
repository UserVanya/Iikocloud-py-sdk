...
class TransportDeliveriesRequestCreateOrderAddressLegacy(TransportDeliveriesRequestCreateOrderAddress):
    """
    Order delivery legacy address.
    """ # noqa: E501
    street: TransportDeliveriesRequestCreateOrderStreet = Field(description="Street.  > It's required specify only \"classifierId\" or \"id\" or \"name\" and \"city\".")
    ...
    region_id: Optional[StrictStr] = Field(default=None, description="Delivery area ID.", alias="regionId")
