...
class TransportDeliveriesRequestCreateOrderProductOrderItem(TransportDeliveriesRequestCreateOrderOrderItem):
    """
    Order item: item.
    """ # noqa: E501
    product_id: StrictStr = Field(description="ID of menu item.                Can be obtained by `/api/1/nomenclature` operation.", alias="productId")
