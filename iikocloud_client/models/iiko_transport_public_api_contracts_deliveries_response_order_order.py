...
class IikoTransportPublicApiContractsDeliveriesResponseOrderOrder(BaseModel):
    """
    Order details.
    """ # noqa: E501
    parent_delivery_id: Optional[UUID] = Field(default=None, description="ID of delivery serving as source for splitting by FCRs.", alias="parentDeliveryId")
    customer: Optional[IikoTransportPublicApiContractsDeliveriesResponseOrderCustomer] = Field(default=None, description="Delivery customer.")
    phone: StrictStr = Field(description="Delivery phone number.")
    phone_extension: Optional[StrictStr] = Field(default=None, description="Extension delivery phone number.", alias="phoneExtension")
    delivery_point: Optional[IikoTransportPublicApiContractsDeliveriesResponseOrderDeliveryPoint] = Field(default=None, description="Delivery point details.  <remarks>  Not required if order type is customer pickup. Otherwise, required.  </remarks>", alias="deliveryPoint")
    status: IikoTransportPublicApiContractsDeliveriesCommonDeliveryStatus = Field(description="Delivery status.                > Delivery status `ReadyForCooking` is deprecated from version `9.0.6`.")
    cancel_info: Optional[IikoTransportPublicApiContractsDeliveriesResponseOrderCancelInfo] = Field(default=None, description="Delivery cancellation details.  <remarks>  Required only if delivery is canceled, i.e. status=Canceled.  </remarks>", alias="cancelInfo")
    courier_info: Optional[IikoTransportPublicApiContractsDeliveriesResponseOrderCourierInfo] = Field(default=None, description="Driver information.", alias="courierInfo")
    ...
    problem: Optional[IikoTransportPublicApiContractsDeliveriesResponseOrderProblem] = Field(default=None, description="Problem flag.")
    operator: Optional[IikoTransportPublicApiContractsDeliveriesResponseOrderEmployee] = Field(default=None, description="Operator that took order.")
    marketing_source: Optional[IikoTransportPublicApiContractsDeliveriesResponseOrderMarketingSource] = Field(default=None, description="Marketing source.", alias="marketingSource")
    ...
    moved_from_delivery_id: Optional[UUID] = Field(default=None, description="Tells that this delivery has been moved from terminal group  with id *MovedFromTerminalGroupId* by cancelling delivery with deliveryId *MovedFromDeliveryId*.   > Allowed from version `7.5.4`.", alias="movedFromDeliveryId")
    moved_from_terminal_group_id: Optional[UUID] = Field(default=None, description="Tells that this delivery has been moved from terminal group  with id *MovedFromTerminalGroupId* by cancelling delivery with deliveryId *MovedFromDeliveryId*.   > Allowed from version `7.5.4`.", alias="movedFromTerminalGroupId")
    moved_from_organization_id: Optional[UUID] = Field(default=None, description="Tells that this delivery has been moved from terminal group  with id *MovedFromTerminalGroupId* by cancelling delivery with deliveryId *MovedFromDeliveryId*.   > Allowed from version `7.5.4`.", alias="movedFromOrganizationId")
    external_courier_service: Optional[IikoTransportPublicApiContractsDeliveriesResponseOrderExternalCourierService] = Field(default=None, description="ECS info.   > Allowed from version `7.7.7`.", alias="externalCourierService")
    moved_to_delivery_id: Optional[UUID] = Field(default=None, description="Tells that this delivery has been canceled and moved to terminal group  with id *MovedToTerminalGroupId*.", alias="movedToDeliveryId")
    moved_to_terminal_group_id: Optional[UUID] = Field(default=None, alias="movedToTerminalGroupId")
    moved_to_organization_id: Optional[UUID] = Field(default=None, alias="movedToOrganizationId")
    ...
    locked_at: Optional[StrictStr] = Field(default=None, description="Timestamp of when the order was taken for editing (lock).", alias="lockedAt")
    ...
    tracking_link: Optional[StrictStr] = Field(default=None, description="Order's tracking link.", alias="trackingLink")
    ...
    __properties: ClassVar[List[str]] = ["parentDeliveryId", "customer", "phone", "phoneExtension", "deliveryPoint", "status", "cancelInfo", "courierInfo", "completeBefore", "whenCreated", "whenConfirmed", "whenPrinted", "whenCookingCompleted", "whenSended", "whenDelivered", "comment", "problem", "operator", "marketingSource", "deliveryDuration", "indexInCourierRoute", "cookingStartTime", "isDeleted", "whenReceivedByApi", "whenReceivedFromFront", "movedFromDeliveryId", "movedFromTerminalGroupId", "movedFromOrganizationId", "externalCourierService", "movedToDeliveryId", "movedToTerminalGroupId", "movedToOrganizationId", "menuId", "deliveryZone", "lockedAt", "estimatedTime", "isAsap", "whenPacked", "priceCategory", "trackingLink", "sum", "number", "sourceKey", "whenBillPrinted", "whenClosed", "conception", "guestsInfo", "items", "combos", "payments", "tips", "discounts", "orderType", "terminalGroupId", "processedPaymentsSum", "loyaltyInfo", "externalData"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if tracking_link (nullable) is None
        # and model_fields_set contains the field
        if self.tracking_link is None and "tracking_link" in self.model_fields_set:
            _dict['trackingLink'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "customer": IikoTransportPublicApiContractsDeliveriesResponseOrderCustomer.from_dict(obj["customer"]) if obj.get("customer") is not None else None,
            "phone": obj.get("phone"),
            "phoneExtension": obj.get("phoneExtension"),
            "deliveryPoint": IikoTransportPublicApiContractsDeliveriesResponseOrderDeliveryPoint.from_dict(obj["deliveryPoint"]) if obj.get("deliveryPoint") is not None else None,
            "status": obj.get("status"),
            "cancelInfo": IikoTransportPublicApiContractsDeliveriesResponseOrderCancelInfo.from_dict(obj["cancelInfo"]) if obj.get("cancelInfo") is not None else None,
            "courierInfo": IikoTransportPublicApiContractsDeliveriesResponseOrderCourierInfo.from_dict(obj["courierInfo"]) if obj.get("courierInfo") is not None else None,
            ...
            "problem": IikoTransportPublicApiContractsDeliveriesResponseOrderProblem.from_dict(obj["problem"]) if obj.get("problem") is not None else None,
            "operator": IikoTransportPublicApiContractsDeliveriesResponseOrderEmployee.from_dict(obj["operator"]) if obj.get("operator") is not None else None,
            "marketingSource": IikoTransportPublicApiContractsDeliveriesResponseOrderMarketingSource.from_dict(obj["marketingSource"]) if obj.get("marketingSource") is not None else None,
            ...
            "externalCourierService": IikoTransportPublicApiContractsDeliveriesResponseOrderExternalCourierService.from_dict(obj["externalCourierService"]) if obj.get("externalCourierService") is not None else None,
