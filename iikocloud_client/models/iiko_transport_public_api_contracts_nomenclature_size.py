...
class IikoTransportPublicApiContractsNomenclatureSize(BaseModel):
    """
    Item size.
    """ # noqa: E501
    id: Optional[UUID] = Field(default=None, description="ID.")
    name: Optional[StrictStr] = Field(default=None, description="Name.")
    priority: Optional[StrictInt] = Field(default=None, description="Priority (serial number) of the size in the size scale.")
    is_default: Optional[StrictBool] = Field(default=None, description="Is the default size in the size scale.", alias="isDefault")
    __properties: ClassVar[List[str]] = ["id", "name", "priority", "isDefault"]
