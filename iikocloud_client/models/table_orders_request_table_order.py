...
class TableOrdersRequestTableOrder(BaseModel):
    """
    ...
    guests: Optional[TableOrdersRequestGuestsInfo] = Field(default=None, description="Guests information.   > Allowed from version `7.6.1`.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "guests": TableOrdersRequestGuestsInfo.from_dict(obj["guests"]) if obj.get("guests") is not None else None,
