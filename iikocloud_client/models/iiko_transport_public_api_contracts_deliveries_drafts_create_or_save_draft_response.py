...
class IikoTransportPublicApiContractsDeliveriesDraftsCreateOrSaveDraftResponse(BaseModel):
    """
    ...
    order_id: UUID = Field(description="Order draft order ID.", alias="orderId")
    __properties: ClassVar[List[str]] = ["correlationId", "orderId"]
