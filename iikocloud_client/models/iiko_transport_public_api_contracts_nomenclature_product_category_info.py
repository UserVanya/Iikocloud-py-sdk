...
class IikoTransportPublicApiContractsNomenclatureProductCategoryInfo(BaseModel):
    """
    DTO for outside transferring of product category details.
    """ # noqa: E501
    id: UUID = Field(description="Product category ID.")
    name: StrictStr = Field(description="Name.")
    is_deleted: StrictBool = Field(description="Is deleted attribute.", alias="isDeleted")
    __properties: ClassVar[List[str]] = ["id", "name", "isDeleted"]
