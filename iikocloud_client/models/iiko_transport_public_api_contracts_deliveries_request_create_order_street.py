...
class IikoTransportPublicApiContractsDeliveriesRequestCreateOrderStreet(BaseModel):
    """
    Street.
    """ # noqa: E501
    ...
    id: Optional[UUID] = Field(default=None, description="ID.                 Can be obtained by `/streets/by_city` operation.")
