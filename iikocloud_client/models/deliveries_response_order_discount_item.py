...
class DeliveriesResponseOrderDiscountItem(BaseModel):
    """
    Discount.
    """ # noqa: E501
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "discountType": DeliveriesResponseOrderDiscountType.from_dict(obj["discountType"]) if obj.get("discountType") is not None else None,
            "sum": obj.get("sum"),
            "selectivePositions": obj.get("selectivePositions"),
            "selectivePositionsWithSum": [DeliveriesResponseOrderPositionWithSum.from_dict(_item) for _item in obj["selectivePositionsWithSum"]] if obj.get("selectivePositionsWithSum") is not None else None
        })
        return _obj
