...
class IikoTransportPublicApiContractsWebHooksGetWebHookSettingsResponse(BaseModel):
    """
    ...
    api_login_name: Optional[StrictStr] = Field(description="Api login name.", alias="apiLoginName")
    web_hooks_uri: Optional[StrictStr] = Field(description="Webhook handler url.", alias="webHooksUri")
    ...
    web_hooks_filter: Optional[IikoTransportPublicApiContractsIntegrationWebHooksFiltersWebHooksFilter] = Field(default=None, description="Webhooks filter.", alias="webHooksFilter")
    __properties: ClassVar[List[str]] = ["correlationId", "apiLoginName", "webHooksUri", "authToken", "webHooksFilter"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if api_login_name (nullable) is None
        # and model_fields_set contains the field
        if self.api_login_name is None and "api_login_name" in self.model_fields_set:
            _dict['apiLoginName'] = None

        # set to None if web_hooks_uri (nullable) is None
        # and model_fields_set contains the field
        if self.web_hooks_uri is None and "web_hooks_uri" in self.model_fields_set:
            _dict['webHooksUri'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "apiLoginName": obj.get("apiLoginName"),
            "webHooksUri": obj.get("webHooksUri"),
            "authToken": obj.get("authToken"),
            "webHooksFilter": IikoTransportPublicApiContractsIntegrationWebHooksFiltersWebHooksFilter.from_dict(obj["webHooksFilter"]) if obj.get("webHooksFilter") is not None else None
        })
        return _obj
