...
class TransportDeliveriesResponseOrderExternalCourierService(BaseModel):
    """
    ECS info (external courier service).
    """ # noqa: E501
    id: StrictStr = Field(description="ECS setting record id. Unique through all organizations.")
