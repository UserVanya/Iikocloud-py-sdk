...
class IikoTransportPublicApiContractsTipsTypesTipsType(BaseModel):
    """
    Tips type.
    """ # noqa: E501
    ...
    order_service_types: List[IikoTransportPublicApiContractsOrderTypesOrderServiceType] = Field(description="Supported order service types.", alias="orderServiceTypes")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "orderServiceTypes": obj.get("orderServiceTypes"),
            "paymentTypesIds": obj.get("paymentTypesIds")
        })
        return _obj
