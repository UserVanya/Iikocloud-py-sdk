...
class IikoTransportPublicApiContractsTableOrdersRequestTableOrderCustomer(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "surname", "comment", "birthdate", "email", "shouldReceiveOrderStatusNotifications", "gender", "phone"]
