...
class DeliveriesCommonPaymentAdditionalData(BaseModel):
    """
    ...
    def from_dict(cls, obj: Dict[str, Any]) -> Optional[Union[DeliveriesCommonCardPaymentAdditionalData, DeliveriesCommonExternalPaymentAdditionalData, DeliveriesCommonLoyaltyCardPaymentAdditionalData]]:
        ...
        if object_type ==  'DeliveriesCommonExternalPaymentAdditionalData':
            return import_module("iikocloud_client.models.deliveries_common_external_payment_additional_data").DeliveriesCommonExternalPaymentAdditionalData.from_dict(obj)
        if object_type ==  'DeliveriesCommonLoyaltyCardPaymentAdditionalData':
            return import_module("iikocloud_client.models.deliveries_common_loyalty_card_payment_additional_data").DeliveriesCommonLoyaltyCardPaymentAdditionalData.from_dict(obj)

        raise ValueError("DeliveriesCommonPaymentAdditionalData failed to lookup discriminator value from " +
