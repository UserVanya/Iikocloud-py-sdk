...
class IikoTransportPublicApiContractsEmployeesActiveCourierLocationsByTerminalGroupRequest(BaseModel):
    """
    ...
    terminal_group_id: UUID = Field(description="iikoFront terminals group ID.                Can be obtained by `/terminal_groups` operation.", alias="terminalGroupId")
