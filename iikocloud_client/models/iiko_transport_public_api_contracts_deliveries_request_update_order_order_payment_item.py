...
class IikoTransportPublicApiContractsDeliveriesRequestUpdateOrderOrderPaymentItem(BaseModel):
    """
    Payments details.
    """ # noqa: E501
    sum: Union[StrictFloat, StrictInt] = Field(description="Amount due")
    payment_type_id: UUID = Field(description="Payment type ID.", alias="paymentTypeId")
    ...
    __properties: ClassVar[List[str]] = ["sum", "paymentTypeId", "isProcessedExternally"]
