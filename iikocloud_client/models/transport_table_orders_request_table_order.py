...
class TransportTableOrdersRequestTableOrder(BaseModel):
    ...
    table_ids: Optional[List[StrictStr]] = Field(default=None, description="Table IDs.                Can be obtained by `/reserve/available_restaurant_sections` operation.", alias="tableIds")
