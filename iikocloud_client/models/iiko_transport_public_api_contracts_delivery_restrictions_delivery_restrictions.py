...
class IikoTransportPublicApiContractsDeliveryRestrictionsDeliveryRestrictions(BaseModel):
    """
    ...
    delivery_geocode_service_type: IikoTransportPublicApiContractsDeliveryRestrictionsDeliveryGeocodeServiceType = Field(description="Geocoding service type.", alias="deliveryGeocodeServiceType")
    ...
    restrictions: List[IikoTransportPublicApiContractsDeliveryRestrictionsDeliveryRestrictionItem] = Field(description="Restrictions.")
    delivery_zones: List[IikoTransportPublicApiContractsDeliveryRestrictionsDeliveryZone] = Field(description="Delivery zones.", alias="deliveryZones")
    ...
    zones_mode: IikoTransportPublicApiContractsDeliveryRestrictionsDeliveryRestrictionsMode = Field(description="Delivery restrictions mode.", alias="zonesMode")
    ...
    action_on_validation_rejection: IikoTransportPublicApiContractsDeliveryRestrictionsActionOnValidationRejection = Field(description="Action on problems with auto-assignment.", alias="actionOnValidationRejection")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "restrictions": [IikoTransportPublicApiContractsDeliveryRestrictionsDeliveryRestrictionItem.from_dict(_item) for _item in obj["restrictions"]] if obj.get("restrictions") is not None else None,
            "deliveryZones": [IikoTransportPublicApiContractsDeliveryRestrictionsDeliveryZone.from_dict(_item) for _item in obj["deliveryZones"]] if obj.get("deliveryZones") is not None else None,
