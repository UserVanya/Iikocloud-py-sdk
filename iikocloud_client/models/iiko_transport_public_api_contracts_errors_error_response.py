...
class IikoTransportPublicApiContractsErrorsErrorResponse(BaseModel):
    """
    Error response.
    """ # noqa: E501
    correlation_id: UUID = Field(description="Operation ID.", alias="correlationId")
    error_description: StrictStr = Field(description="Error text.", alias="errorDescription")
    error: Optional[StrictStr] = Field(default=None, description="Error code.")
    __properties: ClassVar[List[str]] = ["correlationId", "errorDescription", "error"]
