...
class IikoTransportPublicApiContractsNomenclatureSizePrice(BaseModel):
    """
    Price per item size.
    """ # noqa: E501
    size_id: Optional[UUID] = Field(description="Item size ID.", alias="sizeId")
    price: IikoTransportPublicApiContractsNomenclaturePrice = Field(description="Price per this item size.")
    __properties: ClassVar[List[str]] = ["sizeId", "price"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "price": IikoTransportPublicApiContractsNomenclaturePrice.from_dict(obj["price"]) if obj.get("price") is not None else None
        })
        return _obj
