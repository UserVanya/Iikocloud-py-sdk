...
class IikoTransportPublicApiContractsOrganizationsExtendedOrganizationInfo(IikoTransportPublicApiContractsOrganizationsOrganizationInfo):
    """
    ...
    delivery_service_type: Optional[IikoTransportPublicApiContractsOrganizationsDeliverySettingsServiceType] = Field(description="Delivery type.", alias="deliveryServiceType")
    delivery_order_payment_settings: Optional[IikoTransportPublicApiContractsOrganizationsDeliveryOrderPaymentSettings] = Field(default=None, description="Delivery order payment settings.", alias="deliveryOrderPaymentSettings")
    ...
    address_format_type: IikoTransportPublicApiContractsOrganizationsAddressFormatType = Field(description="Address format type.", alias="addressFormatType")
    ...
    address_lookup: List[IikoTransportPublicApiContractsAddressHintsAddressHintsServiceType] = Field(description="Available address lookup services.", alias="addressLookup")
