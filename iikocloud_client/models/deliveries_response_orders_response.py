...
class DeliveriesResponseOrdersResponse(BaseModel):
    """
    Wrapping object (external) for return of delivery orders.
    """ # noqa: E501
    correlation_id: UUID = Field(alias="correlationId")
    orders: List[DeliveriesResponseOrderOrderInfo] = Field(description="Orders.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "orders": [DeliveriesResponseOrderOrderInfo.from_dict(_item) for _item in obj["orders"]] if obj.get("orders") is not None else None
        })
        return _obj
