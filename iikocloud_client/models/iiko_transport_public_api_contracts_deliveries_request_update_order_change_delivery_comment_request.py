...
class IikoTransportPublicApiContractsDeliveriesRequestUpdateOrderChangeDeliveryCommentRequest(BaseModel):
    """
    ...
    comment: StrictStr = Field(description="New delivery comment.")
    __properties: ClassVar[List[str]] = ["organizationId", "orderId", "comment"]
