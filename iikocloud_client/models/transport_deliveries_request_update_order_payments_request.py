...
class TransportDeliveriesRequestUpdateOrderPaymentsRequest(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "paymentItems": [TransportDeliveriesRequestUpdateOrderOrderPaymentItem.from_dict(_item) for _item in obj["paymentItems"]] if obj.get("paymentItems") is not None else None
        })
        return _obj
