...
class TransportDeliveriesRequestCreateOrderTipsPayment(BaseModel):
    ...
    def from_dict(cls, obj: Dict[str, Any]) -> Optional[Union[TransportDeliveriesRequestCreateOrderCardTipsPayment, TransportDeliveriesRequestCreateOrderCashTipsPayment, TransportDeliveriesRequestCreateOrderExternalTipsPayment]]:
        ...
        if object_type ==  'TransportDeliveriesRequestCreateOrderCardTipsPayment':
            return import_module("iikocloud_client.models.transport_deliveries_request_create_order_card_tips_payment").TransportDeliveriesRequestCreateOrderCardTipsPayment.from_dict(obj)
        if object_type ==  'TransportDeliveriesRequestCreateOrderCashTipsPayment':
            return import_module("iikocloud_client.models.transport_deliveries_request_create_order_cash_tips_payment").TransportDeliveriesRequestCreateOrderCashTipsPayment.from_dict(obj)
        if object_type ==  'TransportDeliveriesRequestCreateOrderExternalTipsPayment':
            return import_module("iikocloud_client.models.transport_deliveries_request_create_order_external_tips_payment").TransportDeliveriesRequestCreateOrderExternalTipsPayment.from_dict(obj)
