...
class ExternalMenuItemSize(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["sku", "sizeCode", "sizeName", "isDefault", "portionWeightGrams", "itemModifierGroups", "sizeId", "nutritionPerHundredGrams", "prices", "nutritions", "isHidden", "measureUnitType", "buttonImageUrl"]
