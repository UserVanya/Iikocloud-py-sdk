...
class IikoTransportPublicApiContractsDeliveriesRequestOrdersByDeliveryDateAndStatusRequest(BaseModel):
    """
    ...
    courier_ids: Optional[List[UUID]] = Field(default=None, description="List of driver IDs.", alias="courierIds")
    __properties: ClassVar[List[str]] = ["organizationIds", "deliveryDateFrom", "deliveryDateTo", "statuses", "sourceKeys", "courierIds"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if courier_ids (nullable) is None
        # and model_fields_set contains the field
        if self.courier_ids is None and "courier_ids" in self.model_fields_set:
            _dict['courierIds'] = None
