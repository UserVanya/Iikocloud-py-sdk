...
class IikoTransportPublicApiContractsTableOrdersResponseTableOrdersResponse(BaseModel):
    """
    Wrapping object (external) for return of orders.
    """ # noqa: E501
    correlation_id: UUID = Field(description="Operation ID.", alias="correlationId")
    orders: List[IikoTransportPublicApiContractsTableOrdersResponseTableOrderInfo] = Field(description="Orders.")
    __properties: ClassVar[List[str]] = ["correlationId", "orders"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "orders": [IikoTransportPublicApiContractsTableOrdersResponseTableOrderInfo.from_dict(_item) for _item in obj["orders"]] if obj.get("orders") is not None else None
        })
        return _obj
