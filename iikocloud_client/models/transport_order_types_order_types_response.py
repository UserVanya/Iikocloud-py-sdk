...
class TransportOrderTypesOrderTypesResponse(BaseModel):
    """
    ...
    order_types: List[TransportCommonRmsItemsResponseWrapperOrderType] = Field(description="List of order types.", alias="orderTypes")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "orderTypes": [TransportCommonRmsItemsResponseWrapperOrderType.from_dict(_item) for _item in obj["orderTypes"]] if obj.get("orderTypes") is not None else None
        })
        return _obj
