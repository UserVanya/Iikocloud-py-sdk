...
class TransportDeliveriesRequestOrdersByDeliveryDateAndStatusRequest(BaseModel):
    """
    ...
    courier_ids: Optional[List[StrictStr]] = Field(default=None, description="List of driver IDs.", alias="courierIds")
