...
class IikoTransportPublicApiContractsDeliveriesRequestUpdateOrderChangePaymentsRequest(BaseModel):
    """
    ...
    payments: List[IikoTransportPublicApiContractsDeliveriesRequestCreateOrderPayment] = Field(description="Order payments.")
    tips: Optional[List[IikoTransportPublicApiContractsDeliveriesRequestCreateOrderTipsPayment]] = Field(default=None, description="Order tips.")
    __properties: ClassVar[List[str]] = ["organizationId", "orderId", "payments", "tips"]
