...
class IikoTransportPublicApiContractsMetricsCallCenterTelemetry(BaseModel):
    """
    Cloud Call Center actions metrics information.
    """ # noqa: E501
    employee_id: UUID = Field(description="Cloud Call Center operator id.", alias="employeeId")
    actions: List[IikoTransportPublicApiContractsMetricsCallCenterAction]
    __properties: ClassVar[List[str]] = ["employeeId", "actions"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "actions": [IikoTransportPublicApiContractsMetricsCallCenterAction.from_dict(_item) for _item in obj["actions"]] if obj.get("actions") is not None else None
        })
        return _obj
