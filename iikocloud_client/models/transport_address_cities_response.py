...
class TransportAddressCitiesResponse(BaseModel):
    """
    Service response with list of cities.
    """ # noqa: E501
    correlation_id: StrictStr = Field(description="Operation ID.", alias="correlationId")
    cities: List[TransportCommonRmsItemsResponseWrapperCity] = Field(description="List of cities.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "cities": [TransportCommonRmsItemsResponseWrapperCity.from_dict(_item) for _item in obj["cities"]] if obj.get("cities") is not None else None
        })
        return _obj
