...
class IikoTransportPublicApiContractsOrganizationsGetOrganizationsRequest(BaseModel):
    """
    Request for organizations.
    """ # noqa: E501
    organization_ids: Optional[List[UUID]] = Field(default=None, description="Organizations IDs which have to be returned. By default - all organizations from apiLogin.                Can be obtained by `/organizations` operation.", alias="organizationIds")
    ...
    __properties: ClassVar[List[str]] = ["organizationIds", "returnAdditionalInfo", "includeDisabled", "returnExternalData"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "returnAdditionalInfo": obj.get("returnAdditionalInfo"),
