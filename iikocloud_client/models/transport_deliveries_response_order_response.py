...
class TransportDeliveriesResponseOrderResponse(BaseModel):
    """
    ...
    order_info: TransportDeliveriesResponseOrderOrderInfo = Field(description="Delivery order.", alias="orderInfo")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "orderInfo": TransportDeliveriesResponseOrderOrderInfo.from_dict(obj["orderInfo"]) if obj.get("orderInfo") is not None else None
        })
        return _obj
