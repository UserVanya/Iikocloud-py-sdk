...
class IikoTransportPublicApiContractsDeliveriesRequestCreateOrderPayment(BaseModel):
    """
    ...
    def from_dict(cls, obj: Dict[str, Any]) -> Optional[Union[IikoTransportPublicApiContractsDeliveriesRequestCreateOrderCardPayment, IikoTransportPublicApiContractsDeliveriesRequestCreateOrderCashPayment, IikoTransportPublicApiContractsDeliveriesRequestCreateOrderExternalPayment, IikoTransportPublicApiContractsDeliveriesRequestCreateOrderLoyaltyCardPayment]]:
        ...
        if object_type ==  'IikoTransportPublicApiContractsDeliveriesRequestCreateOrderCardPayment':
            return import_module("iikocloud_client.models.iiko_transport_public_api_contracts_deliveries_request_create_order_card_payment").IikoTransportPublicApiContractsDeliveriesRequestCreateOrderCardPayment.from_dict(obj)
        if object_type ==  'IikoTransportPublicApiContractsDeliveriesRequestCreateOrderCashPayment':
            return import_module("iikocloud_client.models.iiko_transport_public_api_contracts_deliveries_request_create_order_cash_payment").IikoTransportPublicApiContractsDeliveriesRequestCreateOrderCashPayment.from_dict(obj)
        if object_type ==  'IikoTransportPublicApiContractsDeliveriesRequestCreateOrderExternalPayment':
            return import_module("iikocloud_client.models.iiko_transport_public_api_contracts_deliveries_request_create_order_external_payment").IikoTransportPublicApiContractsDeliveriesRequestCreateOrderExternalPayment.from_dict(obj)
        if object_type ==  'IikoTransportPublicApiContractsDeliveriesRequestCreateOrderLoyaltyCardPayment':
            return import_module("iikocloud_client.models.iiko_transport_public_api_contracts_deliveries_request_create_order_loyalty_card_payment").IikoTransportPublicApiContractsDeliveriesRequestCreateOrderLoyaltyCardPayment.from_dict(obj)

        raise ValueError("IikoTransportPublicApiContractsDeliveriesRequestCreateOrderPayment failed to lookup discriminator value from " +
