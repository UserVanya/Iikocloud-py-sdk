...
class DiscountsDiscountsResponse(BaseModel):
    """
    Response with list of discounts/surcharges.
    """ # noqa: E501
    correlation_id: UUID = Field(description="Operation ID.", alias="correlationId")
    discounts: List[WrapperDiscountsDiscountCardTypeInfo] = Field(description="List of discounts/surcharges.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "discounts": [WrapperDiscountsDiscountCardTypeInfo.from_dict(_item) for _item in obj["discounts"]] if obj.get("discounts") is not None else None
        })
        return _obj
