...
class IikoTransportPublicApiContractsDeliveryRestrictionsAllowedRestrictionsGetAllowedRestrictionsRequest(BaseModel):
    """
    ...
    delivery_address: Optional[IikoTransportPublicApiContractsDeliveryRestrictionsAllowedRestrictionsRestrictionsAddress] = Field(default=None, description="Delivery address.", alias="deliveryAddress")
    order_location: Optional[IikoTransportPublicApiContractsDeliveryRestrictionsAllowedRestrictionsOrderLocation] = Field(default=None, description="Order location.", alias="orderLocation")
    order_items: Optional[List[IikoTransportPublicApiContractsDeliveryRestrictionsAllowedRestrictionsRestrictionsOrderItem]] = Field(default=None, description="Order list.", alias="orderItems")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "deliveryAddress": IikoTransportPublicApiContractsDeliveryRestrictionsAllowedRestrictionsRestrictionsAddress.from_dict(obj["deliveryAddress"]) if obj.get("deliveryAddress") is not None else None,
            "orderLocation": IikoTransportPublicApiContractsDeliveryRestrictionsAllowedRestrictionsOrderLocation.from_dict(obj["orderLocation"]) if obj.get("orderLocation") is not None else None,
            "orderItems": [IikoTransportPublicApiContractsDeliveryRestrictionsAllowedRestrictionsRestrictionsOrderItem.from_dict(_item) for _item in obj["orderItems"]] if obj.get("orderItems") is not None else None,
