...
class IikoTransportPublicApiContractsDeliveriesResponseOrderCompoundOrderItem(IikoTransportPublicApiContractsDeliveriesResponseOrderOrderItem):
    """
    IikoTransportPublicApiContractsDeliveriesResponseOrderCompoundOrderItem
    """ # noqa: E501
    primary_component: IikoTransportPublicApiContractsDeliveriesResponseOrderCompoundOrderItemComponent = Field(description="Main component.", alias="primaryComponent")
    secondary_component: Optional[IikoTransportPublicApiContractsDeliveriesResponseOrderCompoundOrderItemComponent] = Field(default=None, description="Additional component.", alias="secondaryComponent")
    common_modifiers: Optional[List[IikoTransportPublicApiContractsDeliveriesResponseOrderOrderItemModifier]] = Field(default=None, description="Indivisible modifiers.", alias="commonModifiers")
    template: Optional[IikoTransportPublicApiContractsDeliveriesResponseOrderCompoundItemTemplate] = Field(default=None, description="Modifier scheme.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "primaryComponent": IikoTransportPublicApiContractsDeliveriesResponseOrderCompoundOrderItemComponent.from_dict(obj["primaryComponent"]) if obj.get("primaryComponent") is not None else None,
            "secondaryComponent": IikoTransportPublicApiContractsDeliveriesResponseOrderCompoundOrderItemComponent.from_dict(obj["secondaryComponent"]) if obj.get("secondaryComponent") is not None else None,
            "commonModifiers": [IikoTransportPublicApiContractsDeliveriesResponseOrderOrderItemModifier.from_dict(_item) for _item in obj["commonModifiers"]] if obj.get("commonModifiers") is not None else None,
            "template": IikoTransportPublicApiContractsDeliveriesResponseOrderCompoundItemTemplate.from_dict(obj["template"]) if obj.get("template") is not None else None
        })
        return _obj
