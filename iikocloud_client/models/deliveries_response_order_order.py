...
class DeliveriesResponseOrderOrder(BaseModel):
    """
    Order details.
    """ # noqa: E501
    ...
    customer: Optional[DeliveriesResponseOrderCustomer] = Field(default=None, description="Delivery customer.")
    ...
    delivery_point: Optional[DeliveriesResponseOrderDeliveryPoint] = Field(default=None, description="Delivery point details.  <remarks>  Not required if order type is customer pickup. Otherwise, required.  </remarks>", alias="deliveryPoint")
    status: DeliveriesCommonDeliveryStatus = Field(description="Delivery status.                > Delivery status `ReadyForCooking` is deprecated from version `9.0.6`.")
    cancel_info: Optional[DeliveriesResponseOrderCancelInfo] = Field(default=None, description="Delivery cancellation details.  <remarks>  Required only if delivery is canceled, i.e. status=Canceled.  </remarks>", alias="cancelInfo")
    courier_info: Optional[DeliveriesResponseOrderCourierInfo] = Field(default=None, description="Driver information.", alias="courierInfo")
    ...
    problem: Optional[DeliveriesResponseOrderProblem] = Field(default=None, description="Problem flag.")
    operator: Optional[DeliveriesResponseOrderEmployee] = Field(default=None, description="Operator that took order.")
    marketing_source: Optional[DeliveriesResponseOrderMarketingSource] = Field(default=None, description="Marketing source.", alias="marketingSource")
    ...
    external_courier_service: Optional[DeliveriesResponseOrderExternalCourierService] = Field(default=None, description="ECS info.   > Allowed from version `7.7.7`.", alias="externalCourierService")
    ...
    price_category: Optional[CommonPriceCategory] = Field(default=None, description="Price category of the order.   > Allowed from version `9.0.5`.", alias="priceCategory")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "customer": DeliveriesResponseOrderCustomer.from_dict(obj["customer"]) if obj.get("customer") is not None else None,
            "phone": obj.get("phone"),
            "phoneExtension": obj.get("phoneExtension"),
            "deliveryPoint": DeliveriesResponseOrderDeliveryPoint.from_dict(obj["deliveryPoint"]) if obj.get("deliveryPoint") is not None else None,
            "status": obj.get("status"),
            "cancelInfo": DeliveriesResponseOrderCancelInfo.from_dict(obj["cancelInfo"]) if obj.get("cancelInfo") is not None else None,
            "courierInfo": DeliveriesResponseOrderCourierInfo.from_dict(obj["courierInfo"]) if obj.get("courierInfo") is not None else None,
            ...
            "problem": DeliveriesResponseOrderProblem.from_dict(obj["problem"]) if obj.get("problem") is not None else None,
            "operator": DeliveriesResponseOrderEmployee.from_dict(obj["operator"]) if obj.get("operator") is not None else None,
            "marketingSource": DeliveriesResponseOrderMarketingSource.from_dict(obj["marketingSource"]) if obj.get("marketingSource") is not None else None,
            ...
            "externalCourierService": DeliveriesResponseOrderExternalCourierService.from_dict(obj["externalCourierService"]) if obj.get("externalCourierService") is not None else None,
            ...
            "priceCategory": CommonPriceCategory.from_dict(obj["priceCategory"]) if obj.get("priceCategory") is not None else None,
