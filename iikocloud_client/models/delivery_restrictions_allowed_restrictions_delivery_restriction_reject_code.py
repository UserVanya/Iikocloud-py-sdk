...
class DeliveryRestrictionsAllowedRestrictionsDeliveryRestrictionRejectCode(str, Enum):
    """
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of DeliveryRestrictionsAllowedRestrictionsDeliveryRestrictionRejectCode from a JSON string"""
