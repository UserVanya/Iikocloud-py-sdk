...
class IikoTransportPublicApiContractsTerminalsTerminalGroup(BaseModel):
    """
    ...
    external_data: Optional[List[IikoTransportPublicApiContractsCommonExternalData]] = Field(default=None, description="Terminal group external data.", alias="externalData")
    __properties: ClassVar[List[str]] = ["id", "organizationId", "name", "address", "timeZone", "externalData"]
