...
class TerminalsTerminalGroupsResponse(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "terminalGroups": [WrapperTerminalsTerminalGroup.from_dict(_item) for _item in obj["terminalGroups"]] if obj.get("terminalGroups") is not None else None,
            "terminalGroupsInSleep": [WrapperTerminalsTerminalGroup.from_dict(_item) for _item in obj["terminalGroupsInSleep"]] if obj.get("terminalGroupsInSleep") is not None else None
        })
        return _obj
