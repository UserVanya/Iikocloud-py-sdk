...
class IikoTransportPublicApiContractsDiscountsProductCategoryDiscount(BaseModel):
    """
    Product category discount details.
    """ # noqa: E501
    category_id: UUID = Field(description="Category ID.", alias="categoryId")
    category_name: Optional[StrictStr] = Field(description="Category name.", alias="categoryName")
    percent: Union[StrictFloat, StrictInt] = Field(description="This category discount %.")
    __properties: ClassVar[List[str]] = ["categoryId", "categoryName", "percent"]
