...
class LoyaltyResultCalculateCheckinResponse(BaseModel):
    """
    Loyalty result for order.
    """ # noqa: E501
    loyalty_program_results: Optional[List[LoyaltyResultLoyaltyProgramResult]] = Field(default=None, description="Loyalty program results.", alias="loyaltyProgramResults")
    available_payments: Optional[List[LoyaltyResultAvailablePayment]] = Field(default=None, description="Marketing campaigns with available payments.", alias="availablePayments")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "loyaltyProgramResults": [LoyaltyResultLoyaltyProgramResult.from_dict(_item) for _item in obj["loyaltyProgramResults"]] if obj.get("loyaltyProgramResults") is not None else None,
            "availablePayments": [LoyaltyResultAvailablePayment.from_dict(_item) for _item in obj["availablePayments"]] if obj.get("availablePayments") is not None else None,
