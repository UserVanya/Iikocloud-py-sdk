...
class IikoTransportPublicApiContractsDeliveriesRequestCreateOrderAddressLegacy(IikoTransportPublicApiContractsDeliveriesRequestCreateOrderAddress):
    """
    IikoTransportPublicApiContractsDeliveriesRequestCreateOrderAddressLegacy
    """ # noqa: E501
    street: IikoTransportPublicApiContractsDeliveriesRequestCreateOrderStreet = Field(description="Street.  > It's required specify only \"classifierId\" or \"id\" or \"name\" and \"city\".")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "street": IikoTransportPublicApiContractsDeliveriesRequestCreateOrderStreet.from_dict(obj["street"]) if obj.get("street") is not None else None,
            "index": obj.get("index"),
            "house": obj.get("house"),
