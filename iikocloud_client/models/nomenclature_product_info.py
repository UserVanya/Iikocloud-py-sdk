...
class NomenclatureProductInfo(BaseModel):
    """
    ...
    order_item_type: Optional[NomenclatureOrderItemType] = Field(default=None, description="Product or compound. Depends on modifiers scheme existence.", alias="orderItemType")
    ...
    size_prices: Optional[List[NomenclatureSizePrice]] = Field(default=None, description="Prices.", alias="sizePrices")
    modifiers: Optional[List[NomenclatureSimpleModifierInfo]] = Field(default=None, description="Modifiers.")
    group_modifiers: Optional[List[NomenclatureGroupModifierInfo]] = Field(default=None, description="Modifier groups.", alias="groupModifiers")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "sizePrices": [NomenclatureSizePrice.from_dict(_item) for _item in obj["sizePrices"]] if obj.get("sizePrices") is not None else None,
            "modifiers": [NomenclatureSimpleModifierInfo.from_dict(_item) for _item in obj["modifiers"]] if obj.get("modifiers") is not None else None,
            "groupModifiers": [NomenclatureGroupModifierInfo.from_dict(_item) for _item in obj["groupModifiers"]] if obj.get("groupModifiers") is not None else None,
