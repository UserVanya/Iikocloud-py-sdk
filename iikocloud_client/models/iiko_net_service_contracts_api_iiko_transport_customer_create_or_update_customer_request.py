...
class IikoNetServiceContractsApiIikoTransportCustomerCreateOrUpdateCustomerRequest(BaseModel):
    """
    ...
    sex: Optional[IikoNetServiceContractsApiIikoTransportCustomerIikoNetUserSex] = Field(default=None, description="Customer sex.  <br>0 - not specified,<br />1 - male,<br />2 - female.")
    consent_status: Optional[IikoNetServiceContractsApiIikoTransportCustomerPersonalDataConsentStatus] = Field(default=None, description="Customer consent status.  <br>0 - unknown,<br />1 - given,<br />2 - revoked.", alias="consentStatus")
