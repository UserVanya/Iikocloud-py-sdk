...
class TransportReservesCreateReserveRequest(BaseModel):
    ...
    """ # noqa: E501
    organization_id: StrictStr = Field(description="Organization ID of a new banquet/reserve.                Can be obtained by `/api/1/organizations` operation.", alias="organizationId")
    terminal_group_id: Optional[StrictStr] = Field(default=None, description="Front group ID an banquet/reserve must be sent to.                Can be obtained by `/api/1/terminal_groups` operation.", alias="terminalGroupId")
