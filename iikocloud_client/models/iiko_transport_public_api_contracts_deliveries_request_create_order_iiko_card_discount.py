...
class IikoTransportPublicApiContractsDeliveriesRequestCreateOrderIikoCardDiscount(IikoTransportPublicApiContractsDeliveriesRequestCreateOrderDiscount):
    """
    ...
    discount_items: List[IikoTransportPublicApiContractsDeliveriesRequestCreateOrderIikoCardDiscountItem] = Field(description="Discount information for order items.", alias="discountItems")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "discountItems": [IikoTransportPublicApiContractsDeliveriesRequestCreateOrderIikoCardDiscountItem.from_dict(_item) for _item in obj["discountItems"]] if obj.get("discountItems") is not None else None
        })
        return _obj
