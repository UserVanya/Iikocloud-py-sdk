...
class ExternalMenuModifierItem3(BaseModel):
    """
    ...
    restrictions: Optional[List[ModifierRestrictionsDto7]] = None
    is_hidden: Optional[StrictBool] = Field(default=False, alias="isHidden")
    prices: Optional[List[ExternalMenuPriceByDepartmentsDto3]] = None
    nutritions: Optional[List[NutritionInfoDto7]] = Field(default=None, description="Nutrition per 100 g of product grouped by departments")
    ...
    customer_tag_groups: Optional[List[SelectedCustomerTag7]] = Field(default=None, alias="customerTagGroups")
    ...
    barcodes: Optional[List[BarcodeDto7]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "restrictions": [ModifierRestrictionsDto7.from_dict(_item) for _item in obj["restrictions"]] if obj.get("restrictions") is not None else None,
            "isHidden": obj.get("isHidden") if obj.get("isHidden") is not None else False,
            "prices": [ExternalMenuPriceByDepartmentsDto3.from_dict(_item) for _item in obj["prices"]] if obj.get("prices") is not None else None,
            "nutritions": [NutritionInfoDto7.from_dict(_item) for _item in obj["nutritions"]] if obj.get("nutritions") is not None else None,
            ...
            "customerTagGroups": [SelectedCustomerTag7.from_dict(_item) for _item in obj["customerTagGroups"]] if obj.get("customerTagGroups") is not None else None,
            ...
            "barcodes": [BarcodeDto7.from_dict(_item) for _item in obj["barcodes"]] if obj.get("barcodes") is not None else None,
