...
class IikoTransportPublicApiContractsWebHooksUpdateWebHookSettingsRequest(BaseModel):
    """
    Request to add or update webhooks settings for listed api logins of the specified organization.
    """ # noqa: E501
    organization_id: UUID = Field(description="Organization UOC Id.                Can be obtained by `/organizations` operation.", alias="organizationId")
