...
class TransportReservesGetRestaurantSectionsWorkloadRequest(BaseModel):
    ...
    """ # noqa: E501
    restaurant_section_ids: List[StrictStr] = Field(description="Collection of restaurant section ID.                Can be obtained by `/reserve/available_restaurant_sections` operation.", alias="restaurantSectionIds")
