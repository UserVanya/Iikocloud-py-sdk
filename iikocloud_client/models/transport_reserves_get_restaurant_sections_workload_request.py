...
class TransportReservesGetRestaurantSectionsWorkloadRequest(BaseModel):
    """
    Request for check restaurant sections workload.
    """ # noqa: E501
    restaurant_section_ids: List[StrictStr] = Field(description="Collection of restaurant section ID.                Can be obtained by `/api/1/reserve/available_restaurant_sections` operation.", alias="restaurantSectionIds")
