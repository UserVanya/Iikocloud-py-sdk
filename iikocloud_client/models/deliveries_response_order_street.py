...
class DeliveriesResponseOrderStreet(BaseModel):
    """
    Street.
    """ # noqa: E501
    id: UUID = Field(description="ID.")
    name: StrictStr = Field(description="Name.")
    city: DeliveriesResponseOrderCity = Field(description="City.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "name": obj.get("name"),
            "city": DeliveriesResponseOrderCity.from_dict(obj["city"]) if obj.get("city") is not None else None
        })
        return _obj
