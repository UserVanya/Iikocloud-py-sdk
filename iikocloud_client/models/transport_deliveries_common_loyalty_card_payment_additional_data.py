...
class TransportDeliveriesCommonLoyaltyCardPaymentAdditionalData(TransportDeliveriesCommonPaymentAdditionalData):
    """
    Additional data for LoyaltyApp payment item.
    """ # noqa: E501
    credential: StrictStr = Field(description="Guest credential, authorizing payment.")
    search_scope: TransportDeliveriesCommonIikoCardSearchScope = Field(description="Guest credential search scope.", alias="searchScope")
