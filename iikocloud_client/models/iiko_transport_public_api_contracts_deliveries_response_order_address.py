...
class IikoTransportPublicApiContractsDeliveriesResponseOrderAddress(BaseModel):
    """
    Address details.
    """ # noqa: E501
    street: Optional[IikoTransportPublicApiContractsDeliveriesResponseOrderStreet] = Field(default=None, description="Street.")
    ...
    region: Optional[IikoTransportPublicApiContractsDeliveriesResponseOrderRegion] = Field(description="Region")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "street": IikoTransportPublicApiContractsDeliveriesResponseOrderStreet.from_dict(obj["street"]) if obj.get("street") is not None else None,
            "index": obj.get("index"),
            "house": obj.get("house"),
            ...
            "region": IikoTransportPublicApiContractsDeliveriesResponseOrderRegion.from_dict(obj["region"]) if obj.get("region") is not None else None,
            "line1": obj.get("line1")
        })
        return _obj
