...
class DeliveriesRequestUpdateOrderPaymentsRequest(BaseModel):
    """
    ...
    payment_items: Optional[List[DeliveriesRequestUpdateOrderOrderPaymentItem]] = Field(default=None, description="Payment details.", alias="paymentItems")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "paymentItems": [DeliveriesRequestUpdateOrderOrderPaymentItem.from_dict(_item) for _item in obj["paymentItems"]] if obj.get("paymentItems") is not None else None
        })
        return _obj
