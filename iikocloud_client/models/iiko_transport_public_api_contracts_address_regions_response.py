...
class IikoTransportPublicApiContractsAddressRegionsResponse(BaseModel):
    """
    Service response with list of districts.
    """ # noqa: E501
    correlation_id: UUID = Field(description="Operation ID.", alias="correlationId")
    regions: List[RmsItemsResponseWrapperAddressRegion] = Field(description="List of districts.")
    __properties: ClassVar[List[str]] = ["correlationId", "regions"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "regions": [RmsItemsResponseWrapperAddressRegion.from_dict(_item) for _item in obj["regions"]] if obj.get("regions") is not None else None
        })
        return _obj
