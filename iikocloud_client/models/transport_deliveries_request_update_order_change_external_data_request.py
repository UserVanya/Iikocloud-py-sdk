...
class TransportDeliveriesRequestUpdateOrderChangeExternalDataRequest(BaseModel):
    """
    ...
    external_data: List[TransportDeliveriesRequestCreateOrderExternalData] = Field(description="External data to change.", alias="externalData")
