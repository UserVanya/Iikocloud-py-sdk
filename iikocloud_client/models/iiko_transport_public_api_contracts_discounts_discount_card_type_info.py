...
class IikoTransportPublicApiContractsDiscountsDiscountCardTypeInfo(BaseModel):
    """
    ...
    product_category_discounts: List[IikoTransportPublicApiContractsDiscountsProductCategoryDiscount] = Field(description="Category discount.", alias="productCategoryDiscounts")
    ...
    mode: IikoTransportPublicApiContractsDiscountsDiscountCardMode = Field(description="Discount type.     Can be obtained by `/discounts` operation.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "productCategoryDiscounts": [IikoTransportPublicApiContractsDiscountsProductCategoryDiscount.from_dict(_item) for _item in obj["productCategoryDiscounts"]] if obj.get("productCategoryDiscounts") is not None else None,
