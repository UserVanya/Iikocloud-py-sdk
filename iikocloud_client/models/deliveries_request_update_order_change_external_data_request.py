...
class DeliveriesRequestUpdateOrderChangeExternalDataRequest(BaseModel):
    """
    ...
    external_data: List[DeliveriesRequestCreateOrderExternalData] = Field(description="External data to change.", alias="externalData")
