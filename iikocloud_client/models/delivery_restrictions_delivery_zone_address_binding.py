...
class DeliveryRestrictionsDeliveryZoneAddressBinding(BaseModel):
    """
    ...
    houses: DeliveryRestrictionsHousesRange = Field(description="Range of house numbers in the delivery zone.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "houses": DeliveryRestrictionsHousesRange.from_dict(obj["houses"]) if obj.get("houses") is not None else None
        })
        return _obj
