...
nutrition_info_dto5_instance = NutritionInfoDto5.from_json(json)
# print the JSON string representation of the object
print(NutritionInfoDto5.to_json())

# convert the object into a dict
nutrition_info_dto5_dict = nutrition_info_dto5_instance.to_dict()
# create an instance of NutritionInfoDto5 from a dict
nutrition_info_dto5_from_dict = NutritionInfoDto5.from_dict(nutrition_info_dto5_dict)
```
