...
**payment_additional_data** | [**DeliveriesCommonPaymentAdditionalData**](DeliveriesCommonPaymentAdditionalData.md) | Additional payment parameters. | [optional] 
...
deliveries_request_create_order_tips_payment_instance = DeliveriesRequestCreateOrderTipsPayment.from_json(json)
# print the JSON string representation of the object
print(DeliveriesRequestCreateOrderTipsPayment.to_json())

# convert the object into a dict
deliveries_request_create_order_tips_payment_dict = deliveries_request_create_order_tips_payment_instance.to_dict()
# create an instance of DeliveriesRequestCreateOrderTipsPayment from a dict
deliveries_request_create_order_tips_payment_from_dict = DeliveriesRequestCreateOrderTipsPayment.from_dict(deliveries_request_create_order_tips_payment_dict)
```
