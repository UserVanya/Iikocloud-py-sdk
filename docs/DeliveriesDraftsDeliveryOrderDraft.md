...
deliveries_drafts_delivery_order_draft_instance = DeliveriesDraftsDeliveryOrderDraft.from_json(json)
# print the JSON string representation of the object
print(DeliveriesDraftsDeliveryOrderDraft.to_json())

# convert the object into a dict
deliveries_drafts_delivery_order_draft_dict = deliveries_drafts_delivery_order_draft_instance.to_dict()
# create an instance of DeliveriesDraftsDeliveryOrderDraft from a dict
deliveries_drafts_delivery_order_draft_from_dict = DeliveriesDraftsDeliveryOrderDraft.from_dict(deliveries_drafts_delivery_order_draft_dict)
```
