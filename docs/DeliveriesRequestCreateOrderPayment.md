...
deliveries_request_create_order_payment_instance = DeliveriesRequestCreateOrderPayment.from_json(json)
# print the JSON string representation of the object
print(DeliveriesRequestCreateOrderPayment.to_json())

# convert the object into a dict
deliveries_request_create_order_payment_dict = deliveries_request_create_order_payment_instance.to_dict()
# create an instance of DeliveriesRequestCreateOrderPayment from a dict
deliveries_request_create_order_payment_from_dict = DeliveriesRequestCreateOrderPayment.from_dict(deliveries_request_create_order_payment_dict)
```
