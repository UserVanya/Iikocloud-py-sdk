...
json = "{}"
# create an instance of DeliveriesRequestCreateOrderOrder from a JSON string
deliveries_request_create_order_order_instance = DeliveriesRequestCreateOrderOrder.from_json(json)
# print the JSON string representation of the object
print(DeliveriesRequestCreateOrderOrder.to_json())

# convert the object into a dict
deliveries_request_create_order_order_dict = deliveries_request_create_order_order_instance.to_dict()
# create an instance of DeliveriesRequestCreateOrderOrder from a dict
deliveries_request_create_order_order_from_dict = DeliveriesRequestCreateOrderOrder.from_dict(deliveries_request_create_order_order_dict)
```
