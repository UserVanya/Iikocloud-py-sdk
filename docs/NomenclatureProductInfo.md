...
**size_prices** | [**List[NomenclatureSizePrice]**](NomenclatureSizePrice.md) | Prices. | [optional] 
**modifiers** | [**List[NomenclatureSimpleModifierInfo]**](NomenclatureSimpleModifierInfo.md) | Modifiers. | [optional] 
...
json = "{}"
# create an instance of NomenclatureProductInfo from a JSON string
nomenclature_product_info_instance = NomenclatureProductInfo.from_json(json)
# print the JSON string representation of the object
print(NomenclatureProductInfo.to_json())

# convert the object into a dict
nomenclature_product_info_dict = nomenclature_product_info_instance.to_dict()
# create an instance of NomenclatureProductInfo from a dict
nomenclature_product_info_from_dict = NomenclatureProductInfo.from_dict(nomenclature_product_info_dict)
```
