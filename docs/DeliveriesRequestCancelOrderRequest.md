...
json = "{}"
# create an instance of DeliveriesRequestCancelOrderRequest from a JSON string
deliveries_request_cancel_order_request_instance = DeliveriesRequestCancelOrderRequest.from_json(json)
# print the JSON string representation of the object
print(DeliveriesRequestCancelOrderRequest.to_json())

# convert the object into a dict
deliveries_request_cancel_order_request_dict = deliveries_request_cancel_order_request_instance.to_dict()
# create an instance of DeliveriesRequestCancelOrderRequest from a dict
deliveries_request_cancel_order_request_from_dict = DeliveriesRequestCancelOrderRequest.from_dict(deliveries_request_cancel_order_request_dict)
```
