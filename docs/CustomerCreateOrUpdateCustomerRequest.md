...
**sex** | [**CustomerIikoNetUserSex**](CustomerIikoNetUserSex.md) | Customer sex.  &lt;br&gt;0 - not specified,&lt;br /&gt;1 - male,&lt;br /&gt;2 - female. | [optional] 
**consent_status** | [**CustomerPersonalDataConsentStatus**](CustomerPersonalDataConsentStatus.md) | Customer consent status.  &lt;br&gt;0 - unknown,&lt;br /&gt;1 - given,&lt;br /&gt;2 - revoked. | [optional] 
...
json = "{}"
# create an instance of CustomerCreateOrUpdateCustomerRequest from a JSON string
customer_create_or_update_customer_request_instance = CustomerCreateOrUpdateCustomerRequest.from_json(json)
# print the JSON string representation of the object
print(CustomerCreateOrUpdateCustomerRequest.to_json())

# convert the object into a dict
customer_create_or_update_customer_request_dict = customer_create_or_update_customer_request_instance.to_dict()
# create an instance of CustomerCreateOrUpdateCustomerRequest from a dict
customer_create_or_update_customer_request_from_dict = CustomerCreateOrUpdateCustomerRequest.from_dict(customer_create_or_update_customer_request_dict)
```
