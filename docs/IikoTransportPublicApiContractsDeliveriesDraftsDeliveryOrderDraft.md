...
json = "{}"
# create an instance of IikoTransportPublicApiContractsDeliveriesDraftsDeliveryOrderDraft from a JSON string
iiko_transport_public_api_contracts_deliveries_drafts_delivery_order_draft_instance = IikoTransportPublicApiContractsDeliveriesDraftsDeliveryOrderDraft.from_json(json)
# print the JSON string representation of the object
print(IikoTransportPublicApiContractsDeliveriesDraftsDeliveryOrderDraft.to_json())

# convert the object into a dict
iiko_transport_public_api_contracts_deliveries_drafts_delivery_order_draft_dict = iiko_transport_public_api_contracts_deliveries_drafts_delivery_order_draft_instance.to_dict()
# create an instance of IikoTransportPublicApiContractsDeliveriesDraftsDeliveryOrderDraft from a dict
iiko_transport_public_api_contracts_deliveries_drafts_delivery_order_draft_from_dict = IikoTransportPublicApiContractsDeliveriesDraftsDeliveryOrderDraft.from_dict(iiko_transport_public_api_contracts_deliveries_drafts_delivery_order_draft_dict)
```
