...
**sex** | [**CustomerIikoNetUserSex**](CustomerIikoNetUserSex.md) | Sex.  &lt;br&gt;0 - not specified,&lt;br /&gt;1 - male,&lt;br /&gt;2 - female. | [optional] 
**consent_status** | [**CustomerPersonalDataConsentStatus**](CustomerPersonalDataConsentStatus.md) | Guest consent status.  &lt;br&gt;0 - unknown,&lt;br /&gt;1 - given,&lt;br /&gt;2 - revoked. | [optional] 
**anonymized** | **bool** | Guest anonymized. | [optional] 
**cards** | [**List[CustomerGuestCardInfo]**](CustomerGuestCardInfo.md) | Customer&#39;s cards. | [optional] 
**categories** | [**List[CustomerGuestCategoryShortInfo]**](CustomerGuestCategoryShortInfo.md) | Customer categories. | [optional] 
**wallet_balances** | [**List[CustomerGuestBalanceInfo]**](CustomerGuestBalanceInfo.md) | Customer&#39;s user wallets. Contains bonus balances of different loyalty programs. | [optional] 
...
json = "{}"
# create an instance of CustomerGetCustomerInfoResponse from a JSON string
customer_get_customer_info_response_instance = CustomerGetCustomerInfoResponse.from_json(json)
# print the JSON string representation of the object
print(CustomerGetCustomerInfoResponse.to_json())

# convert the object into a dict
customer_get_customer_info_response_dict = customer_get_customer_info_response_instance.to_dict()
# create an instance of CustomerGetCustomerInfoResponse from a dict
customer_get_customer_info_response_from_dict = CustomerGetCustomerInfoResponse.from_dict(customer_get_customer_info_response_dict)
```
